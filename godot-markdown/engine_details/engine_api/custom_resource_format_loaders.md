<a id="doc-custom-resource-format-loaders"></a>
...
data types. If not, refer to this guide: [Custom modules in C++](custom_modules_in_cpp.md#doc-custom-modules-in-cpp)

### References

- [ResourceLoader](../../classes/class_resourceloader.md#class-resourceloader)
...
Godot may not have a proper substitute within its [Core types](../architecture/core_types.md#doc-core-types)
