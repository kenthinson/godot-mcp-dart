<a id="doc-binding-to-external-libraries"></a>

# Binding to external libraries

## Modules

The Summator example in [Custom modules in C++](custom_modules_in_cpp.md#doc-custom-modules-in-cpp) is great for small,
