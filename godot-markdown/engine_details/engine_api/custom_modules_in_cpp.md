<a id="doc-custom-modules-in-cpp"></a>
...
[GDExtension](../../tutorials/scripting/gdextension/index.md#doc-gdextension) is generally more suited as it doesn't
...
and compile it](../development/compiling/index.md#toc-devel-compiling).
...
[Binding to external libraries](binding_to_external_libraries.md#doc-binding-to-external-libraries) for details about binding to
external libraries.
...
template. See the [Compiling](../development/compiling/index.md#toc-devel-compiling) pages
...
#### SEE ALSO
[Introduction to the buildsystem - Custom modules build option](../development/compiling/introduction_to_the_buildsystem.md#doc-buildsystem-custom-modules).
...
Edit the file(s) following the [class reference primer](https://contributing.godotengine.org/en/latest/documentation/class_reference/class_reference_primer.html) and recompile the engine.
...
<a id="doc-custom-module-unit-tests"></a>
...
[Unit testing](../architecture/unit_testing.md#doc-unit-testing).
...
1. Create a new test suite: `test_summator.h`. The header must be prefixed
...
1. Compile the engine with `scons tests=yes`, and run the tests with the
   following command:
...
<a id="doc-custom-module-icons"></a>
...
please refer to [Editor icons](../editor/creating_icons.md#doc-editor-icons) first.
...
- If you inherit from [Node](../../classes/class_node.md#class-node) (or any derived node type, such as
  Sprite2D), your new class will appear in the editor, in the inheritance
  tree in the "Add Node" dialog.
- If you inherit from [Resource](../../classes/class_resource.md#class-resource), it will appear in the resource
