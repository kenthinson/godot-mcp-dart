...
[Unit testing](../../architecture/unit_testing.md#doc-unit-testing) in continuous integration.

Sanitizers can be used on Windows, macOS and Linux by using the Clang (LLVM),
GCC or Visual Studio compilers.
[Certain platforms](#doc-using-sanitizers-platform-specific-sanitizers)
...
When [compiling](../compiling/index.md#toc-devel-compiling) with any of the sanitizers enabled,
...
<a id="doc-using-sanitizers-address-sanitizer"></a>
...
the address sanitizer doesn't suffice. The [Memory sanitizer (MSAN)](#doc-using-sanitizers-memory-sanitizer)
...
[dedicated servers](../../../tutorials/export/exporting_for_dedicated_servers.md#doc-exporting-for-dedicated-servers) for months or
...
<a id="doc-using-sanitizers-memory-sanitizer"></a>
...
[Address sanitizer (ASAN)](#doc-using-sanitizers-address-sanitizer). Unlike the address sanitizer,
...
<a id="doc-using-sanitizers-platform-specific-sanitizers"></a>

## Platform-specific sanitizers

### Web

When [compiling for the Web](../compiling/compiling_for_web.md#doc-compiling-for-web),
