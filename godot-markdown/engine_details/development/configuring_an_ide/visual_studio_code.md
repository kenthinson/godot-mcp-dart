<a id="doc-configuring-an-ide-vscode"></a>
...
[the C# guide to configure an external editor](../../../tutorials/scripting/c_sharp/c_sharp_basics.md#doc-c-sharp-setup-external-editor) or
[the GDScript guide to using an external text editor](../../../tutorials/editor/external_editor.md#doc-external-editor).

[Visual Studio Code](https://code.visualstudio.com) is a free cross-platform code editor
by [Microsoft](https://microsoft.com) (not to be confused with [Visual Studio](visual_studio.md#doc-configuring-an-ide-vs)).
...
![image](engine_details/development/configuring_an_ide/img/vscode_configure_task.png)
- Select the **Create tasks.json file from template** option.

![image](engine_details/development/configuring_an_ide/img/vscode_create_tasksjson.png)
- Then select **Others**.

![image](engine_details/development/configuring_an_ide/img/vscode_create_tasksjson_others.png)
...
![image](engine_details/development/configuring_an_ide/img/vscode_3_tasks.json.png)

Arguments can be different based on your own setup and needs. See
[Introduction to the buildsystem](../compiling/introduction_to_the_buildsystem.md#doc-introduction-to-the-buildsystem) for a full list of arguments.
...
![image](engine_details/development/configuring_an_ide/img/vscode_1_create_launch.json.png)
...
![image](engine_details/development/configuring_an_ide/img/vscode_2_launch.json.png)
...
Do note that lldb may work better with LLVM-based builds. See [Compiling for Linux, \*BSD](../compiling/compiling_for_linuxbsd.md#doc-compiling-for-linuxbsd) for further information.
...
![image](engine_details/development/configuring_an_ide/img/vscode_edit_configurations.webp)
...
- Make sure the compiler path is configured correctly to the compiler you are using. See [Introduction to the buildsystem](../compiling/introduction_to_the_buildsystem.md#doc-introduction-to-the-buildsystem) for further information on your platform.
...
By installing the
[Godot Hover Docs extension](https://marketplace.visualstudio.com/items?itemName=RedMser.godot-hover-docs),
