<a id="doc-configuring-an-ide-android-studio"></a>
...
![image](engine_details/development/configuring_an_ide/img/android_studio_setup_project_1.png)
...
- To build the `editor` module:
  : - Select the [Run/Debug Configurations drop down](https://developer.android.com/studio/run/rundebugconfig#running) and select `editor`.
    <br/>
    ![image](engine_details/development/configuring_an_ide/img/android_studio_editor_configurations_drop_down.webp)
...
- To debug the `editor` module:
  : - Open the **Build Variants** window using **View > Tools Windows > Build Variants** from the top menu.
    ...
    <br/>
    ![image](engine_details/development/configuring_an_ide/img/android_studio_editor_build_variant.webp)
    ...
    <br/>
    ![image](engine_details/development/configuring_an_ide/img/android_studio_editor_debug_type_setup.webp)
...
- To build the `app` module:
  : - Select the [Run/Debug Configurations drop down](https://developer.android.com/studio/run/rundebugconfig#running) and select `app`.
    <br/>
    ![image](engine_details/development/configuring_an_ide/img/android_studio_app_configurations_drop_down.webp)
...
- To debug the `app` module:
  : - Open the **Build Variants** window using **View > Tools Windows > Build Variants** from the top menu.
    ...
    <br/>
    ![image](engine_details/development/configuring_an_ide/img/android_studio_app_build_variant.webp)
    - Open the **Run/Debug Configurations** window by clicking on **Run > Edit Configurations...** on the top menu.
    ...
    - Click the `+` sign under the **Symbol Directories** section, and add the `lib` module directory: `platform/android/java/lib`
    <br/>
    ![image](engine_details/development/configuring_an_ide/img/android_studio_app_debug_type_setup.webp)
