<a id="doc-configuring-an-ide-xcode"></a>
...
![image](engine_details/development/configuring_an_ide/img/xcode_1_create_external_build_project.webp)
...
![image](engine_details/development/configuring_an_ide/img/xcode_2_set_external_build_project_parameters.webp)
- Open the main target from the **Targets** section and select the **Info** tab.

![image](engine_details/development/configuring_an_ide/img/xcode_3_configure_scons.webp)
...
![image](engine_details/development/configuring_an_ide/img/xcode_4_add_new_target.webp)
- Select **macOS > Application > Command Line Tool**.

![image](engine_details/development/configuring_an_ide/img/xcode_5_select_command_line_target.webp)
...
![image](engine_details/development/configuring_an_ide/img/xcode_6_after_add_godot_source_to_project.webp)
...
![image](engine_details/development/configuring_an_ide/img/xcode_7_setup_build_post_action.webp)
- Build the external build target.
- Open the scheme editor again and select **Run**.

![image](engine_details/development/configuring_an_ide/img/xcode_8_setup_run_scheme.webp)
