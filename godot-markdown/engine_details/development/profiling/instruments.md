<a id="doc-profiler-instruments"></a>

# Instruments

#### SEE ALSO
Please see the [sampling profiler instructions](index.md#doc-sampling-profilers)
and the [tracing profiler instructions](index.md#doc-tracing-profilers) for
more information.
...
![image](engine_details/development/profiling/img/cpp_profiler_xcode_menu.png)
...
![image](engine_details/development/profiling/img/cpp_profiler_time_profiler.png)
...
![image](engine_details/development/profiling/img/cpp_profiler_time_profiler_record.png)
...
![image](engine_details/development/profiling/img/cpp_profiler_time_profiler_result.png)
