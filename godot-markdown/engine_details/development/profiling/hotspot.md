<a id="doc-profiler-hotspot"></a>

# Hotspot

#### SEE ALSO
Please see the [sampling profiler instructions](index.md#doc-sampling-profilers) for more information.

- Open [Hotspot](https://github.com/KDAB/hotspot). Click **Record Data**:

![image](engine_details/development/profiling/img/cpp_profiler_hotspot_welcome.png)
...
![image](engine_details/development/profiling/img/cpp_profiler_hotspot_record.png)
...
![image](engine_details/development/profiling/img/cpp_profiler_hotspot_view_results.png)
...
![image](engine_details/development/profiling/img/cpp_profiler_hotspot_flame_graph.png)
