<a id="doc-introduction-to-the-buildsystem"></a>

# Introduction to the buildsystem

Godot is a primarily C++ project and it [uses the SCons build system.](../../../about/faq.md#doc-faq-why-scons)
...
- [Compiling for Android](compiling_for_android.md#doc-compiling-for-android)
- [Compiling for iOS](compiling_for_ios.md#doc-compiling-for-ios)
- [Compiling for Linux, \*BSD](compiling_for_linuxbsd.md#doc-compiling-for-linuxbsd)
- [Compiling for macOS](compiling_for_macos.md#doc-compiling-for-macos)
- [Compiling for the Web](compiling_for_web.md#doc-compiling-for-web)
- [Compiling for Windows](compiling_for_windows.md#doc-compiling-for-windows)
...
<a id="doc-introduction-to-the-buildsystem-resulting-binary"></a>
...
<a id="doc-introduction-to-the-buildsystem-target"></a>
...
The list of [command line arguments](../../../tutorials/editor/command_line_tutorial.md#doc-command-line-tutorial)
...
<a id="doc-introduction-to-the-buildsystem-development-and-production-aliases"></a>

## Development and production aliases

When creating builds for development (running debugging/[profiling](../profiling/index.md#doc-using-cpp-profilers)
...
- `dev_mode=yes` is an alias for `verbose=yes warnings=extra werror=yes
  ...
  continuous integration setup) and also builds [unit tests](../../architecture/unit_testing.md#doc-unit-testing) so you can run them locally.
...
See [Using sanitizers](../debugging/using_sanitizers.md#doc-using-sanitizers) for more information.

<a id="doc-introduction-to-the-buildsystem-debugging-symbols"></a>
...
<a id="doc-buildsystem-custom-modules"></a>
...
#### SEE ALSO
[Custom modules in C++](../../engine_api/custom_modules_in_cpp.md#doc-custom-modules-in-cpp)
...
<a id="doc-overriding-build-options"></a>
...
time it takes to build the engine. See [Optimizing a build for size](optimizing_for_size.md#doc-optimizing-for-size) page for more details.
