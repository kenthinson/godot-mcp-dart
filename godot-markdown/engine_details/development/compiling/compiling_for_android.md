<a id="doc-compiling-for-android"></a>

# Compiling for Android

#### SEE ALSO
This page describes how to compile Android export template binaries from source.
If you're looking to export your project to Android instead, read [Exporting for Android](../../../tutorials/export/exporting_for_android.md#doc-exporting-for-android).
...
[Exporting for Android](../../../tutorials/export/exporting_for_android.md#doc-exporting-for-android) tutorial before attempting to build
...
- Android SDK
  > - To install the Android SDK, follow the steps here <[https://docs.godotengine.org/en/stable/tutorials/export/exporting_for_android.html](https://docs.godotengine.org/en/stable/tutorials/export/exporting_for_android.html)>_.
...
<a id="doc-android-setting-up-the-buildsystem"></a>
...
[Vulkan validation layers on Android](../debugging/vulkan/vulkan_validation_layers.md#doc-vulkan-validation-layers-android).
...
![image](engine_details/development/compiling/img/andtemplates.webp)
...
See [Setting up the buildsystem](#doc-android-setting-up-the-buildsystem)
