<a id="doc-compiling-for-windows"></a>

# Compiling for Windows

#### SEE ALSO
This page describes how to compile Windows editor and export template binaries from source.
If you're looking to export your project to Windows instead, read [Exporting for Windows](../../../tutorials/export/exporting_for_windows.md#doc-exporting-for-windows).
...
- [SCons 4.0+](https://scons.org/pages/download.html) build system. Using the
  ...
  Studio releases.
- [Direct3D 12 dependencies](#doc-compiling-for-windows-installing-d3d12-requirements)
...
<a id="doc-compiling-for-windows-install-vs"></a>

## Downloading Godot's source

Refer to [Getting the source](getting_source.md#doc-getting-source) for detailed instructions.
...
<a id="doc-compiling-for-windows-installing-d3d12-requirements"></a>
...
- Download the pre-built static libraries from [godot-angle-static library](https://github.com/godotengine/godot-angle-static/releases), and unzip them.
...
#### SEE ALSO
See [Visual Studio](../configuring_an_ide/visual_studio.md#doc-configuring-an-ide-vs) for further details.
...
Continue without code, then Help > Check for Updates in the
...
| **Arch Linux**              | ```shell<br/>pacman -S mingw-w64<br/>```                                                                                                 |
|-----------------------------|------------------------------------------------------------------------------------------------------------------------------------------|
| **Debian** /<br/>**Ubuntu** | ```shell<br/>apt install mingw-w64<br/>```                                                                                               |
| **Fedora**                  | ```shell<br/>dnf install mingw64-gcc-c++ mingw64-winpthreads-static \<br/>            mingw32-gcc-c++ mingw32-winpthreads-static<br/>``` |
| **macOS**                   | ```shell<br/>brew install mingw-w64<br/>```                                                                                              |
| **Mageia**                  | ```shell<br/>urpmi mingw64-gcc-c++ mingw64-winpthreads-static \<br/>      mingw32-gcc-c++ mingw32-winpthreads-static<br/>```             |
...
![image](engine_details/development/compiling/img/wintemplates.webp)
