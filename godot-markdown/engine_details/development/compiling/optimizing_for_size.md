<a id="doc-optimizing-for-size"></a>
...
[C++ profilers](../profiling/index.md#doc-using-cpp-profilers) will also no longer be able to display
...
Godot features an [Using the engine compilation configuration editor](../../../tutorials/editor/using_engine_compilation_configuration_editor.md#doc-engine-compilation-configuration-editor) tool that can detect
...
- [AcceptDialog](../../../classes/class_acceptdialog.md#class-acceptdialog)
- [CharFXTransform](../../../classes/class_charfxtransform.md#class-charfxtransform)
- [CodeEdit](../../../classes/class_codeedit.md#class-codeedit)
- [CodeHighlighter](../../../classes/class_codehighlighter.md#class-codehighlighter)
- [ColorPicker](../../../classes/class_colorpicker.md#class-colorpicker)
- [ColorPickerButton](../../../classes/class_colorpickerbutton.md#class-colorpickerbutton)
- [ConfirmationDialog](../../../classes/class_confirmationdialog.md#class-confirmationdialog)
- [FileDialog](../../../classes/class_filedialog.md#class-filedialog)
- [FoldableContainer](../../../classes/class_foldablecontainer.md#class-foldablecontainer)
- [FoldableGroup](../../../classes/class_foldablegroup.md#class-foldablegroup)
- [GraphEdit](../../../classes/class_graphedit.md#class-graphedit)
- [GraphElement](../../../classes/class_graphelement.md#class-graphelement)
- [GraphFrame](../../../classes/class_graphframe.md#class-graphframe)
- [GraphNode](../../../classes/class_graphnode.md#class-graphnode)
- [HSplitContainer](../../../classes/class_hsplitcontainer.md#class-hsplitcontainer)
- [MenuBar](../../../classes/class_menubar.md#class-menubar)
- [MenuButton](../../../classes/class_menubutton.md#class-menubutton)
- [OptionButton](../../../classes/class_optionbutton.md#class-optionbutton)
- [PopupMenu](../../../classes/class_popupmenu.md#class-popupmenu) (will make all popup menus unavailable in code for classes that use them,
  like [LineEdit](../../../classes/class_lineedit.md#class-lineedit), even though those classes are still available)
- [RichTextEffect](../../../classes/class_richtexteffect.md#class-richtexteffect)
- [RichTextLabel](../../../classes/class_richtextlabel.md#class-richtextlabel)
- [SpinBox](../../../classes/class_spinbox.md#class-spinbox)
- [SplitContainer](../../../classes/class_splitcontainer.md#class-splitcontainer)
- [SubViewportContainer](../../../classes/class_subviewportcontainer.md#class-subviewportcontainer)
- [SyntaxHighlighter](../../../classes/class_syntaxhighlighter.md#class-syntaxhighlighter)
- [TextEdit](../../../classes/class_textedit.md#class-textedit)
- [Tree](../../../classes/class_tree.md#class-tree)
- [TreeItem](../../../classes/class_treeitem.md#class-treeitem)
- [VSplitContainer](../../../classes/class_vsplitcontainer.md#class-vsplitcontainer)
...
#### SEE ALSO
[Overriding the build options](introduction_to_the_buildsystem.md#doc-overriding-build-options).
...
See [Serving the files](../../../tutorials/export/exporting_for_web.md#doc-exporting-for-web-serving-the-files) for instructions.
