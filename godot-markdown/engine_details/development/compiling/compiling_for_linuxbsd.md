<a id="doc-compiling-for-linuxbsd"></a>

# Compiling for Linux, \*BSD

#### SEE ALSO
This page describes how to compile Linux editor and export template binaries from source.
If you're looking to export your project to Linux instead, read [Exporting for Linux](../../../tutorials/export/exporting_for_linux.md#doc-exporting-for-linux).
...
#### SEE ALSO
To get the Godot source code for compiling, see [Getting the source](getting_source.md#doc-getting-source).

For a general overview of SCons usage for Godot, see [Introduction to the buildsystem](introduction_to_the_buildsystem.md#doc-introduction-to-the-buildsystem).

<a id="doc-compiling-for-linuxbsd-oneliners"></a>
...
![image](engine_details/development/compiling/img/lintemplates.webp)
...
- [riscv-gnu-toolchain](https://github.com/riscv-collab/riscv-gnu-toolchain/releases).
  ...
  If in doubt, [use this version](https://github.com/riscv-collab/riscv-gnu-toolchain/releases/tag/2023.07.07),
...
- Follow [these instructions](https://github.com/ivmai/libatomic_ops#installation-and-usage) to configure, build, and
...
For even faster linking compared to LLD, you can use [mold](https://github.com/rui314/mold).
...
listed in the [Distro-specific one-liners](#doc-compiling-for-linuxbsd-oneliners):
