<a id="doc-common-engine-methods-and-macros"></a>
...
The `vformat()` function returns a formatted [String](../../classes/class_string.md#class-string). It behaves
...
<a id="doc-common-engine-methods-and-macros-error-macros"></a>
