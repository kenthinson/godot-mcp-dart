<a id="doc-object-class"></a>

# Object class

#### SEE ALSO
This page describes the C++ implementation of objects in Godot.
Looking for the Object class reference? [Have a look here.](../../classes/class_object.md#class-object)

## General definition

[Object](../../classes/class_object.md#class-object) is the base class for almost everything. Most classes in Godot
...
<a id="doc-binding-properties-using-set-get-property-list"></a>
...
For the values of `p_flags`, see [ConnectFlags](../../classes/class_object.md#enum-object-connectflags).
...
When an object is passed to you via [Variant](../../classes/class_variant.md#class-variant), especially when using deferred callbacks, it is
...
[RefCounted](../../classes/class_refcounted.md#class-refcounted) subclasses are memory managed with
[reference counting semantics](https://en.wikipedia.org/wiki/Reference_counting).
...
- [core/object/ref_counted.h](https://github.com/godotengine/godot/blob/master/core/object/ref_counted.h)
...
[C++ RTTI](https://en.wikipedia.org/wiki/Run-time_type_information).

## Notifications

All objects in Godot have a [\_notification](../../classes/class_object.md#class-object-private-method-notification)
method that allows them to respond to engine-level callbacks that may relate to it.
More information can be found on the [Godot notifications](../../tutorials/best_practices/godot_notifications.md#doc-godot-notifications) page.

## Resources

[Resource](../../classes/class_resource.md#class-resource) inherits from RefCounted, so all resources
