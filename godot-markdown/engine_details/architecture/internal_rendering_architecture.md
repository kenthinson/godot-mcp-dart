<a id="doc-internal-rendering-architecture"></a>
...
[Godot's design philosophy](https://contributing.godotengine.org/en/latest/engine/guidelines/best_practices.html),
...
[Godot Contributors Chat](https://chat.godotengine.org/channel/rendering).
...
<a id="doc-internal-rendering-architecture-methods"></a>
...
rendering features such as SDFGI and [Volumetric fog and fog volumes](../../tutorials/3d/volumetric_fog.md#doc-volumetric-fog). Several
post-processing effects are also not available.

<a id="doc-internal-rendering-architecture-compatibility"></a>
...
used when available. [volk](https://github.com/zeux/volk) is used as a Vulkan
loader, and
[Vulkan Memory Allocator](https://github.com/GPUOpen-LibrariesAndSDKs/VulkanMemoryAllocator)
is used for memory management.

Both the Forward+ and Mobile
[Rendering methods](#doc-internal-rendering-architecture-methods) are supported when using the
Vulkan driver.
...
Both the Forward+ and Mobile [Rendering methods](#doc-internal-rendering-architecture-methods) can be
used with Direct3D 12.

[Core shaders](#doc-internal-rendering-architecture-core-shaders) are shared with the
...
See the [pull request that introduced Direct3D 12 support](https://github.com/godotengine/godot/pull/70315)
...
[Core shaders](#doc-internal-rendering-architecture-core-shaders) are shared with the
Vulkan renderer. Shaders are transpiled from GLSL to 
using SPIRV-Cross.

Godot also supports Metal rendering via [MoltenVK](https://github.com/KhronosGroup/MoltenVK),
...
See the [pull request that introduced Metal support](https://github.com/godotengine/godot/pull/88199)
for more information.
...
Only the [Compatibility](#doc-internal-rendering-architecture-compatibility) rendering
method can be used with the OpenGL driver.

[Core shaders](#doc-internal-rendering-architecture-core-shaders) are entirely different
...
![image](engine_details/architecture/img/rendering_architecture_diagram.webp)

[View at full size](https://raw.githubusercontent.com/godotengine/godot-docs/master/engine_details/architecture/img/rendering_architecture_diagram.webp)

<a id="doc-internal-rendering-architecture-core-shaders"></a>

## Core shaders

While shaders in Godot projects are written using a
[custom language inspired by GLSL](../../tutorials/shaders/shader_reference/shading_language.md#doc-shading-language), core shaders are
...
See
[The Shader Permutation Problem](https://therealmjp.github.io/posts/shader-permutations-part1/)
and
...
in  sRGB-space while 3D rendering uses
 linear space.
...
Both Forward+ and Mobile methods use
 to filter shadow maps and create a
...
#### SEE ALSO
[Sky shaders](../../tutorials/shaders/shader_reference/sky_shader.md#doc-sky-shader)
...
#### SEE ALSO
[Fog shaders](../../tutorials/shaders/shader_reference/fog_shader.md#doc-fog-shader)
...
[Embree](https://github.com/embree/embree). The buffer's resolution depends
