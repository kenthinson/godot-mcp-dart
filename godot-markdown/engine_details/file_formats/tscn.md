...
The [Skeleton3D](../../classes/class_skeleton3d.md#class-skeleton3d) node inherits the Node3D node, but may also have a
...
The [BoneAttachment3D](../../classes/class_boneattachment3d.md#class-boneattachment3d) node is an intermediate node to describe some
...
An example of a [Marker3D](../../classes/class_marker3d.md#class-marker3d) node parented to a bone in Skeleton:
...
The [AnimationPlayer](../../classes/class_animationplayer.md#class-animationplayer) node works with one or more animation libraries
stored in [AnimationLibrary](../../classes/class_animationlibrary.md#class-animationlibrary) resources. An animation library is a
collection of individual [Animation](../../classes/class_animation.md#class-animation) resources, whose structure is
documented [here](#doc-tscn-animation).
...
a common workflow in 3D animation software. See the [original pull request](https://github.com/godotengine/godot/pull/59980) for details.
