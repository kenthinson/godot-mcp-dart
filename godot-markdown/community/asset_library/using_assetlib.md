...
![image0](community/asset_library/img/assetlib_website.webp)
...
![image1](community/asset_library/img/assetlib_search.webp)
...
![image2](community/asset_library/img/assetlib_asset.webp)
...
![image3](community/asset_library/img/assetlib_register-login.webp)

From here, you can register your account, which requires a valid email address,
a username, and a (preferably strong) password.

![image4](community/asset_library/img/assetlib_register.webp)

Then, you can use your username and password to log in.

![image5](community/asset_library/img/assetlib_login.webp)
...
![image6](community/asset_library/img/assetlib_login_header.webp)

You can learn how to submit assets to the Library, and what the asset submission
guidelines are, in the next part of this tutorial, [Submitting to the Asset Library](submitting_to_assetlib.md#doc-submitting-to-assetlib).

<a id="doc-using-assetlib-editor"></a>
...
![image7](community/asset_library/img/assetlib_editor_workspace.png)

![image14](community/asset_library/img/assetlib_editor_projects.webp)
...
![image8](community/asset_library/img/assetlib_editor.png)
...
![image9](community/asset_library/img/assetlib_editor_asset.png)
...
![image10](community/asset_library/img/assetlib_editor_download.png)

When it finishes, you can proceed to install it using the Install button.
This will bring up the Package Installer window.

![image11](community/asset_library/img/assetlib_editor_installer.png)
...
![image12](community/asset_library/img/assetlib_editor_installer_error.png)
...
![image13](community/asset_library/img/assetlib_editor_installer_success.png)
