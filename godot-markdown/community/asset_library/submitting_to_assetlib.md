<a id="doc-submitting-to-assetlib"></a>
...
As mentioned in the [Using the Asset Library](using_assetlib.md#doc-using-assetlib) document, in order to be able to
...
* Make your code conform to the official **style guides**. Having a
  ...
  [GDScript style guide](../../tutorials/scripting/gdscript/gdscript_styleguide.md#doc-gdscript-styleguide) or the [C# style guide](../../tutorials/scripting/c_sharp/c_sharp_style_guide.md#doc-c-sharp-styleguide).
...
![image0](community/asset_library/img/assetlib_submit.png)
