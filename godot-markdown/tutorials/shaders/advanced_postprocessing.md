<a id="doc-advanced-postprocessing"></a>
...
generally and, in particular, with the methods outlined in the [custom post-processing tutorial](custom_postprocessing.md#doc-custom-postprocessing).
...
To get around the limitation on using the depth buffer, use a [MeshInstance3D](../../classes/class_meshinstance3d.md#class-meshinstance3d)
with a [QuadMesh](../../classes/class_quadmesh.md#class-quadmesh) primitive. This allows us to use a
...
Set the Mesh in the MeshInstance3D to an [ArrayMesh](../../classes/class_arraymesh.md#class-arraymesh). An
