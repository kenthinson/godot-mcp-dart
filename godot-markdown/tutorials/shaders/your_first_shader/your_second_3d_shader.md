<a id="doc-your-second-spatial-shader"></a>
...
For a full list of these parameters see the [spatial shader](../shader_reference/spatial_shader.md#doc-spatial-shader) reference doc.
...
importantly, sets the `ALBEDO` color of the [MeshInstance3D](../../../classes/class_meshinstance3d.md#class-meshinstance3d).
...
For a full list of render modes see the [Spatial shader reference](../shader_reference/spatial_shader.md#doc-spatial-shader).
...
![image](tutorials/shaders/your_first_shader/img/albedo.png)
...
![image](tutorials/shaders/your_first_shader/img/PBR.png)
...
![image](tutorials/shaders/your_first_shader/img/plastic.png)
...
![image](tutorials/shaders/your_first_shader/img/specular-toon.png)
...
![image](tutorials/shaders/your_first_shader/img/rim.png)
...
![image](tutorials/shaders/your_first_shader/img/fresnel.png)
...
![image](tutorials/shaders/your_first_shader/img/dark-water.png)
...
![image](tutorials/shaders/your_first_shader/img/wave1.png)
...
![image](tutorials/shaders/your_first_shader/img/wave2.png)
...
![image](tutorials/shaders/your_first_shader/img/wave3.png)

For more information about Spatial shaders read the [Shading Language](../shader_reference/shading_language.md#doc-shading-language) doc and the [Spatial Shaders](../shader_reference/spatial_shader.md#doc-spatial-shader)
doc. Also look at more advanced tutorials in the [Shading section](../index.md#toc-learn-features-shading) and the [3D](../../3d/index.md#toc-learn-features-3d)
sections.
