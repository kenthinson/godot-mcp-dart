<a id="doc-converting-glsl-to-godot-shaders"></a>
...
[Shading Language](shader_reference/shading_language.md#doc-shading-language) reference.
...
The [Godot shader preprocessor](shader_reference/shader_preprocessor.md#doc-shader-preprocessor) supports the following macros:
...
For more information, see the [Shading Language](shader_reference/shading_language.md#doc-shading-language)
reference.
...
`fragCoord` behaves the same as `gl_FragCoord` in [GLSL](#glsl-coordinates) and `FRAGCOORD` in Godot.
