...
[CanvasItem](canvas_item_shader.md#doc-canvas-item-shader) or [Spatial](spatial_shader.md#doc-spatial-shader)
...
([GPUParticles2D](../../../classes/class_gpuparticles2d.md#class-gpuparticles2d) and [GPUParticles3D](../../../classes/class_gpuparticles3d.md#class-gpuparticles3d)).

CPU-based particle nodes ([CPUParticles2D](../../../classes/class_cpuparticles2d.md#class-cpuparticles2d) and
[CPUParticles3D](../../../classes/class_cpuparticles3d.md#class-cpuparticles3d)) are *rendered* on the GPU (which means they can
...
| in vec4 **USERDATAX**           | Vector that enables the integration of supplementary user-defined data into the particle process shader.<br/>`USERDATAX` are six built-ins identified by number, `X` can be numbers between 1 and 6, for example `USERDATA3`.                       |
...
| in vec3 **EMITTER_VELOCITY**    | Velocity of the [Particles2D](../../../classes/class_gpuparticles2d.md#class-gpuparticles2d) ([3D](../../../classes/class_gpuparticles3d.md#class-gpuparticles3d)) node.                                                                            |
| in float **INTERPOLATE_TO_END** | Value of the [interp_to_end](../../../classes/class_gpuparticles2d.md#class-gpuparticles2d-property-interp-to-end)<br/>([3D](../../../classes/class_gpuparticles3d.md#class-gpuparticles3d-property-interp-to-end)) property of the Particles node. |
| in uint **AMOUNT_RATIO**        | Value of the [amount_ratio](../../../classes/class_gpuparticles2d.md#class-gpuparticles2d-property-amount-ratio)<br/>([3D](../../../classes/class_gpuparticles3d.md#class-gpuparticles3d-property-amount-ratio)) property of the Particles node.    |
