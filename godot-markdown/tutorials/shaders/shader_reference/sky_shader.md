...
* If any `LIGHTX_*` properties are used and any
  [DirectionalLight3D](../../../classes/class_directionallight3d.md#class-directionallight3d) changes.
...
[Sky process mode](../../../classes/class_sky.md#class-sky-property-process-mode) is set to
[PROCESS_MODE_REALTIME](../../../classes/class_sky.md#class-sky-constant-process-mode-realtime).

Note that the [process mode](../../../classes/class_sky.md#class-sky-property-process-mode) only
...
be optimized by setting the sky's [process mode](../../../classes/class_sky.md#class-sky-property-process-mode)
and the [radiance size](../../../classes/class_sky.md#class-sky-property-radiance-size) to get the
...
|---------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| in float **TIME**               | Global time since the engine has started, in seconds. It repeats after every `3,600`<br/>seconds (which can be changed with the<br/>[rollover](../../../classes/class_projectsettings.md#class-projectsettings-property-rendering-limits-time-time-rollover-secs)<br/>setting). It's affected by [time_scale](../../../classes/class_engine.md#class-engine-property-time-scale) but not by pausing. If you need a<br/>`TIME` variable that is not affected by time scale, add your own<br/>[global shader uniform](shading_language.md#doc-shading-language-global-uniforms) and update it each<br/>frame. |
...
| in float **LIGHTX_SIZE**        | Angular diameter of `LIGHTX` in the sky. Expressed in radians. For reference, the sun from earth is about .0087 radians<br/>(0.5 degrees).                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
