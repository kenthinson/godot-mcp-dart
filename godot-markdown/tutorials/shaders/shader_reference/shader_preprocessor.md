<a id="doc-shader-preprocessor"></a>
...
#### NOTE
The shader preprocessor is not available in [visual shaders](../visual_shaders.md#doc-visual-shaders).
...
The [shading language](shading_language.md#doc-shading-language) supports runtime `if` statements:
...
Modern GPUs are [quite effective](https://medium.com/@jasonbooth_86226/branching-on-a-gpu-18bfc83694f2)
...
high amounts of  (which can be caused by
...
menu option of the shader editor, or by creating a new [ShaderInclude](../../../classes/class_shaderinclude.md#class-shaderinclude) resource
