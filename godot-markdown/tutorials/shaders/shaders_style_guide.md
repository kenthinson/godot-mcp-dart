<a id="doc-shaders-style-guide"></a>
...
[Shader preprocessor](shader_reference/shader_preprocessor.md#doc-shader-preprocessor) directives should be written in CONSTANT_\_CASE.
...
[clang-format](https://clang.llvm.org/docs/ClangFormat.html) on one or several
