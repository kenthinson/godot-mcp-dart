...
to shaders please read [Introduction to shaders](introduction_to_shaders.md#doc-introduction-to-shaders) and [your
first shader](your_first_shader/index.md#toc-your-first-shader) before proceeding with this tutorial.
...
Now to execute our shader we need a local [RenderingDevice](../../classes/class_renderingdevice.md#class-renderingdevice)
which can be created using the [RenderingServer](../../classes/class_renderingserver.md#class-renderingserver):
...
each an [RID](../../classes/class_rid.md#class-rid). Because RenderingDevice is meant to be a lower-level
...
[free_rid()](../../classes/class_renderingdevice.md#class-renderingdevice-method-free-rid) method.
...
[Compute Shader Heightmap demo](https://github.com/godotengine/godot-demo-projects/tree/master/compute/heightmap)
