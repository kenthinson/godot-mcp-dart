<a id="doc-custom-postprocessing"></a>
...
DOF, and SSAO, which are described in [Environment and post-processing](../3d/environment_and_post_processing.md#doc-environment-and-post-processing).
...
[Screen Reading Shaders Tutorial](screen-reading_shaders.md#doc-screen-reading-shaders) first.

## Single pass post-processing

Post-processing effects are shaders applied to a frame after Godot has rendered
it. To apply a shader to a frame, create a [CanvasLayer](../../classes/class_canvaslayer.md#class-canvaslayer), and give it a [ColorRect](../../classes/class_colorrect.md#class-colorrect). Assign a
new [ShaderMaterial](../../classes/class_shadermaterial.md#class-shadermaterial) to the newly created
`ColorRect`, and set the `ColorRect`'s anchor preset to Full Rect:

![Setting the anchor preset to Full Rect on the ColorRect node](tutorials/shaders/img/custom_postprocessing_anchors_preset_full_rect.webp)

Your scene tree will look something like this:

![image](tutorials/shaders/img/post_tree1.png)

#### NOTE
Another more efficient method is to use a [BackBufferCopy](../../classes/class_backbuffercopy.md#class-backbuffercopy) to copy a region of the screen to a buffer and to
...
For this demo, we will use this [Sprite](../../classes/class_sprite2d.md#class-sprite2d) of a sheep.

![image](tutorials/shaders/img/post_example1.png)

Assign a new [Shader](../../classes/class_shader.md#class-shader) to the `ColorRect`'s
...
![image](tutorials/shaders/img/post_example2.png)
...
![image](tutorials/shaders/img/post_tree2.png)
...
![image](tutorials/shaders/img/post_example3.png)
