<a id="doc-screen-reading-shaders"></a>
...
Godot [Shading language](shader_reference/shading_language.md#doc-shading-language) has a special texture to access the already
...
![image](tutorials/shaders/img/texscreen_demo1.png)
...
In 2D, this can be corrected via the [BackBufferCopy](../../classes/class_backbuffercopy.md#class-backbuffercopy)
...
![image](tutorials/shaders/img/texscreen_bbc.png)

With correct back-buffer copying, the two spheres blend correctly:

![image](tutorials/shaders/img/texscreen_demo2.png)
...
You can reproduce the back-buffer logic in 3D by creating a [Viewport](../../classes/class_viewport.md#class-viewport)
with a camera in the same position as your object, and then use the
[Viewport's](../../classes/class_viewport.md#class-viewport) texture instead of the screen texture.
