<a id="doc-handling-quit-requests"></a>
...
On desktop and web platforms, [Node](../../classes/class_node.md#class-node) receives a special
...
[SceneTree.quit](../../classes/class_scenetree.md#class-scenetree-method-quit), doing so will not send
the `NOTIFICATION_WM_CLOSE_REQUEST` to the nodes in the scene tree.
Quitting by calling [SceneTree.quit](../../classes/class_scenetree.md#class-scenetree-method-quit) will
...
the previous behavior, [SceneTree.quit](../../classes/class_scenetree.md#class-scenetree-method-quit) should
