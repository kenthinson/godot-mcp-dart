<a id="doc-controller-features"></a>
...
Use the method [Input.set_joy_light()](../../classes/class_input.md#class-input-method-set-joy-light) to set the color
of a given controller's LEDs.

To determine if a given controller supports setting LED lights, use the [Input.has_joy_light()](../../classes/class_input.md#class-input-method-has-joy-light)
