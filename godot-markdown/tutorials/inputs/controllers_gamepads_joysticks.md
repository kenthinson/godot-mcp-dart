<a id="doc-controllers-gamepads-joysticks"></a>
...
#### NOTE
Since Godot 4.5, the engine relies on [SDL 3](https://www.libsdl.org/index.php)
...
[report bugs on GitHub](https://github.com/godotengine/godot/blob/master/CONTRIBUTING.md#reporting-bugs).
...
Input actions are explained in detail on the [Using InputEvent](inputevent.md#doc-inputevent) page.
...
[start_joy_vibration](../../classes/class_input.md#class-input-method-start-joy-vibration) method to
start vibrating a gamepad. Use
[stop_joy_vibration](../../classes/class_input.md#class-input-method-stop-joy-vibration) to stop
vibration early (useful if no duration was specified when starting).

On mobile devices, you can also use
[vibrate_handheld](../../classes/class_input.md#class-input-method-vibrate-handheld) to vibrate the
...
[InputEvent](../../classes/class_inputevent.md#class-inputevent) objects by code and parse them using
[Input.parse_input_event()](../../classes/class_input.md#class-input-method-parse-input-event)
at regular intervals. This can be accomplished
with the help of a [Timer](../../classes/class_timer.md#class-timer) node.
...
[third-party split screen functionality](https://nucleus-coop.github.io/),
...
need to create an [autoload](../scripting/singletons_autoload.md#doc-singletons-autoload) called `Focus`
...
use the [Gamepad Tester](https://hardwaretester.com/gamepad) website to confirm
...
[Xbox Accessories app](https://www.microsoft.com/en-us/p/xbox-accessories/9nblggh30xj3).
...
[Godot game controller database](https://github.com/godotengine/godot/blob/master/core/input/godotcontrollerdb.txt).
...
in the [official Joypads demo](https://godotengine.org/asset-library/asset/2785).
...
[Input.add_joy_mapping()](../../classes/class_input.md#class-input-method-add-joy-mapping)
...
[planned](https://github.com/godotengine/godot/pull/109645)
in a future release.
...
is [planned](https://github.com/godotengine/godot/pull/109645) in a future release.
