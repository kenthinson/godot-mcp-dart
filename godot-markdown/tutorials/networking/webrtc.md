...
![image](tutorials/networking/img/webrtc_signaling.png)
...
WebRTC is implemented in Godot via two main classes [WebRTCPeerConnection](../../classes/class_webrtcpeerconnection.md#class-webrtcpeerconnection) and [WebRTCDataChannel](../../classes/class_webrtcdatachannel.md#class-webrtcdatachannel), plus the multiplayer API implementation [WebRTCMultiplayerPeer](../../classes/class_webrtcmultiplayerpeer.md#class-webrtcmultiplayerpeer). See section on [high-level multiplayer](high_level_multiplayer.md#doc-high-level-multiplayer) for more details.

#### NOTE
These classes are available automatically in HTML5, but **require an external GDExtension plugin on native (non-HTML5) platforms**. Check out the [webrtc-native plugin repository](https://github.com/godotengine/webrtc-native) for instructions and to get the latest [release](https://github.com/godotengine/webrtc-native/releases).
...
This example expands on the previous one, separating the peers in two different scenes, and using a [singleton](../scripting/singletons_autoload.md#doc-singletons-autoload) as a signaling server.
...
#### NOTE
This local signaling server is supposed to be used as a [singleton](../scripting/singletons_autoload.md#doc-singletons-autoload) to connect two peers in the same scene.
...
A more advanced demo using WebSocket for signaling peers and [WebRTCMultiplayerPeer](../../classes/class_webrtcmultiplayerpeer.md#class-webrtcmultiplayerpeer) is available in the [godot demo projects](https://github.com/godotengine/godot-demo-projects) under networking/webrtc_signaling.
