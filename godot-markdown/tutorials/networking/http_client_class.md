<a id="doc-http-client-class"></a>

# HTTP client class

[HTTPClient](../../classes/class_httpclient.md#class-httpclient) provides low-level access to HTTP communication.
For a higher-level interface, you may want to take a look at [HTTPRequest](../../classes/class_httprequest.md#class-httprequest) first,
which has a tutorial available [here](http_request_class.md#doc-http-request-class).
...
Here's an example of using the [HTTPClient](../../classes/class_httpclient.md#class-httpclient)
