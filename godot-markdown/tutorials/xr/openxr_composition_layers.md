<a id="doc-openxr-composition-layers"></a>
...
The solution then is to render the UI to a [SubViewport](../../classes/class_subviewport.md#class-subviewport)
and display the result of this using a [ViewportTexture](../../classes/class_viewporttexture.md#class-viewporttexture) on a 3D mesh.
The [QuadMesh](../../classes/class_quadmesh.md#class-quadmesh) is a suitable option for this.
...
- [OpenXRCompositionLayerCylinder](../../classes/class_openxrcompositionlayercylinder.md#class-openxrcompositionlayercylinder) shows the contents of the SubViewport on the inside of a cylinder (or "slice" of a cylinder).
- [OpenXRCompositionLayerEquirect](../../classes/class_openxrcompositionlayerequirect.md#class-openxrcompositionlayerequirect) shows the contents of the SubViewport on the interior of a sphere (or "slice" of a sphere).
- [OpenXRCompositionLayerQuad](../../classes/class_openxrcompositionlayerquad.md#class-openxrcompositionlayerquad) shows the contents of the SubViewport on a flat rectangle.
...
![image](tutorials/xr/img/openxr_composition_layer_subviewport.webp)
...
our [XROrigin3D](../../classes/class_xrorigin3d.md#class-xrorigin3d) node.
...
![image](tutorials/xr/img/openxr_composition_layer_quad.webp)
...
we prepare an [InputEventMouseMotion](../../classes/class_inputeventmousemotion.md#class-inputeventmousemotion) object
...
an [InputEventMouseButton](../../classes/class_inputeventmousebutton.md#class-inputeventmousebutton) object
...
![image](tutorials/xr/img/openxr_composition_layer_hole_punch.webp)
