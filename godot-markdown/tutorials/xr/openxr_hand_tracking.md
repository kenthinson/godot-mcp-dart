<a id="doc-openxr-hand-tracking"></a>
...
![image](tutorials/xr/img/xr_enable_handtracking.webp)
...
![image](tutorials/xr/img/openxr_enable_hand_tracking_meta.webp)
...
![image](tutorials/xr/img/openxr_hand_tracking_nodes.webp)
...
> * Tracking happens in the local space of the [XROrigin3D](../../classes/class_xrorigin3d.md#class-xrorigin3d) node.
...
For this you need to add an [XRNode3D](../../classes/class_xrnode3d.md#class-xrnode3d) node to your `XROrigin3D` node.
...
For this Godot uses the hand bone structure as defined for the [Godot Humanoid](../../classes/class_skeletonprofilehumanoid.md#class-skeletonprofilehumanoid)
...
We also need to enable editable children to gain access to our [Skeleton3D](../../classes/class_skeleton3d.md#class-skeleton3d) node.

### The hand skeleton modifier

Finally we need to add an [XRHandModifier3D](../../classes/class_xrhandmodifier3d.md#class-xrhandmodifier3d) node as a child to our `Skeleton3D` node.
...
Reacting to actions performed by the user is handled through [The XR action map](xr_action_map.md#doc-xr-action-map)
...
![image](tutorials/xr/img/openxr_hand_interaction_profile.webp)
...
![image](tutorials/xr/img/openxr_msft_hand_interaction_profile.webp)
...
![image](tutorials/xr/img/openxr_htc_hand_interaction_profile.webp)
...
![image](tutorials/xr/img/openxr_simple_controller_hand.webp)
...
You can obtain the full hand tracking data through the [XRHandTracker](../../classes/class_xrhandtracker.md#class-xrhandtracker)
