<a id="doc-openxr-render-models"></a>
...
The [OpenXRRenderModelManager](../../classes/class_openxrrendermodelmanager.md#class-openxrrendermodelmanager)
...
This node must have an [XROrigin3D](../../classes/class_xrorigin3d.md#class-xrorigin3d) node as an
ancestor.
...
child of our [XROrigin3D](../../classes/class_xrorigin3d.md#class-xrorigin3d) node.
...
[XROrigin3D](../../classes/class_xrorigin3d.md#class-xrorigin3d) node.
...
Use this in combination with an [XRController3D](../../classes/class_xrcontroller3d.md#class-xrcontroller3d)
...
![image](tutorials/xr/img/openxr_render_models_setup.webp)

In this setup we find an [OpenXRRenderModelManager](../../classes/class_openxrrendermodelmanager.md#class-openxrrendermodelmanager)
node directly underneath our [XROrigin3D](../../classes/class_xrorigin3d.md#class-xrorigin3d) node.
...
We have an [XRController3D](../../classes/class_xrcontroller3d.md#class-xrcontroller3d) that will track the
...
As a child of the node we have an [AnimatableBody3D](../../classes/class_animatablebody3d.md#class-animatablebody3d)
...
Finally we see another [OpenXRRenderModelManager](../../classes/class_openxrrendermodelmanager.md#class-openxrrendermodelmanager)
...
The [OpenXRRenderModel](../../classes/class_openxrrendermodel.md#class-openxrrendermodel) node implements
...
[OpenXRRenderModelManager](../../classes/class_openxrrendermodelmanager.md#class-openxrrendermodelmanager) nodes,
...
[OpenXRRenderModelExtension](../../classes/class_openxrrendermodelextension.md#class-openxrrendermodelextension)
singleton.
...
|--------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| render_model_get_all                       | Provides an array of RIDs for all render models<br/>that are being tracked.                                                                                        |
| render_model_new_scene_instance            | Provides a new scene that contains all meshes<br/>needed to display the render model.                                                                              |
| render_model_get_subaction_paths           | Provides a list of subaction paths from your<br/>action map related to this render mode.                                                                           |
| render_model_get_top_level_path            | Returns the top level path associated with this<br/>render model (if any).<br/>Use the `render_model_top_level_path_changed`<br/>signal to react to this changing. |
| render_model_get_confidence                | Returns the tracking confidence for the tracking<br/>data for this render model.                                                                                   |
| render_model_get_root_transform            | Returns the root transform for this render model<br/>within our current reference space. This can be<br/>used to place the render model in space.                  |
| render_model_get_animatable_node_count     | Returns the number of nodes in our render model<br/>scene that can be animated                                                                                     |
| render_model_get_animatable_node_name      | Returns the name of the node that we can animate.<br/>Note that this node can be any number of levels<br/>deep within the scene.                                   |
| render_model_is_animatable_node_visible    | Returns true if this animatable node should be<br/>visible                                                                                                         |
| render_model_get_animatable_node_transform | Returns the transform for this animatable node.<br/>This is a local transform that can be directly<br/>applied.                                                    |
