...
In traditional first person games a player is represented by a [CharacterBody3D](../../classes/class_characterbody3d.md#class-characterbody3d) node.
...
Applying this model to the XR setup, we add an [XROrigin3D](../../classes/class_xrorigin3d.md#class-xrorigin3d) node as a child of the character body,
and add an [XRCamera3D](../../classes/class_xrcamera3d.md#class-xrcamera3d) as a child of the origin node. At face value this seems to work.
...
![image](tutorials/xr/img/XRRoomCenterWalk.gif)
...
![image](tutorials/xr/img/XRRoomWalkOffCliff.gif)
...
![image](tutorials/xr/img/XRRoomRotateOrigin.gif)
...
![image](tutorials/xr/img/XRRoomWalkWall.gif)
...
![image](tutorials/xr/img/xr_room_scale_origin_body.webp)
...
#### NOTE
The [Origin centric movement demo](https://github.com/godotengine/godot-demo-projects/tree/master/xr/openxr_origin_centric_movement) contains a more elaborate example of the technique described below.
...
![image](tutorials/xr/img/xr_room_scale_character_body.webp)
...
#### NOTE
The [Character centric movement demo](https://github.com/godotengine/godot-demo-projects/tree/master/xr/openxr_character_centric_movement) contains a more elaborate example of the technique described below.
