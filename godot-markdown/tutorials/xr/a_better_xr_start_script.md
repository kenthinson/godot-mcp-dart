<a id="doc-a-better-xr-start-script"></a>

# A better XR start script

In [Setting up XR](setting_up_xr.md#doc-setting-up-xr) we introduced a startup script that initialises our setup which we used as our script on our main node.
...
Alternatively, if you are using XR Tools (see [Introducing XR tools](introducing_xr_tools.md#doc-introducing-xr-tools)) it contains a version of this script updated with some features related to XR tools.
...
- `xr_interface` holds a reference to our XR interface, this already existed but we now type it to get full access to our [XRInterface](../../classes/class_xrinterface.md#class-xrinterface) API.
...
See [OpenXR Settings](openxr_settings.md#doc-openxr-settings) for further details.

We hook up a number of signals that will be emitted by the [XRInterface](../../classes/class_xrinterface.md#class-xrinterface).
...
Often it is enough to call [center_on_hmd()](../../classes/class_xrserver.md#class-xrserver-method-center-on-hmd).
