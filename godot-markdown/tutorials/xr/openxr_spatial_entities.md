<a id="doc-openxr-spatial-entities"></a>
...
![image](tutorials/xr/img/openxr_spatial_entities_project_settings.webp)

#### Spatial entity settings

| Setting                          | Description                                                                                                                                                          |
|----------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Enabled                          | Enables the core of the spatial entities system. This must be enabled for any of the spatial<br/>entities systems to work.                                           |
| Enable spatial anchors           | Enables the spatial anchors capability that allow creating and tracking spatial anchors.                                                                             |
| Enable persistent anchors        | Enables the ability to make spatial anchors persistent. This means that their location is stored<br/>and can be retrieved in subsequent sessions.                    |
| Enable built-in anchor detection | Enables our built-in anchor detection logic, this will automatically retrieve persistent anchors<br/>and adjust the positioning of anchors when tracking is updated. |
| Enable plane tracking            | Enables the plane tracking capability that allows detection of surfaces such as floors, walls,<br/>ceilings, and tables.                                             |
| Enable built-in plane detection  | Enables our built-in plane detection logic, this will automatically react to new plane data<br/>becoming available.                                                  |
| Enable marker tracking           | Enables our marker tracking capability that allows detection of markers such as QR codes,<br/>Aruco markers, and April tags.                                         |
| Enable built-in marker tracking  | Enables our built-in marker detection logic, this will automatically react to new markers being<br/>found or markers being moved around the player's space.          |
...
[OpenXRSpatialEntityTracker](../../classes/class_openxrspatialentitytracker.md#class-openxrspatialentitytracker)
object is instantiated and registered with the [XRServer](../../classes/class_xrserver.md#class-xrserver).
...
As the tracker objects can be used with [XRAnchor3D](../../classes/class_xranchor3d.md#class-xranchor3d) nodes, these subscenes
...
object. As all locations are local to the [XROrigin3D](../../classes/class_xrorigin3d.md#class-xrorigin3d) node, we should create
...
Spatial anchors are tracked using [OpenXRAnchorTracker](../../classes/class_openxranchortracker.md#class-openxranchortracker) objects
registered with the XRServer.

When needed, the location of the spatial anchor will be updated automatically; the pose on the
related tracker will be updated and thus the [XRAnchor3D](../../classes/class_xranchor3d.md#class-xranchor3d) node will
reposition.
...
This scene should have an [XRAnchor3D](../../classes/class_xranchor3d.md#class-xranchor3d) node as the root but nothing
...
The root node for this scene must be an [XRAnchor3D](../../classes/class_xranchor3d.md#class-xranchor3d) node.
We'll add a [StaticBody3D](../../classes/class_staticbody3d.md#class-staticbody3d) node as a child and add a
[CollisionShape3D](../../classes/class_collisionshape3d.md#class-collisionshape3d) and [MeshInstance3D](../../classes/class_meshinstance3d.md#class-meshinstance3d)
node as children of the static body.

![image](tutorials/xr/img/openxr_plane_anchor.webp)
...
For our "hole punch" material, create a [ShaderMaterial](../../classes/class_shadermaterial.md#class-shadermaterial)
...
Please consult the [OpenXRPlaneTracker](../../classes/class_openxrplanetracker.md#class-openxrplanetracker) class documentation for
further information.
...
When markers are detected, [OpenXRMarkerTracker](../../classes/class_openxrmarkertracker.md#class-openxrmarkertracker) objects are
...
with an [XRAnchor3D](../../classes/class_xranchor3d.md#class-xranchor3d) node at the root, save this, and assign it to the
...
[OpenXRSpatialEntityExtension](../../classes/class_openxrspatialentityextension.md#class-openxrspatialentityextension) singleton.
...
entry and that is [OpenXRSpatialQueryResultData](../../classes/class_openxrspatialqueryresultdata.md#class-openxrspatialqueryresultdata).
...
[OpenXRSpatialEntityTracker](../../classes/class_openxrspatialentitytracker.md#class-openxrspatialentitytracker) instance is destroyed.

### Spatial anchor capability

Spatial anchors are managed by our [OpenXRSpatialAnchorCapability](../../classes/class_openxrspatialanchorcapability.md#class-openxrspatialanchorcapability)
singleton object.
...
[OpenXRSpatialCapabilityConfigurationAnchor](../../classes/class_openxrspatialcapabilityconfigurationanchor.md#class-openxrspatialcapabilityconfigurationanchor)
...
| Enum                             | Description                                                                                                                                                                                                                                                                                                     |
|----------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| PERSISTENCE_SCOPE_SYSTEM_MANAGED | Provides the application with read-only access (i.e. applications cannot modify this store)<br/>to spatial entities persisted and managed by the system.<br/>The application can use the UUID in the persistence component for this store to correlate<br/>entities across spatial contexts and device reboots. |
| PERSISTENCE_SCOPE_LOCAL_ANCHORS  | Persistence operations and data access is limited to spatial anchors, on the same device,<br/>for the same user and app (using persist_anchor and<br/>unpersist_anchor functions)                                                                                                                               |
...
|----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|
| COMPONENT_TYPE_ANCHOR      | [OpenXRSpatialComponentAnchorList](../../classes/class_openxrspatialcomponentanchorlist.md#class-openxrspatialcomponentanchorlist)                | Provides us with the pose (location + orientation) of each anchor |
| COMPONENT_TYPE_PERSISTENCE | [OpenXRSpatialComponentPersistenceList](../../classes/class_openxrspatialcomponentpersistencelist.md#class-openxrspatialcomponentpersistencelist) | Provides us with the persistence state and UUID of each anchor    |
```gdscript
...
...
Finally we can process our snapshot. Note that we are using [OpenXRAnchorTracker](../../classes/class_openxranchortracker.md#class-openxranchortracker)
...
[OpenXRSpatialPlaneTrackingCapability](../../classes/class_openxrspatialplanetrackingcapability.md#class-openxrspatialplanetrackingcapability)
singleton class.
...
#### Plane tracking components

| Component                           | Data class                                                                                                                                                             | Description                                                             |
|-------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| COMPONENT_TYPE_BOUNDED_2D           | [OpenXRSpatialComponentBounded2DList](../../classes/class_openxrspatialcomponentbounded2dlist.md#class-openxrspatialcomponentbounded2dlist)                            | Provides us with the center pose and bounding rectangle for each plane. |
| COMPONENT_TYPE_PLANE_ALIGNMENT      | [OpenXRSpatialComponentPlaneAlignmentList](../../classes/class_openxrspatialcomponentplanealignmentlist.md#class-openxrspatialcomponentplanealignmentlist)             | Provides us with the alignment of each plane                            |
| COMPONENT_TYPE_MESH_2D              | [OpenXRSpatialComponentMesh2DList](../../classes/class_openxrspatialcomponentmesh2dlist.md#class-openxrspatialcomponentmesh2dlist)                                     | Provides us with a 2D mesh that shapes each plane                       |
| COMPONENT_TYPE_POLYGON_2D           | [OpenXRSpatialComponentPolygon2DList](../../classes/class_openxrspatialcomponentpolygon2dlist.md#class-openxrspatialcomponentpolygon2dlist)                            | Provides us with a 2D polygon that shapes each plane                    |
| COMPONENT_TYPE_PLANE_SEMANTIC_LABEL | [OpenXRSpatialComponentPlaneSemanticLabelList](../../classes/class_openxrspatialcomponentplanesemanticlabellist.md#class-openxrspatialcomponentplanesemanticlabellist) | Provides us with a type identification of each plane                    |
...
We can use our [OpenXRPlaneTracker](../../classes/class_openxrplanetracker.md#class-openxrplanetracker) tracker object to store our component data.
...
[OpenXRSpatialMarkerTrackingCapability](../../classes/class_openxrspatialmarkertrackingcapability.md#class-openxrspatialmarkertrackingcapability)
singleton class.
...
#### Marker tracking options

| Option        | Check for support           | Configuration object                                                                                                                                                            |
|---------------|-----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| April tag     | `april_tag_is_supported`    | [OpenXRSpatialCapabilityConfigurationAprilTag](../../classes/class_openxrspatialcapabilityconfigurationapriltag.md#class-openxrspatialcapabilityconfigurationapriltag)          |
| Aruco         | `aruco_is_supported`        | [OpenXRSpatialCapabilityConfigurationAruco](../../classes/class_openxrspatialcapabilityconfigurationaruco.md#class-openxrspatialcapabilityconfigurationaruco)                   |
| QR code       | `qrcode_is_supported`       | [OpenXRSpatialCapabilityConfigurationQrCode](../../classes/class_openxrspatialcapabilityconfigurationqrcode.md#class-openxrspatialcapabilityconfigurationqrcode)                |
| Micro QR code | `micro_qrcode_is_supported` | [OpenXRSpatialCapabilityConfigurationMicroQrCode](../../classes/class_openxrspatialcapabilityconfigurationmicroqrcode.md#class-openxrspatialcapabilityconfigurationmicroqrcode) |
...
#### Marker tracking components

| Component                 | Data class                                                                                                                                  | Description                                                                                 |
|---------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| COMPONENT_TYPE_MARKER     | [OpenXRSpatialComponentMarkerList](../../classes/class_openxrspatialcomponentmarkerlist.md#class-openxrspatialcomponentmarkerlist)          | Provides us with the type, ID (Aruco and April Tag), and/or data (QR Code) for each marker. |
| COMPONENT_TYPE_BOUNDED_2D | [OpenXRSpatialComponentBounded2DList](../../classes/class_openxrspatialcomponentbounded2dlist.md#class-openxrspatialcomponentbounded2dlist) | Provides us with the center pose and bounding rectangle for each plane.                     |
