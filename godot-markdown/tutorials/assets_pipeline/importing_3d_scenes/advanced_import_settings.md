<a id="doc-advanced-import-settings"></a>
...
and animation previews. To open it select the Advanced... button at the
bottom of the import dock.

![image](tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_advanced_import_settings_button.webp)
...
[Import configuration](import_configuration.md#doc-importing-3d-scenes-import-configuration) page.
...
![Advanced Import Settings dialog (Scene tab)](tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_advanced_import_settings_scene.webp)
...
![Selecting a node in the Advanced Import Settings dialog (Scene tab)](tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_advanced_import_settings_node.webp)
...
- **Generate > NavMesh:** If checked, generates a NavigationRegion3D *child*
  node for [navigation](../../navigation/navigation_introduction_3d.md#doc-navigation-overview-3d). **Mesh + NavMesh**
...
- **Generate > Occluder:** If checked, generates an OccluderInstance3D *sibling*
  node for [occlusion culling](../../3d/occlusion_culling.md#doc-occlusion-culling) using the mesh's
...
![Advanced Import Settings dialog (Meshes tab)](tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_advanced_import_settings_meshes.webp)

The options are as follows:

- **Save to File:** Saves the [Mesh](../../../classes/class_mesh.md#class-mesh) *resource* to an external file
  ...
  nodes, such as [MeshInstance3D](../../../classes/class_meshinstance3d.md#class-meshinstance3d), [MultiMeshInstance3D](../../../classes/class_multimeshinstance3d.md#class-multimeshinstance3d),
  [GPUParticles3D](../../../classes/class_gpuparticles3d.md#class-gpuparticles3d) or [CPUParticles3D](../../../classes/class_cpuparticles3d.md#class-cpuparticles3d).
...
- **Generate > Shadow Meshes:** Per-mesh override for the **Meshes > Create
  ...
  [Using the Import dock](import_configuration.md#doc-importing-3d-scenes-using-the-import-dock). **Default** will use the
...
![Advanced Import Settings dialog (Materials tab)](tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_advanced_import_settings_materials.webp)
...
![Extracting all built-in materials to external resources in the Advanced Import Settings dialog](tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_advanced_import_settings_extract_materials.webp)

After choosing this option, select a folder to extract material `.tres` files
to, then confirm the extraction:

![Confirming material extraction in the Advanced Import Settings subdialog](tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_advanced_import_settings_extract_materials_confirm.webp)
...
Several extra options are available for the generated [AnimationPlayer](../../../classes/class_animationplayer.md#class-animationplayer)
