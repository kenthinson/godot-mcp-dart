<a id="doc-importing-3d-scenes-model-export-considerations"></a>
...
textures, they can work in Godot. This includes the [Substance suite](https://www.adobe.com/creativecloud/3d-ar.html),
[ArmorPaint (open source)](https://armorpaint.org/), and [Material Maker (open source)](https://github.com/RodZill4/material-maker).

#### SEE ALSO
For more information on Godot's materials, see [Standard Material 3D and ORM Material 3D](../../3d/standard_material_3d.md#doc-standard-material-3d).
