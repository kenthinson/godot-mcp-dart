<a id="doc-importing-3d-scenes-available-formats"></a>
...
- FBX, supported via the [ufbx](https://github.com/ufbx/ufbx) library. The
  previous import workflow used [FBX2glTF](https://github.com/godotengine/FBX2glTF)
...
![Diagram explaining the runtime import and export process for glTF files in Godot](tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_available_formats_gltf_runtime.webp)
...
![Diagram explaining the editor import process for glTF files in Godot](tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_available_formats_gltf_editor.webp)
...
The editor can directly import `.blend` files by calling [Blender](https://www.blender.org/)'s
...
![Diagram explaining the import process for Blender files in Godot](tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_available_formats_blend.webp)
...
- Change their import mode to **OBJ as Scene** in the Import dock then restart
  ...
  scenes, such as unwrapping UV2 on import (for [Using Lightmap global illumination](../../3d/global_illumination/using_lightmap_gi.md#doc-using-lightmap-gi)).
...
unless you have a specific reason to use it, you need to download the [FBX2glTF](https://github.com/godotengine/FBX2glTF)
...
![Diagram explaining the import process for FBX files in Godot  via FBX2glTF](tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_available_formats_fbx.webp)

#### SEE ALSO
The full installation process for using FBX2glTF in Godot is described on the
[FBX import page of the Godot website](https://godotengine.org/fbx-import).
