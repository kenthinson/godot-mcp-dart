<a id="doc-importing-3d-scenes-import-configuration"></a>
...
[Model export considerations](model_export_considerations.md#doc-importing-3d-scenes-model-export-considerations) and
[Node type customization using name suffixes](node_type_customization.md#doc-importing-3d-scenes-node-type-customization) articles
...
![Import dock after selecting a 3D scene in the FileSystem dock](tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_import_dock.webp)
...
- The **Advanced Import Settings** dialog, which can be accessed by double-clicking
  ...
  preview models and animations. please see the [Advanced Import Settings](advanced_import_settings.md#doc-advanced-import-settings)
  page for more information.
- [Import hints](node_type_customization.md#doc-importing-3d-scenes-node-type-customization), which are special
...
<a id="doc-importing-3d-scenes-using-the-import-dock"></a>
...
- **Generate LODs:** If checked, generates lower detail variants of the
  ...
  See [Mesh level of detail (LOD)](../../3d/mesh_lod.md#doc-mesh-lod) for more information.
...
- **Light Baking:** Configures the meshes'
  [global illumination mode](../../../classes/class_geometryinstance3d.md#class-geometryinstance3d-property-gi-mode)
  in the 3D scene. If set to **Static Lightmaps**, sets the meshes' GI mode to
  **Static** and generates UV2 on import for [lightmap baking](../../3d/global_illumination/using_lightmap_gi.md#doc-using-lightmap-gi).
...
- **Use Named Skins:** If checked, use named [Skins](../../../classes/class_skin.md#class-skin) for animation.
  The [MeshInstance3D](../../../classes/class_meshinstance3d.md#class-meshinstance3d) node contains 3 properties of relevance here: a skeleton
  NodePath pointing to the Skeleton3D node (usually `..`), a mesh, and a skin:
  - The [Skeleton3D](../../../classes/class_skeleton3d.md#class-skeleton3d) node contains a list of bones with names, their pose and rest,
...
- **Path:** Path to an import script, which can run code *after*
  ...
  See [Using import scripts for automation](#doc-importing-3d-scenes-import-script) for more information.
...
- **Custom Properties:** If checked, imports custom properties from Blender as glTF extras.
  ...
  [GLTFDocument.register_gltf_document_extension()](../../../classes/class_gltfdocument.md#class-gltfdocument-method-register-gltf-document-extension),
...
- **Export Geometry Nodes Instances:** If checked, imports
  [geometry node](https://docs.blender.org/manual/en/latest/modeling/geometry_nodes/introduction.html)
...
<a id="doc-importing-3d-scenes-import-script"></a>
...
![Changing the import type to Animation Library in the Import dock](tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_changing_import_type.webp)

Click **Reimport** and restart the editor when prompted. After restarting, the
glTF file will be imported as an [AnimationLibrary](../../../classes/class_animationlibrary.md#class-animationlibrary) instead of a
[PackedScene](../../../classes/class_packedscene.md#class-packedscene). This animation library can then be referenced in an
...
[Using the Import dock](#doc-importing-3d-scenes-using-the-import-dock) for more information.
...
[String.matchn()](../../../classes/class_string.md#class-string-method-matchn) under the hood).
...
![Dialog when opening an imported 3D scene in the editor](tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_create_inherited_scene_dialog.webp)
