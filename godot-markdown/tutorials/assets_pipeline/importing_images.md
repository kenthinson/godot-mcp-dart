...
- Khronos Texture (`.ktx`)
  - Decoding is done using [libktx](https://github.com/KhronosGroup/KTX-Software).
...
- SVG (`.svg`)
  ...
  when importing them. [Support is limited](https://www.thorvg.org/about#:~:text=certain%20features%20remain%20unsupported%20within%20the%20current%20framework);
  complex vectors may not render correctly. [Text must be converted to paths](#doc-importing-images-svg-text);
  ...
  For complex vectors, rendering them to PNGs using [Inkscape](https://inkscape.org/)
...
without converting them back to an [Image](../../classes/class_image.md#class-image) in a script. This is what
...
![Import options in the Import dock after selecting an image in the FileSystem dock](tutorials/assets_pipeline/img/importing_images_import_dock.webp)

<a id="doc-importing-images-changing-import-type"></a>
...
- **BitMap:** 1-bit monochrome texture (intended to be used as a click mask in
  [TextureButton](../../classes/class_texturebutton.md#class-texturebutton) and [TouchScreenButton](../../classes/class_touchscreenbutton.md#class-touchscreenbutton)). This resource
  type cannot be displayed directly onto 2D or 3D nodes, but the pixel values
  can be queried from a script using [get_bit](../../classes/class_bitmap.md#class-bitmap-method-get-bit).
...
- **Font Data (Monospace Image Font):** Import the image as a bitmap font where
  all characters have the same width. See [Using Fonts](../ui/gui_using_fonts.md#doc-gui-using-fonts).
- **Image:** Import the image as-is. This resource type cannot be displayed
  ...
  script using [get_pixel](../../classes/class_image.md#class-image-method-get-pixel).
...
- **Texture2DArray:** Import the image as a collection of 2-dimensional textures.
  ...
  texture arrays, so you must create a custom shader in [2D](../shaders/shader_reference/canvas_item_shader.md#doc-canvas-item-shader)
  or [3D](../shaders/shader_reference/spatial_shader.md#doc-spatial-shader) to display a texture from a texture array.
- **Texture3D:** Import the image as a 3-dimensional texture. This is *not* a 2D
  ...
  [FogMaterial](../../classes/class_fogmaterial.md#class-fogmaterial) density maps in [volumetric fog](../3d/volumetric_fog.md#doc-volumetric-fog), [particle attractor](../3d/particles/attractors.md#doc-3d-particles-attractors)
  vector fields, [Environment](../../classes/class_environment.md#class-environment) 3D LUT color correction, and custom shaders.
...
[BaseMaterial3D](../../classes/class_basematerial3d.md#class-basematerial3d)). If this happens, several import options are
...
[Detect 3D > Compress To](#doc-importing-images-detect-3d-compress-to) is changed. The texture is
...
[Detect 3D > Compress To](#doc-importing-images-detect-3d-compress-to) option before using the
texture in 3D, or change [Compress > Mode](#doc-importing-images-compress-mode) to
...
[per-material configuration in 3D](../3d/standard_material_3d.md#doc-standard-material-3d-sampling).
In custom shaders, filter and repeat mode is changed on the `sampler2D`
uniform using hints described in the [Shading language](../shaders/shader_reference/shading_language.md#doc-shading-language)
documentation.

<a id="doc-importing-images-compress-mode"></a>
...
advantages and disadvantages (![good](tutorials/assets_pipeline/img/good.png) = best, ![bad](tutorials/assets_pipeline/img/bad.png) = worst):
...
| **Size on disk** | ![regular](tutorials/assets_pipeline/img/regular.png) Small  | ![good](tutorials/assets_pipeline/img/good.png) Very small   | ![regular](tutorials/assets_pipeline/img/regular.png) Small | ![bad](tutorials/assets_pipeline/img/bad.png) Large          | ![good](tutorials/assets_pipeline/img/good.png) Very small   |
| **Memory usage** | ![bad](tutorials/assets_pipeline/img/bad.png) Large          | ![bad](tutorials/assets_pipeline/img/bad.png) Large          | ![good](tutorials/assets_pipeline/img/good.png) Small       | ![bad](tutorials/assets_pipeline/img/bad.png) Large          | ![good](tutorials/assets_pipeline/img/good.png) Small        |
| **Performance**  | ![regular](tutorials/assets_pipeline/img/regular.png) Normal | ![regular](tutorials/assets_pipeline/img/regular.png) Normal | ![good](tutorials/assets_pipeline/img/good.png) Fast        | ![regular](tutorials/assets_pipeline/img/regular.png) Normal | ![good](tutorials/assets_pipeline/img/good.png) Fast         |
| **Quality loss** | ![good](tutorials/assets_pipeline/img/good.png) None         | ![regular](tutorials/assets_pipeline/img/regular.png) Slight | ![bad](tutorials/assets_pipeline/img/bad.png) Moderate      | ![good](tutorials/assets_pipeline/img/good.png) None         | ![bad](tutorials/assets_pipeline/img/bad.png) Moderate       |
| **Load time**    | ![bad](tutorials/assets_pipeline/img/bad.png) Slow           | ![bad](tutorials/assets_pipeline/img/bad.png) Slow           | ![good](tutorials/assets_pipeline/img/good.png) Fast        | ![regular](tutorials/assets_pipeline/img/regular.png) Normal | ![regular](tutorials/assets_pipeline/img/regular.png) Normal |
...
|----------------|----------------------------------------------------------------|----------------------------------------------------------------|----------------------------------------------------------------|----------------------------------------------------------------|----------------------------------------------------------------|
| **128×128**    | ![good](tutorials/assets_pipeline/img/good.png) 85 KiB         | ![good](tutorials/assets_pipeline/img/good.png) 85 KiB         | ![good](tutorials/assets_pipeline/img/good.png) 21 KiB         | ![good](tutorials/assets_pipeline/img/good.png) 85 KiB         | ![good](tutorials/assets_pipeline/img/good.png) 21 KiB         |
| **256×256**    | ![good](tutorials/assets_pipeline/img/good.png) 341 KiB        | ![good](tutorials/assets_pipeline/img/good.png) 341 KiB        | ![good](tutorials/assets_pipeline/img/good.png) 85 KiB         | ![good](tutorials/assets_pipeline/img/good.png) 341 KiB        | ![good](tutorials/assets_pipeline/img/good.png) 85 KiB         |
| **512×512**    | ![good](tutorials/assets_pipeline/img/good.png) 1.33 MiB       | ![good](tutorials/assets_pipeline/img/good.png) 1.33 MiB       | ![good](tutorials/assets_pipeline/img/good.png) 341 KiB        | ![good](tutorials/assets_pipeline/img/good.png) 1.33 MiB       | ![good](tutorials/assets_pipeline/img/good.png) 341 KiB        |
| **1024×1024**  | ![regular](tutorials/assets_pipeline/img/regular.png) 5.33 MiB | ![regular](tutorials/assets_pipeline/img/regular.png) 5.33 MiB | ![good](tutorials/assets_pipeline/img/good.png) 1.33 MiB       | ![regular](tutorials/assets_pipeline/img/regular.png) 5.33 MiB | ![good](tutorials/assets_pipeline/img/good.png) 1.33 MiB       |
| **2048×2048**  | ![bad](tutorials/assets_pipeline/img/bad.png) 21.33 MiB        | ![bad](tutorials/assets_pipeline/img/bad.png) 21.33 MiB        | ![regular](tutorials/assets_pipeline/img/regular.png) 5.33 MiB | ![bad](tutorials/assets_pipeline/img/bad.png) 21.33 MiB        | ![regular](tutorials/assets_pipeline/img/regular.png) 5.33 MiB |
| **4096×4096**  | ![bad](tutorials/assets_pipeline/img/bad.png) 85.33 MiB        | ![bad](tutorials/assets_pipeline/img/bad.png) 85.33 MiB        | ![bad](tutorials/assets_pipeline/img/bad.png) 21.33 MiB        | ![bad](tutorials/assets_pipeline/img/bad.png) 85.33 MiB        | ![bad](tutorials/assets_pipeline/img/bad.png) 21.33 MiB        |
...
![Previewing a texture in the Inspector](tutorials/assets_pipeline/img/importing_images_inspector_preview.webp)
...
If enabled, uses BPTC compression on desktop platforms and  compression on mobile platforms. When using BPTC,
...
don't look that nice in normal maps, the 
compression format is the best fit for this data. Forcing this option to **Enable**
will make Godot import the image as  compressed.
...
Note that  compression affects the
...
![Normal map with standard VRAM compression (left) and with RGTC VRAM compression (right)](tutorials/assets_pipeline/img/importing_images_normal_map_rgtc.webp)
...
textures ([Cubemap](../../classes/class_cubemap.md#class-cubemap), [CubemapArray](../../classes/class_cubemaparray.md#class-cubemaparray), [Texture2DArray](../../classes/class_texture2darray.md#class-texture2darray)
and [Texture3D](../../classes/class_texture3d.md#class-texture3d)). This forces all layers from the texture to be imported
with the RG color format, with only the red and green
channels preserved.  compression is able to
...
<a id="doc-importing-images-mipmaps"></a>
...
![image](tutorials/assets_pipeline/img/fixedborder.png)
...
- In 2D, a [CanvasItemMaterial](../../classes/class_canvasitemmaterial.md#class-canvasitemmaterial) will need to be created and
  configured to use the **Premul Alpha** blend mode on CanvasItems that use this
  texture. In [custom canvas item shaders](../shaders/shader_reference/canvas_item_shader.md#doc-canvas-item-shader),
  `render_mode blend_premul_alpha;` should be used.
- In 3D, a [BaseMaterial3D](../../classes/class_basematerial3d.md#class-basematerial3d) will need to be created and configured
  to use the **Premul Alpha** blend mode on materials that use this texture.
  In [custom spatial shaders](../shaders/shader_reference/spatial_shader.md#doc-spatial-shader),
  `render_mode blend_premul_alpha;` should be used.
...
<a id="doc-importing-images-detect-3d-compress-to"></a>

### Detect 3D > Compress To

This changes the [Compress > Mode](#doc-importing-images-compress-mode) option that is used
...
<a id="doc-importing-images-editor-import-options"></a>
...
[Godot's own color palette for editor icons](../../engine_details/editor/creating_icons.md#doc-editor-icons), with the
...
<a id="doc-importing-images-svg-text"></a>
...
To support [multiple resolutions](../rendering/multiple_resolutions.md#doc-multiple-resolutions) with crisp
...
[runtime file loading and saving](../io/runtime_file_loading_and_saving.md#doc-runtime-file-loading-and-saving-images),
