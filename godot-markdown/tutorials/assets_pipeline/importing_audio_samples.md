<a id="doc-importing-audio-samples"></a>
...
type. The above figures use  encoding for
simplicity, but most Ogg Vorbis and MP3 files you can find online are encoded
with  encoding which is more efficient.
...
![Import options in the Import dock after selecting a WAV file in the FileSystem dock](tutorials/assets_pipeline/img/importing_audio_samples_import_options_wav.webp)

The set of options available after selecting an Ogg Vorbis or MP3 file is different:

![Import options in the Import dock after selecting an MP3 file in the FileSystem dock](tutorials/assets_pipeline/img/importing_audio_samples_import_options_mp3.webp)

After importing a sound, you can play it back using the AudioStreamPlayer,
AudioStreamPlayer2D or AudioStreamPlayer3D nodes. See [Audio streams](../audio/audio_streams.md#doc-audio-streams)
...
[Best practices](#doc-importing-audio-samples-best-practices) for more information.

## Edit > Trim

The source audio file may contain long silences at the beginning and/or the end.
These silences are inserted by  when
...
[Advanced import settings](#doc-importing-audio-samples-advanced-import-settings)
...
<a id="doc-importing-audio-samples-advanced-import-settings"></a>
...
![Advanced dialog when double-clicking an Ogg Vorbis or MP3 file in the FileSystem dock](tutorials/assets_pipeline/img/importing_audio_samples_advanced_import_settings.webp)

This dialog allows you to edit the audio's loop point with a real-time preview,
in addition to the , beat count and bar beats.
...
<a id="doc-importing-audio-samples-best-practices"></a>
...
Godot has an [extensive bus system](../audio/audio_buses.md#doc-audio-buses) with built-in effects.
...
![image](tutorials/assets_pipeline/img/reverb.png)
...
[runtime file loading and saving](../io/runtime_file_loading_and_saving.md#doc-runtime-file-loading-and-saving-audio-video-files),
