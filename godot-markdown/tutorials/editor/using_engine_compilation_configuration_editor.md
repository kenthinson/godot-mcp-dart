<a id="doc-engine-compilation-configuration-editor"></a>
...
with certain features disabled. This is described in detail in [Optimizing a build for size](../../engine_details/development/compiling/optimizing_for_size.md#doc-optimizing-for-size).
...
The Project > Tools > Engine Compilation Configuration Editor
...
- Use the Detect from Project button to automatically detect features
...
![Opening the Engine Compilation Configuration Editor](tutorials/editor/img/engine_compilation_configuration_editor_detect.webp)

Once you click Detect from Project, the project detection step will run.
...
![Updated features list after using feature detection (example from the 3D platformer demo)](tutorials/editor/img/engine_compilation_configuration_editor_detected.webp)
...
This file can be passed as a SCons option when [compiling](../../engine_details/development/compiling/index.md#doc-compiling-index)
export templates:
...
The Detect from Project functionality relies on reading the project's scenes and scripts.
...
- Features that are used in [expressions](../scripting/evaluating_expressions.md#doc-evaluating-expressions).
- Features that are used in [GDExtensions](../scripting/gdextension/index.md#doc-gdextension), unless the language binding
  allows for defining used classes and the extension makes use of the functionality.
  See [GH-104129](https://github.com/godotengine/godot/pull/104129) for details.
- Features that are used in [external PCKs loaded at runtime](../export/exporting_pcks.md#doc-exporting-pcks).
- Certain edge cases may exist. If unsure, please
  [open an issue on GitHub](https://github.com/godotengine/godot/issues)
...
See [Optimizing a build for size](../../engine_details/development/compiling/optimizing_for_size.md#doc-optimizing-for-size) for more information.
