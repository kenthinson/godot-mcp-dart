<a id="doc-editor-inspector-dock"></a>
...
![image](tutorials/editor/img/inspector_overview.webp)
...
![image](tutorials/editor/img/inspector_top_buttons.webp)
...
![image](tutorials/editor/img/inspector_dock_overlay.webp)
...
![image](tutorials/editor/img/inspector_dock_subresource.webp)
...
The values with different values than their original values will have a revert icon (![undo](tutorials/editor/img/inspector_dock_revert.webp)).
...
![image](tutorials/editor/img/inspector_tools_menu.webp)
...
- **Expand Non-Default**: Only expands the sections where the original value is different
  than the current value (the properties with a revert icon (![undo](tutorials/editor/img/inspector_dock_revert.webp))).
...
#### SEE ALSO
Refer to [Customizing the interface](customizing_editor.md#doc-customizing-editor) for dock customization options.
