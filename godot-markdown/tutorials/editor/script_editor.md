<a id="doc-script-editor"></a>

# Script Editor

<a id="doc-script-editor-introduction"></a>
...
[Integrated class reference](../../getting_started/introduction/first_look_at_the_editor.md#doc-intro-to-the-editor-interface-integrated-class-reference).

![image](tutorials/editor/img/script_editor_icons/text_editor.webp)

<a id="doc-script-editor-features"></a>
...
<a id="doc-script-editor-usage"></a>
...
in your project, see [Using an external text editor](external_editor.md#doc-external-editor) and
[Configuring an external editor](../scripting/c_sharp/c_sharp_basics.md#doc-c-sharp-setup-external-editor).

![image](tutorials/editor/img/editor_ui_script_editor_open.webp)
...
![image](tutorials/editor/img/editor_ui_script_editor_menu.webp)
...
For a complete shortcut list, see the [text editor shortcuts](default_key_mapping.md#doc-default-key-mapping-shortcuts-text-editor).
...
<a id="doc-script-editor-script-panel"></a>

### Script Panel

![image](tutorials/editor/img/editor_ui_script_editor_script_panel.webp)
...
to the file name. For example, the ![script](tutorials/editor/img/script_editor_icons/Script.webp) icon means that it is a GDScript.
the ![scriptcsharp](tutorials/editor/img/script_editor_icons/ScriptCSharp.webp) means it is a C# script. The ![documentation](tutorials/editor/img/script_editor_icons/Documentation.webp) means that this is a
built-in class reference. Finally, the ![toolscript](tutorials/editor/img/script_editor_icons/ToolScript.webp) means it is a currently running
script (See [tool annotation](../plugins/running_code_in_the_editor.md#doc-running-code-in-the-editor) for more on this).
...
<a id="doc-script-editor-menus"></a>
...
![image](tutorials/editor/img/script_editor_icons/text_editor_menu.webp)

The **File** menu provides the following options:

![image](tutorials/editor/img/script_editor_icons/text_editor_file_menu.webp)
...
- **Soft Reload Tool Script**: If the selected script is a
  [tool](../plugins/running_code_in_the_editor.md#doc-running-code-in-the-editor), reloads the script to execute it again.
...
- **Close Docs**: Closes the class reference documentation pages, leaving only the
  scripts.
- **Run**: If the script extends [EditorScript](../../classes/class_editorscript.md#class-editorscript) and
  intended to be executed without running the project, this option runs the script.
  See [Running one-off scripts using EditorScript](../plugins/running_code_in_the_editor.md#doc-running-code-in-the-editor-editorscript) for more.
- **Toggle Scripts Panel**: Shows or hides the script panel located on the left side
  ...
  Scripts Panel is explained [above](#doc-script-editor-script-panel).

The **Edit** menu provides several options for line operations:

![image](tutorials/editor/img/script_editor_icons/text_editor_edit_menu.webp)
...
- **Folding**: Provides a set of folding options for the selected text. Depending on the
  ...
  - **Create Code Region\***: Wraps the selected text in a foldable code region to improve
    the readability of larger scripts. See [Built-in types](../scripting/gdscript/gdscript_basics.md#doc-gdscript-builtin-types) for more.
...
![image](tutorials/editor/img/script_editor_icons/text_editor_search_menu.webp)
...
![image](tutorials/editor/img/editor_ui_script_editor_replaceinfiles.webp)

#### WARNING
Note that "Replace in Files" operation cannot be undone!

![image](tutorials/editor/img/editor_ui_script_editor_replace_all.webp)
...
![image](tutorials/editor/img/script_editor_icons/text_editor_goto_menu.webp)
...
[Script editor debug tools and options](../scripting/debug/overview_of_debugging_tools.md#doc-debugger-tools-and-options) for more.

<a id="doc-script-editor-coding-area"></a>

### Coding area

#### NOTE
This section will only cover the basics of the coding area in terms of the user
interface. To learn more about scripting in Godot, refer to the [GDScript](../scripting/gdscript/index.md#doc-gdscript) or
[Scripting](../scripting/index.md#toc-learn-scripting) documentation.

![image](tutorials/editor/img/editor_ui_script_editor_coding_area.webp)
...
In the script, to the left of function definitions, you might see additional icons. The ![override](tutorials/editor/img/script_editor_icons/override.webp)
icon indicates that this function is an [override](../scripting/overridable_functions.md#doc-overridable-functions) of an existing
function. Clicking it opens the documentation of the original function. The ![receiver](tutorials/editor/img/script_editor_icons/receiver.webp) icon means
that it is a receiving method of a signal. Clicking it shows where the signal is coming
from. A ![foldable](tutorials/editor/img/script_editor_icons/Foldable.webp) icon to the left of the line denotes a foldable block. You can
...
Line 55 is a breakpoint that can be used in [debugging](../scripting/debug/overview_of_debugging_tools.md#doc-overview-of-debugging-tools).

![image](tutorials/editor/img/script_editor_icons/text_editor_coding_area_indicators.webp)
