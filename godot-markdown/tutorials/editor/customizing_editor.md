...
<a id="doc-customizing-editor-moving-docks"></a>
...
![Resizing a dock in the editor](tutorials/editor/img/editor_ui_resize_dock.webp)
...
![Moving a dock in the editor](tutorials/editor/img/editor_ui_move_dock.webp)
...
![Splitting the script editor to its own window](tutorials/editor/img/editor_ui_split_script_editor.webp)

To split the shader editor to its own window, click the corresponding button in
the top-right corner of the script editor:

![Splitting the shader editor to its own window](tutorials/editor/img/editor_ui_split_shader_editor.webp)
...
the configuration path of the [Editor data paths](../io/data_paths.md#doc-data-paths-editor-data-paths).
...
![The Editor Settings window](tutorials/editor/img/editor_settings.webp)
...
See the [EditorSettings](../../classes/class_editorsettings.md#class-editorsettings) class reference for a complete description
