...
![image](tutorials/audio/img/audio_buses1.webp)
...
![image](tutorials/audio/img/audio_buses2.webp)
...
![image](tutorials/audio/img/audio_buses3.webp)

Finally, toggle the **Playing** property to **On** and sound will flow.

#### SEE ALSO
You may also be interested in reading about [Audio streams](audio_streams.md#doc-audio-streams) now.
...
![image](tutorials/audio/img/audio_buses4.webp)

For information on what each effect does, see [Audio effects](audio_effects.md#doc-audio-effects).
...
![image](tutorials/audio/img/audio_buses5.webp)
