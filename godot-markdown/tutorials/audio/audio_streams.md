<a id="doc-audio-streams"></a>

# Audio streams

## Introduction

As you might have already read in [Audio buses](audio_buses.md#doc-audio-buses), sound is sent to
...
information on supported formats and differences in [Importing audio samples](../assets_pipeline/importing_audio_samples.md#doc-importing-audio-samples).

There are other types of AudioStreams, such as [AudioStreamRandomizer](../../classes/class_audiostreamrandomizer.md#class-audiostreamrandomizer).
...
![image](tutorials/audio/img/audio_stream_player.webp)
...
![image](tutorials/audio/img/audio_stream_2d.webp)
...
![image](tutorials/audio/img/audio_stream_2d_area.webp)

## AudioStreamPlayer3D

![image](tutorials/audio/img/audio_stream_3d.webp)
...
![image](tutorials/audio/img/audio_stream_3d_area.webp)

Unlike for 2D, the 3D version of AudioStreamPlayer has a few more advanced options:

<a id="doc-audio-streams-reverb-buses"></a>
...
See [Audio playback in the Exporting for the Web documentation](../export/exporting_for_web.md#doc-exporting-for-web-audio-playback)
for details.
...
![image](tutorials/audio/img/audio_stream_reverb_bus.webp)
...
![image](tutorials/audio/img/audio_stream_reverb_bus2.webp)
...
![image](tutorials/audio/img/audio_stream_doppler.webp)
