<a id="doc-recording-with-microphone"></a>
...
You will need to enable audio input in the [Audio > Driver > Enable Input](../../classes/class_projectsettings.md#class-projectsettings-property-audio-driver-enable-input) project setting, or you'll just get empty audio files.
...
![image](tutorials/audio/img/record_bus.png)![image](tutorials/audio/img/record_stream_player.png)
...
The audio recording is handled by the [AudioEffectRecord](../../classes/class_audioeffectrecord.md#class-audioeffectrecord) resource
which has three methods:
[get_recording()](../../classes/class_audioeffectrecord.md#class-audioeffectrecord-method-get-recording),
[is_recording_active()](../../classes/class_audioeffectrecord.md#class-audioeffectrecord-method-is-recording-active),
and [set_recording_active()](../../classes/class_audioeffectrecord.md#class-audioeffectrecord-method-set-recording-active).
