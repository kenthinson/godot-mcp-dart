<a id="doc-using-character-body-2d"></a>
...
[CharacterBody2D](../../classes/class_characterbody2d.md#class-characterbody2d) node and show some examples
of how to use it.
...
bodies. Please read [Physics introduction](physics_introduction.md#doc-physics-introduction) first, for an overview
...
This method takes one required parameter: a [Vector2](../../classes/class_vector2.md#class-vector2) indicating
...
method will return a [KinematicCollision2D](../../classes/class_kinematiccollision2d.md#class-kinematiccollision2d) object.
...
specific circumstances. See the [CharacterBody2D](../../classes/class_characterbody2d.md#class-characterbody2d) docs
for full details.
...
See [KinematicCollision2D](../../classes/class_kinematiccollision2d.md#class-kinematiccollision2d) for details on what
...
![image](tutorials/physics/img/k2d_compare.gif)
...
#### NOTE
See [2D movement overview](../2d/2d_movement.md#doc-2d-movement) for examples of implementing 2D movement schemes.
...
some obstacles. Add a [StaticBody2D](../../classes/class_staticbody2d.md#class-staticbody2d) with a
...
![image](tutorials/physics/img/k2d_bullet_bounce.gif)
...
[Polygon2D](../../classes/class_polygon2d.md#class-polygon2d) to create the platform shapes.
...
![image](tutorials/physics/img/k2d_platform.gif)
