<a id="doc-troubleshooting-physics-issues"></a>
...
see
[open physics-related issues on GitHub](https://github.com/godotengine/godot/issues?q=is%3Aopen+is%3Aissue+label%3Atopic%3Aphysics).
Looking through [closed issues](https://github.com/godotengine/godot/issues?q=+is%3Aclosed+is%3Aissue+label%3Atopic%3Aphysics)
...
- Modify your fast-moving object's collision shape depending on its movement
  ...
  reliably.
- Increase [Physics Ticks per Second](../../classes/class_projectsettings.md#class-projectsettings-property-physics-common-physics-ticks-per-second)
...
can also improve stability. See [Using Jolt Physics](using_jolt_physics.md#doc-using-jolt-physics) for more information.
...
[Physics Ticks per Second](../../classes/class_projectsettings.md#class-projectsettings-property-physics-common-physics-ticks-per-second)
in the advanced
...
See [Using Jolt Physics](using_jolt_physics.md#doc-using-jolt-physics) for more information.
...
In 3D, switching the physics engine from the default GodotPhysics to Jolt
can also improve performance. See [Using Jolt Physics](using_jolt_physics.md#doc-using-jolt-physics) for more information.
...
from the world origin. See [Large world coordinates](large_world_coordinates.md#doc-large-world-coordinates) for more
information.
