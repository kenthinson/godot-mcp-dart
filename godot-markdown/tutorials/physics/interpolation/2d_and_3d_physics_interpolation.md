<a id="doc-2d-and-3d-physics-interpolation"></a>
...
- In 3D, it is easy to turn interpolation on and off at the level of each `Node`,
  via the [physics_interpolation_mode](../../../classes/class_node.md#class-node-property-physics-interpolation-mode)
  property in the Inspector, which can be set to `On`, `Off`, or `Inherited`.

![image](tutorials/physics/interpolation/img/physics_interpolation_mode.webp)
...
- Physics interpolation in 2D is implemented on the server side, which means it's
  effective on physics bodies created using [low-level servers](../../performance/using_servers.md#doc-using-servers).
  ...
  [pull request description](https://github.com/godotengine/godot/pull/104269)
