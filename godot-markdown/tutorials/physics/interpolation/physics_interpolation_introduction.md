<a id="doc-physics-interpolation-introduction"></a>
...
physics proceeds at a fixed tick rate (set in [Project Settings > Physics > Common > Physics Tick per Second](../../../classes/class_projectsettings.md#class-projectsettings-property-physics-common-physics-ticks-per-second)),
...
![image](tutorials/physics/interpolation/img/fti_graph_fixed_ticks.webp)
...
![image](tutorials/physics/interpolation/img/fti_graph_interpolated.webp)
...
for you by Godot. It can be retrieved on any frame by calling [Engine.get_physics_interpolation_fraction](../../../classes/class_engine.md#class-engine-method-get-physics-interpolation-fraction).
