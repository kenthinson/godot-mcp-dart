<a id="doc-advanced-physics-interpolation"></a>
...
[Node](../../../classes/class_node.md#class-node) (or branch of the [SceneTree](../../../classes/class_scenetree.md#class-scenetree)), and
have the finer control of performing interpolation manually.

This is possible using the [Node.physics_interpolation_mode](../../../classes/class_node.md#class-node-property-physics-interpolation-mode)
...
In many cases, a [Camera3D](../../../classes/class_camera3d.md#class-camera3d) can use automatic interpolation
...
![image](tutorials/physics/interpolation/img/fti_camera_worldspace.webp)
1. Call [Node3D.top_level](../../../classes/class_node3d.md#class-node3d-property-top-level) and set this to `true`, which will make the Camera ignore the transform of its parent.
...
We can do this using the [Node3D.get_global_transform_interpolated](../../../classes/class_node3d.md#class-node3d-method-get-global-transform-interpolated)
function. This acts exactly like getting [Node3D.global_transform](../../../classes/class_node3d.md#class-node3d-property-global-transform)
...
node (using [Node.physics_interpolation_mode](../../../classes/class_node.md#class-node-property-physics-interpolation-mode))
...
- A first person camera may position the camera at a player location (perhaps using
  [Node3D.get_global_transform_interpolated](../../../classes/class_node3d.md#class-node3d-method-get-global-transform-interpolated)),
...
- [MultiMesh.reset_instance_physics_interpolation](../../../classes/class_multimesh.md#class-multimesh-method-reset-instance-physics-interpolation)
- [MultiMesh.set_buffer_interpolated](../../../classes/class_multimesh.md#class-multimesh-method-set-buffer-interpolated)

Full details are in the [MultiMesh](../../../classes/class_multimesh.md#class-multimesh) documentation.
