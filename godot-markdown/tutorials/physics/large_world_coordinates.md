<a id="doc-large-world-coordinates"></a>
...
| [2048; 4096]     | ~0.0002       | ~1e-12                | Maximum *recommended* single-precision range for a first-person 3D game<br/>without rendering artifacts or physics glitches.                      |
| [4096; 8192]     | ~0.0005       | ~1e-12                | Maximum *recommended* single-precision range for a third-person 3D game<br/>without rendering artifacts or physics glitches.                      |
| [8192; 16384]    | ~0.001        | ~1e-12                |                                                                                                                                                   |
| [16384; 32768]   | ~0.0019       | ~1e-11                | Maximum *recommended* single-precision range for a top-down 3D game<br/>without rendering artifacts or physics glitches.                          |
| [32768; 65536]   | ~0.0039       | ~1e-11                | Maximum *recommended* single-precision range for any 3D game. Double<br/>precision (large world coordinates) is usually required past this point. |
| [65536; 131072]  | ~0.0078       | ~1e-11                |                                                                                                                                                   |
| [131072; 262144] | ~0.0156       | ~1e-10                |                                                                                                                                                   |
| > 262144         | > ~0.0313     | ~1e-10 (0.0000000001) | Double-precision remains far more precise than single-precision<br/>past this value.                                                              |
...
#### SEE ALSO
See the [Demystifying Floating Point Precision](https://blog.demofox.org/2017/11/21/)
...
By default, [float](../../classes/class_float.md#class-float) is 64-bit in GDScript, but [Vector2](../../classes/class_vector2.md#class-vector2),
[Vector3](../../classes/class_vector3.md#class-vector3) and [Vector4](../../classes/class_vector4.md#class-vector4) are 32-bit. This means that the
...
for performance reasons, but an [alternative solution](https://github.com/godotengine/godot/pull/66178)
...
See the [Compiling](../../engine_details/development/compiling/index.md#toc-devel-compiling) section for compiling
...
When saving a *binary* resource using the [ResourceSaver](../../classes/class_resourcesaver.md#class-resourcesaver) singleton,
...
[ResourceLoader](../../classes/class_resourceloader.md#class-resourceloader) singleton on resources that use this special flag.
...
- [Triplanar mapping](../3d/standard_material_3d.md#doc-standard-material-3d-triplanar-mapping) doesn't
...
- [GPUParticles3D](../../classes/class_gpuparticles3d.md#class-gpuparticles3d) nodes with **Local Coords** disabled will not benefit
  ...
  as well as [CPUParticles3D](../../classes/class_cpuparticles3d.md#class-cpuparticles3d) nodes, will still benefit from increased precision.
...
- In double-precision builds, world space coordinates in a shader `fragment()`
  ...
  pass them using a [varying](../shaders/shader_reference/shading_language.md#doc-shading-language-varyings), for example:
  ```glsl
  varying vec3 world;
  void vertex() {
