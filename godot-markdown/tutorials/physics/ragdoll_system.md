...
or using the [Asset Library](https://godotengine.org/asset-library/asset/2748).

You can also check out an example of a complete ragdoll setup in the
[Ragdoll Physics demo](https://github.com/godotengine/godot-demo-projects/tree/master/3d/ragdoll_physics).
...
- A [PhysicalBoneSimulator3D](../../classes/class_physicalbonesimulator3d.md#class-physicalbonesimulator3d) node.
  This node is the parent of all physical bones and is responsible
  for controlling the simulation.
- One or more [PhysicalBone3D](../../classes/class_physicalbone3d.md#class-physicalbone3d) children.
...
![Creating a physical skeleton in the editor](tutorials/physics/img/ragdoll_system_create_physical_skeleton.webp)
...
![Scene tree of the player scene after creating a physical skeleton](tutorials/physics/img/ragdoll_system_skeleton_scene_tree.webp)
...
select a PhysicalBone3D node and change the constraint type in the Joint section
...
![Adjusting joints in the inspector after selecting a PhysicalBone3D node](tutorials/physics/img/ragdoll_system_adjust_joints_inspector.webp)
...
- For HingeJoint, make sure to enable **Angular Limit** in the
  Joint Constraints section of the inspector. After enabling it,
...
![Adjusting collision shapes in the 3D editor](tutorials/physics/img/ragdoll_system_adjust_collision_shapes.webp)

This is the final result:

![Result after adjusting joints and collision shapes (player mesh is hidden for visibility)](tutorials/physics/img/ragdoll_system_result.webp)

## Simulate the ragdoll

The ragdoll is now ready to use. To start the simulation and play the ragdoll animation,
you need to call the
[PhysicalBoneSimulator3D.physical_bones_start_simulation()](../../classes/class_physicalbonesimulator3d.md#class-physicalbonesimulator3d-method-physical-bones-start-simulation)
method. Attach a script to the [PhysicalBoneSimulator3D](../../classes/class_physicalbonesimulator3d.md#class-physicalbonesimulator3d) node
...
[PhysicalBoneSimulator3D.physical_bones_stop_simulation()](../../classes/class_physicalbonesimulator3d.md#class-physicalbonesimulator3d-method-physical-bones-stop-simulation)
method.
...
![Layers and masks must be adjusted to these values in the inspector for each node](tutorials/physics/img/ragdoll_system_collision_layers_masks.webp)
...
using the [physical_bones_add_collision_exception()](../../classes/class_physicalbonesimulator3d.md#class-physicalbonesimulator3d-method-physical-bones-add-collision-exception)
and [physical_bones_remove_collision_exception()](../../classes/class_physicalbonesimulator3d.md#class-physicalbonesimulator3d-method-physical-bones-remove-collision-exception)
methods. This can be used to prevent collisions with a specific object
without relying on layers and masks.

#### SEE ALSO
For more information, see [Collision layers and masks](physics_introduction.md#doc-physics-introduction-collision-layers-and-masks).
