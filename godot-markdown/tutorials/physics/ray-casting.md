...
[RayCast3D](../../classes/class_raycast3d.md#class-raycast3d) and [RayCast2D](../../classes/class_raycast2d.md#class-raycast2d)
...
[CanvasItem.get_world_2d().space](../../classes/class_canvasitem.md#class-canvasitem-method-get-world-2d).
For 3D, it's [Node3D.get_world_3d().space](../../classes/class_node3d.md#class-node3d-method-get-world-3d).

The resulting space [RID](../../classes/class_rid.md#class-rid) can be used in
[PhysicsServer3D](../../classes/class_physicsserver3d.md#class-physicsserver3d) and
[PhysicsServer2D](../../classes/class_physicsserver2d.md#class-physicsserver2d) respectively for 3D and 2D.
...
[Node._physics_process()](../../classes/class_node.md#class-node-private-method-physics-process)
callback. Accessing it from outside this function may result in an error
due to space being *locked*.

To perform queries into physics space, the
[PhysicsDirectSpaceState2D](../../classes/class_physicsdirectspacestate2d.md#class-physicsdirectspacestate2d)
and [PhysicsDirectSpaceState3D](../../classes/class_physicsdirectspacestate3d.md#class-physicsdirectspacestate3d)
must be used.
...
[PhysicsDirectSpaceState2D.intersect_ray()](../../classes/class_physicsdirectspacestate2d.md#class-physicsdirectspacestate2d-method-intersect-ray)
...
![image](tutorials/physics/img/raycast_falsepositive.webp)
...
See [Code example](physics_introduction.md#doc-physics-introduction-collision-layer-code-example) for details on how to set the collision mask.

## 3D ray casting from screen

Casting a ray from screen to 3D physics space is useful for object
picking. There is not much need to do this because
[CollisionObject3D](../../classes/class_collisionobject3d.md#class-collisionobject3d)
has an "input_event" signal that will let you know when it was clicked,
but in case there is any desire to do it manually, here's how.

To cast a ray from the screen, you need a [Camera3D](../../classes/class_camera3d.md#class-camera3d)
...
![image](tutorials/physics/img/raycast_projection.png)
