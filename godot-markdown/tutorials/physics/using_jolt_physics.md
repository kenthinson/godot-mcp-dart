...
can be found [here on GitHub](https://github.com/godot-jolt/godot-jolt) and in
Godot's asset library.

To change the 3D physics engine to be Jolt Physics, set
[Project Settings > Physics > 3D > Physics Engine](../../classes/class_projectsettings.md#class-projectsettings-property-physics-3d-physics-engine)
...
to ([node_a](../../classes/class_joint3d.md#class-joint3d-property-node-a) vs [node_b](../../classes/class_joint3d.md#class-joint3d-property-node-b))
...
representing "the world". There is a project setting called [Physics > Jolt Physics 3D > Joints > World Node](../../classes/class_projectsettings.md#class-projectsettings-property-physics-jolt-physics-3d-joints-world-node)
...
called [Physics > Jolt Physics 3D > Collisions > Collision Margin Fraction](../../classes/class_projectsettings.md#class-projectsettings-property-physics-jolt-physics-3d-collisions-collision-margin-fraction)
...
[Physics > Jolt Physics 3D > Simulation > Baumgarte Stabilization Factor](../../classes/class_projectsettings.md#class-projectsettings-property-physics-jolt-physics-3d-simulation-baumgarte-stabilization-factor).
...
[ConcavePolygonShape3D](../../classes/class_concavepolygonshape3d.md#class-concavepolygonshape3d) or [HeightMapShape3D](../../classes/class_heightmapshape3d.md#class-heightmapshape3d) as either "active" or "inactive", based on
...
project setting [Physics >Jolt Physics 3D > Collisions > Active Edge Threshold](../../classes/class_projectsettings.md#class-projectsettings-property-physics-jolt-physics-3d-collisions-active-edge-threshold).
...
[ConcavePolygonShape3D](../../classes/class_concavepolygonshape3d.md#class-concavepolygonshape3d) and [HeightMapShape3D](../../classes/class_heightmapshape3d.md#class-heightmapshape3d), but also edges between any shapes within
the same body.

Enhanced internal edge removal can be toggled on and off for the various contexts to
which it's applied, using the [Physics >Jolt Physics 3D > Simulation > Use Enhanced Internal Edge Removal](../../classes/class_projectsettings.md#class-projectsettings-property-physics-jolt-physics-3d-simulation-use-enhanced-internal-edge-removal),
project setting, and the similar settings for [queries](../../classes/class_projectsettings.md#class-projectsettings-property-physics-jolt-physics-3d-queries-use-enhanced-internal-edge-removal)
and [motion queries](../../classes/class_projectsettings.md#class-projectsettings-property-physics-jolt-physics-3d-motion-queries-use-enhanced-internal-edge-removal).
...
be configured using the [Physics > Jolt Physics 3D > Limits > Temporary Memory Buffer Size](../../classes/class_projectsettings.md#class-projectsettings-property-physics-jolt-physics-3d-limits-temporary-memory-buffer-size)
project setting.

### Ray-cast face index

The `face_index` property returned in the results of [intersect_ray()](../../classes/class_physicsdirectspacestate3d.md#class-physicsdirectspacestate3d-method-intersect-ray)
and RayCast3D will by default always be `-1` with Jolt. The project setting [Physics > Jolt Physics 3D > Queries > Enable Ray Cast Face Index](../../classes/class_projectsettings.md#class-projectsettings-property-physics-jolt-physics-3d-queries-enable-ray-cast-face-index)
will enable them.

Note that enabling this setting will increase the memory requirement of [ConcavePolygonShape3D](../../classes/class_concavepolygonshape3d.md#class-concavepolygonshape3d)
with about 25%.

### Kinematic RigidBody3D contacts

When using Jolt, a [RigidBody3D](../../classes/class_rigidbody3d.md#class-rigidbody3d) frozen with [FREEZE_MODE_KINEMATIC](../../classes/class_rigidbody3d.md#class-rigidbody3d-constant-freeze-mode-kinematic)
will by default not report contacts from collisions with other static/kinematic
bodies, for performance reasons, even when setting a non-zero [max_contacts_reported](../../classes/class_rigidbody3d.md#class-rigidbody3d-property-max-contacts-reported).
If you have many/large kinematic bodies overlapping with complex static geometry,
such as [ConcavePolygonShape3D](../../classes/class_concavepolygonshape3d.md#class-concavepolygonshape3d) or [HeightMapShape3D](../../classes/class_heightmapshape3d.md#class-heightmapshape3d), you can
...
[Physics > Jolt Physics 3D > Simulation > Generate All Kinematic Contacts](../../classes/class_projectsettings.md#class-projectsettings-property-physics-jolt-physics-3d-simulation-generate-all-kinematic-contacts).

### Contact impulses

Due to limitations internal to Jolt, the contact impulses provided by [PhysicsDirectBodyState3D.get_contact_impulse()](../../classes/class_physicsdirectbodystate3d.md#class-physicsdirectbodystate3d-method-get-contact-impulse)
...
Jolt does not currently support any interactions between [SoftBody3D](../../classes/class_softbody3d.md#class-softbody3d)
and [Area3D](../../classes/class_area3d.md#class-area3d), such as the wind and gravity properties found on
[Area3D](../../classes/class_area3d.md#class-area3d).

### WorldBoundaryShape3D

[WorldBoundaryShape3D](../../classes/class_worldboundaryshape3d.md#class-worldboundaryshape3d), which is meant to represent an infinite plane, is
...
You can configure this size using the [Physics > Jolt Physics 3D > Limits > World Boundary Shape Size](../../classes/class_projectsettings.md#class-projectsettings-property-physics-jolt-physics-3d-limits-world-boundary-shape-size)
project setting.
...
including support for the [Physics > 3D > Run On Separate Thread](../../classes/class_projectsettings.md#class-projectsettings-property-physics-3d-run-on-separate-thread)
