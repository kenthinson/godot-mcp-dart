<a id="doc-collision-shapes-3d"></a>
...
You can define the shape of a [PhysicsBody3D](../../classes/class_physicsbody3d.md#class-physicsbody3d) by adding one or more
[CollisionShape3Ds](../../classes/class_collisionshape3d.md#class-collisionshape3d) as *direct* child nodes.
Indirect child nodes (i.e. children of child nodes) will be ignored and won't be
used as collision shapes. Also, note that you must add a [Shape3D](../../classes/class_shape3d.md#class-shape3d)
...
- [BoxShape3D](../../classes/class_boxshape3d.md#class-boxshape3d)
- [SphereShape3D](../../classes/class_sphereshape3d.md#class-sphereshape3d)
- [CapsuleShape3D](../../classes/class_capsuleshape3d.md#class-capsuleshape3d)
- [CylinderShape3D](../../classes/class_cylindershape3d.md#class-cylindershape3d)
...
[Convex collision shapes](../../classes/class_convexpolygonshape3d.md#class-convexpolygonshape3d) are a compromise
...
[Concave collision shapes](../../classes/class_concavepolygonshape3d.md#class-concavepolygonshape3d), also called trimesh
...
#### SEE ALSO
See [Importing 3D scenes](../assets_pipeline/importing_3d_scenes/index.md#doc-importing-3d-scenes) for information on how to export models
