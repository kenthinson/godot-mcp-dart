<a id="doc-physics-introduction"></a>
...
Godot offers four kinds of collision objects which all extend [CollisionObject2D](../../classes/class_collisionobject2d.md#class-collisionobject2d).
The last three listed below are physics bodies and additionally extend [PhysicsBody2D](../../classes/class_physicsbody2d.md#class-physicsbody2d).

- [Area2D](../../classes/class_area2d.md#class-area2d)
  : `Area2D` nodes provide **detection** and **influence**. They can detect when
    ...
    in a defined area.
- [StaticBody2D](../../classes/class_staticbody2d.md#class-staticbody2d)
...
- [RigidBody2D](../../classes/class_rigidbody2d.md#class-rigidbody2d)
  : This is the node that implements simulated 2D physics. You do not control a
    ...
    [Read more about using rigid bodies.](rigid_body.md#doc-rigid-body)
- [CharacterBody2D](../../classes/class_characterbody2d.md#class-characterbody2d)
  : A body that provides collision detection, but no physics. All movement and
    collision response must be implemented in code.

### Physics material

Static bodies and rigid bodies can be configured to use a [PhysicsMaterial](../../classes/class_physicsmaterial.md#class-physicsmaterial). This allows adjusting the friction and bounce of an object,
and set if it's absorbent and/or rough.

### Collision shapes

A physics body can hold any number of [Shape2D](../../classes/class_shape2d.md#class-shape2d) objects
...
The most common way to assign a shape is by adding a [CollisionShape2D](../../classes/class_collisionshape2d.md#class-collisionshape2d)
or [CollisionPolygon2D](../../classes/class_collisionpolygon2d.md#class-collisionpolygon2d) as a child of the object.
...
![image](tutorials/physics/img/player_coll_shape.webp)
...
differentiates [between physics and idle processing](../scripting/idle_and_physics_processing.md#doc-idle-and-physics-processing).
...
The physics callback, [Node._physics_process()](../../classes/class_node.md#class-node-private-method-physics-process),
...
<a id="doc-physics-introduction-collision-layers-and-masks"></a>
...
![image](tutorials/physics/img/physics_layer_names.webp)
...
![image](tutorials/physics/img/player_collision_layers.webp)![image](tutorials/physics/img/player_collision_mask.webp)

<a id="doc-physics-introduction-collision-layer-code-example"></a>
...
or `set_collision_mask_value(layer_number, value)` on any given [CollisionObject2D](../../classes/class_collisionobject2d.md#class-collisionobject2d) as follows:
...
Additional export annotations are available for render and navigation layers, in both 2D and 3D. See [Exporting bit flags](../scripting/gdscript/gdscript_exports.md#doc-gdscript-exports-exporting-bit-flags).
...
There are three main uses for [Area2D](../../classes/class_area2d.md#class-area2d):
...
This is the node that implements simulated 2D physics. You do not control a
[RigidBody2D](../../classes/class_rigidbody2d.md#class-rigidbody2d) directly. Instead, you apply forces
...
**Project Settings > Physics**, or by entering an [Area2D](../../classes/class_area2d.md#class-area2d)
...
of the physics-related properties, you should use the [\_integrate_forces()](../../classes/class_rigidbody2d.md#class-rigidbody2d-private-method-integrate-forces)
callback instead of `_physics_process()`. In this callback, you have access
to the body's [PhysicsDirectBodyState2D](../../classes/class_physicsdirectbodystate2d.md#class-physicsdirectbodystate2d),
...
force to it, or by disabling the [can_sleep](../../classes/class_rigidbody2d.md#class-rigidbody2d-property-can-sleep)
...
contact reporting, set the [max_contacts_reported](../../classes/class_rigidbody2d.md#class-rigidbody2d-property-max-contacts-reported)
property to a non-zero value. The contacts can then be obtained via
[PhysicsDirectBodyState2D.get_contact_count()](../../classes/class_physicsdirectbodystate2d.md#class-physicsdirectbodystate2d-method-get-contact-count)
and related functions.

Contact monitoring via signals can be enabled via the [contact_monitor](../../classes/class_rigidbody2d.md#class-rigidbody2d-property-contact-monitor)
property. See [RigidBody2D](../../classes/class_rigidbody2d.md#class-rigidbody2d) for the list of available
signals.

## CharacterBody2D

[CharacterBody2D](../../classes/class_characterbody2d.md#class-characterbody2d) bodies detect collisions with
...
#### [move_and_collide](../../classes/class_physicsbody2d.md#class-physicsbody2d-method-move-and-collide)

When using `move_and_collide()`, the function returns a
[KinematicCollision2D](../../classes/class_kinematiccollision2d.md#class-kinematiccollision2d) object, which contains
...
#### [move_and_slide](../../classes/class_characterbody2d.md#class-characterbody2d-method-move-and-slide)
...
See [Kinematic character (2D)](kinematic_character_2d.md#doc-kinematic-character-2d) for more details on using `move_and_slide()`,
