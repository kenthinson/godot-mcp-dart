<a id="doc-animation-tree"></a>

# Using AnimationTree

## Introduction

With [AnimationPlayer](../../classes/class_animationplayer.md#class-animationplayer), Godot has one of the most flexible animation systems that you can find in any game engine.
...
[AnimationTree](../../classes/class_animationtree.md#class-animationtree) is a node designed to deal with advanced transitions.
...
[name suffixes](https://docs.godotengine.org/en/stable/tutorials/assets_pipeline/importing_3d_scenes/node_type_customization.html#animation-loop-loop-cycle)
...
![image](tutorials/animation/img/animtree_treeandplayersetup.png)
...
![image](tutorials/animation/img/animtree_rootnodes.png)
...
![image](tutorials/animation/img/animtree_emptyblendtree.webp)
...
![image](tutorials/animation/img/animtree_blendnodes.webp)
...
![image](tutorials/animation/img/animtree_animtooutput.png)
...
![image](tutorials/animation/img/animtree_blend2.gif)
...
![image](tutorials/animation/img/animtree_filtering.png)
...
![image](tutorials/animation/img/animtree_oneshot.gif)
...
![image](tutorials/animation/img/animtree_timeseek.webp)
...
![image](tutorials/animation/img/animtree_timescale.webp)
...
![image](tutorials/animation/img/animtree_transition.webp)
...
![image](tutorials/animation/img/animtree_emptystatemachine.webp)
...
![image](tutorials/animation/img/animtree_connections.gif)

There are 3 types of transitions:

![image](tutorials/animation/img/animtree_transitiontypes.png)
...
![image](tutorials/animation/img/animtree_statemachinetransitionproperties.webp)
...
such as `velocity` on a [CharacterBody3D](../../classes/class_characterbody3d.md#class-characterbody3d) node, you should use
...
![image](tutorials/animation/img/animtree_badanimcondition.webp)![image](tutorials/animation/img/animtree_badanimcondition.gif)
...
![image](tutorials/animation/img/animtree_goodanimcondition.webp)![image](tutorials/animation/img/animtree_goodanimcondition.gif)
...
![image](tutorials/animation/img/animtree_goodanimexpression.webp)![image](tutorials/animation/img/animtree_goodanimexpression2.webp)![image](tutorials/animation/img/animtree_goodanimexpression.gif)
...
#### SEE ALSO
The Advance Expression is evaluated using Godot's [Expression](../../classes/class_expression.md#class-expression) class.
See [Evaluating expressions](../scripting/evaluating_expressions.md#doc-evaluating-expressions) for more information on writing expressions.
...
To use the travel ability, you should first retrieve the [AnimationNodeStateMachinePlayback](../../classes/class_animationnodestatemachineplayback.md#class-animationnodestatemachineplayback)
...
![image](tutorials/animation/img/animtree_blendspace2d.gif)
...
![image](tutorials/animation/img/animtree_blendspacepoints.gif)
...
![image](tutorials/animation/img/animtree_blendmode.png)

BlendSpace1D works just like BlendSpace2D, but in one dimension (a line). Triangles are not used.

![image](tutorials/animation/img/animtree_blendspace1d.webp)
...
![image](tutorials/animation/img/blending5.webp)
...
![image](tutorials/animation/img/animtree_rootmotiontrack.webp)

Afterwards, the actual motion can be retrieved via the [AnimationTree](../../classes/class_animationtree.md#class-animationtree) API as a transform:
...
This can be fed to functions such as [CharacterBody3D.move_and_slide](../../classes/class_characterbody3d.md#class-characterbody3d-method-move-and-slide) to control the character movement.
...
![image](tutorials/animation/img/animtree15.gif)
...
![image](tutorials/animation/img/animtree_parameters.webp)
...
![image](tutorials/animation/img/animtree_propertypath.webp)
...
#### NOTE
Advance Expressions from a StateMachine will not be found under the parameters. This is because they are held in another script rather than the
