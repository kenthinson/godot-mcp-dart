...
- **Custom Shaped Elements**: Custom shapes can be created with
  [Polygon2D](../../classes/class_polygon2d.md#class-polygon2d)
...
![image](tutorials/animation/img/tuto_cutout_walk.gif)
...
![image](tutorials/animation/img/tuto_cutout1.png)
...
![image](tutorials/animation/img/tuto_cutout2.png)
...
![image](tutorials/animation/img/tuto_cutout3.png)
...
![image](tutorials/animation/img/tutovec_torso1.gif)

The rotation pivot is wrong and needs to be adjusted.

This small cross in the middle of the [Sprite2D](../../classes/class_sprite2d.md#class-sprite2d) is
the rotation pivot:

![image](tutorials/animation/img/tuto_cutout4.png)
...
![image](tutorials/animation/img/tuto_cutout5.png)
...
![image](tutorials/animation/img/tutovec_torso2.gif)
...
![image](tutorials/animation/img/tuto_cutout6.png)

With the left arm there's a problem. In 2D, child nodes appear in front of
their parents:

![image](tutorials/animation/img/tuto_cutout7.png)
...
The [RemoteTransform2D](../../classes/class_remotetransform2d.md#class-remotetransform2d) node transforms nodes
...
![image](tutorials/animation/img/tuto_cutout9.png)
...
![image](tutorials/animation/img/tutovec_torso4.gif)
...
![image](tutorials/animation/img/tuto_cutout10.png)
...
![image](tutorials/animation/img/tuto_cutout11.png)

Then, click on the Skeleton menu and select `Make Bones`.

![image](tutorials/animation/img/tuto_cutout12.png)

This will add bones covering the arm, but the result may be surprising.

![image](tutorials/animation/img/tuto_cutout13.png)
...
but [Marker2D](../../classes/class_marker2d.md#class-marker2d) is preferred because it's
visible in the editor. The endpoint node will ensure that the last bone
has orientation.

![image](tutorials/animation/img/tuto_cutout14.png)

Now select the whole chain, from the endpoint to the arm and create
bones:

![image](tutorials/animation/img/tuto_cutout15.png)
...
![image](tutorials/animation/img/tuto_cutout15_2.png)

Your final skeleton should look something like this:

![image](tutorials/animation/img/tuto_cutout16.png)
...
![image](tutorials/animation/img/tuto_cutout17.png)

Then enable this chain for IK. Go to Edit > Make IK Chain.

![image](tutorials/animation/img/tuto_cutout18.png)

As a result, the base of the chain will turn *Yellow*.

![image](tutorials/animation/img/tuto_cutout19.png)
...
![image](tutorials/animation/img/tutovec_torso5.gif)
...
works, see [Introduction to the animation features](introduction.md#doc-introduction-animation).
...
![image](tutorials/animation/img/tuto_cutout20.png)
...
![image](tutorials/animation/img/tuto_cutout21.png)
...
![image](tutorials/animation/img/tuto_cutout22.png)
...
![image](tutorials/animation/img/tuto_cutout23.png)
...
![image](tutorials/animation/img/tuto_cutout24.png)
...
This process is described in a [separate tutorial](2d_skeletons.md#doc-2d-skeletons).
