<a id="doc-playing-videos"></a>

# Playing videos

Godot supports video playback with the [VideoStreamPlayer](../../classes/class_videostreamplayer.md#class-videostreamplayer) node.
...
2. Select the VideoStreamPlayer node in the scene tree dock, go to the inspector
   ...
   - If you don't have your video in Ogg Theora format yet, jump to
     [Recommended Theora encoding settings](#doc-playing-videos-recommended-theora-encoding-settings).
...
the video's resolution. You can make it follow usual [Control](../../classes/class_control.md#class-control) sizing
...
[AspectRatioContainer](../../classes/class_aspectratiocontainer.md#class-aspectratiocontainer) node, which is designed to handle this kind of
use case:
...
![AspectRatioContainer's Ratio property being modified in the editor inspector](tutorials/animation/img/playing_videos_aspect_ratio_container.png)
...
#### SEE ALSO
See [Multiple resolutions](../rendering/multiple_resolutions.md#doc-multiple-resolutions) for more tips on supporting multiple
aspect ratios in your project.

### Displaying a video on a 3D surface

Using a VideoStreamPlayer node as a child of a [SubViewport](../../classes/class_subviewport.md#class-subviewport) node,
...
1. Create a [SubViewport](../../classes/class_subviewport.md#class-subviewport) node. Set its size to match your video's size
   in pixels.
...
See [Using Viewports](../rendering/viewports.md#doc-viewports) and the
...
<a id="doc-playing-videos-recommended-theora-encoding-settings"></a>
...
[FFmpeg](https://ffmpeg.org/) (CLI) is a popular open source tool
...
> ![image](tutorials/animation/img/chroma_key_video.webp)
...
> ![image](tutorials/animation/img/chroma_key_scene.webp)
...
> ![image](tutorials/animation/img/slider_range.webp)
