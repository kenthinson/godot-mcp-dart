...
it is a good idea to start from [General optimization tips](general_optimization.md#doc-general-optimization).

## Common

* [General optimization tips](general_optimization.md)
* [Optimization using Servers](using_servers.md)
...
* [Optimization using MultiMeshes](using_multimesh.md)
* [Reducing stutter from shader (pipeline) compilations](pipeline_compilations.md)

## 3D

* [Optimizing 3D performance](optimizing_3d_performance.md)
* [Animating thousands of objects](vertex_animation/index.md)
