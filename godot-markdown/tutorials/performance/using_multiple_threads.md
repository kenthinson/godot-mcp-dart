<a id="doc-using-multiple-threads"></a>

# Using multiple threads

#### SEE ALSO
For a list of multithreading primitives in C++, see [Multithreading / Concurrency](../../engine_details/architecture/core_types.md#doc-core-concurrency-types).
...
#### WARNING
Before using a built-in class in a thread, read [Thread-safe APIs](thread_safe_apis.md#doc-thread-safe-apis)
...
[Thread.wait_to_finish()](../../classes/class_thread.md#class-thread-method-wait-to-finish), which will
...
<a id="doc-using-multiple-threads-mutexes"></a>
...
[Thread-safe APIs](thread_safe_apis.md#doc-thread-safe-apis) documentation to understand which engine APIs
...
when modified. Always use a [Mutex](../../classes/class_mutex.md#class-mutex) when accessing
a piece of data from different threads.

When calling [Mutex.lock()](../../classes/class_mutex.md#class-mutex-method-lock), a thread ensures that
...
[Mutex.unlock()](../../classes/class_mutex.md#class-mutex-method-unlock), the other threads will be
...
For this, [Semaphores](../../classes/class_semaphore.md#class-semaphore) are used. The function
[Semaphore.wait()](../../classes/class_semaphore.md#class-semaphore-method-wait) is used in the thread to
suspend it until some data arrives.

The main thread, instead, uses
[Semaphore.post()](../../classes/class_semaphore.md#class-semaphore-method-post) to signal that data is
