<a id="doc-general-optimization"></a>
...
- Using the [Godot profiler](../scripting/debug/the_profiler.md#doc-the-profiler).
- Using [external CPU profilers](../../engine_details/development/profiling/index.md#doc-using-cpp-profilers).
- Using external GPU profilers/debuggers such as
  [NVIDIA Nsight Graphics](https://developer.nvidia.com/nsight-graphics),
  [Radeon GPU Profiler](https://gpuopen.com/rgp/),
  [PIX](https://devblogs.microsoft.com/pix/download/) (Direct3D 12 only),
  [Xcode](https://developer.apple.com/documentation/xcode/optimizing-gpu-performance) (Metal only), or
...
- Checking the frame rate (with V-Sync disabled). Third-party utilities such as
  [RivaTuner Statistics Server](https://www.guru3d.com/files-details/rtss-rivatuner-statistics-server-download.html) (Windows),
  [Special K](https://www.special-k.info/) (Windows),
  or [MangoHud](https://github.com/flightlessmango/MangoHud)
...
For more info about using Godot's built-in profiler, see [The Profiler](../scripting/debug/the_profiler.md#doc-the-profiler).
