<a id="doc-animating-thousands-of-fish"></a>
...
In Godot, this can be accomplished with a custom [Shader](../../../classes/class_shader.md#class-shader) and
a [MultiMeshInstance3D](../../../classes/class_multimeshinstance3d.md#class-multimeshinstance3d). Using the following technique you
...
We will start with a single fish. Load your fish model into a [MeshInstance3D](../../../classes/class_meshinstance3d.md#class-meshinstance3d)
and add a new [ShaderMaterial](../../../classes/class_shadermaterial.md#class-shadermaterial).

Here is the fish we will be using for the example images, you can use any fish model you like.

![image](tutorials/performance/vertex_animation/img/fish.png)

#### NOTE
The fish model in this tutorial is made by [QuaterniusDev](https://quaternius.com) and is
shared with a creative commons license. CC0 1.0 Universal (CC0 1.0) Public Domain
Dedication [https://creativecommons.org/publicdomain/zero/1.0/](https://creativecommons.org/publicdomain/zero/1.0/)

Typically, you would use bones and a [Skeleton3D](../../../classes/class_skeleton3d.md#class-skeleton3d) to animate objects. However,
...
![image](tutorials/performance/vertex_animation/img/sidetoside.gif)
...
![image](tutorials/performance/vertex_animation/img/pivot.gif)
...
![image](tutorials/performance/vertex_animation/img/wave.gif)
...
![image](tutorials/performance/vertex_animation/img/twist.gif)

If we apply all these motions one after another, we get a fluid jelly-like motion.

![image](tutorials/performance/vertex_animation/img/all_motions.gif)
...
![image](tutorials/performance/vertex_animation/img/mask.png)
...
![image](tutorials/performance/vertex_animation/img/all_motions_mask.gif)
...
Once you have a MultiMeshInstance3D add a [MultiMesh](../../../classes/class_multimesh.md#class-multimesh), and to that
MultiMesh add your [Mesh](../../../classes/class_mesh.md#class-mesh) with the shader from above.
...
a [Color](../../../classes/class_color.md#class-color).
...
and is described in the [MultiMeshInstance3D tutorial](../../3d/using_multi_mesh_instance.md#doc-using-multi-mesh-instance).
...
In the next tutorial we will cover how to use [GPUParticles3D](../../../classes/class_gpuparticles3d.md#class-gpuparticles3d) to take advantage
