...
Most [Global Scope](../../classes/class_@globalscope.md#class-globalscope) singletons are thread-safe by default.
Accessing servers from threads is supported. However, for the
[rendering](#doc-thread-safe-apis-rendering) and
[physics](#doc-thread-safe-apis-physics) servers,
...
[call_deferred](../../classes/class_object.md#class-object-method-call-deferred) or [set_deferred](../../classes/class_object.md#class-object-method-set-deferred):
...
<a id="doc-thread-safe-apis-rendering"></a>

## Rendering

Instancing nodes that render anything in 2D or 3D (such as [Sprite2D](../../classes/class_sprite2d.md#class-sprite2d)
or [MeshInstance3D](../../classes/class_meshinstance3d.md#class-meshinstance3d)) is *not* thread-safe by default. To run the
rendering driver on a separate thread, set the
[Rendering > Driver > Thread Model](../../classes/class_projectsettings.md#class-projectsettings-property-rendering-driver-threads-thread-model)
...
synchronization with the [RenderingServer](../../classes/class_renderingserver.md#class-renderingserver),
as data needs to be transmitted to or updated on the GPU.

<a id="doc-thread-safe-apis-physics"></a>
...
- **PhysicsServer2D:** [Physics > 2D > Run on Separate Thread](../../classes/class_projectsettings.md#class-projectsettings-property-physics-2d-run-on-separate-thread).
- **PhysicsServer3D:** [Physics > 3D > Run on Separate Thread](../../classes/class_projectsettings.md#class-projectsettings-property-physics-3d-run-on-separate-thread).

## Navigation

[NavigationServer2D](../../classes/class_navigationserver2d.md#class-navigationserver2d) and [NavigationServer3D](../../classes/class_navigationserver3d.md#class-navigationserver3d) are both thread-safe and thread-friendly.
...
set [Navigation > Pathfinding > Max Threads](../../classes/class_projectsettings.md#class-projectsettings-property-navigation-pathfinding-max-threads).
...
The navigation-related helper classes like [AStar2D](../../classes/class_astar2d.md#class-astar2d), [AStar3D](../../classes/class_astar3d.md#class-astar3d), and [AStarGrid2D](../../classes/class_astargrid2d.md#class-astargrid2d) are **not** thread-safe.
...
locking a [mutex](using_multiple_threads.md#doc-using-multiple-threads-mutexes).
