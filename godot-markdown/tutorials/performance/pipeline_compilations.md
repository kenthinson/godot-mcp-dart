<a id="doc-pipeline-compilations"></a>
...
![Flowchart showing the entire compilation process for a shader: VisualShader and Standard Material to Godot Shading Language to GLSL to Intermediate Format (SPIR-V) to Pipeline. Shader Compilation is the GLSL to Intermediate Format step. Pipeline Compilation is the Intermediate Format to Pipeline step.](tutorials/performance/img/pipeline_compilations_shader_compilation_diagram.webp)
...
![Screenshot of the Godot pipeline compilations monitor](tutorials/performance/img/pipeline_compilations_monitors.webp)
...
necessary, e.g. by covering it with a [ColorRect](../../classes/class_colorrect.md#class-colorrect) node or
using a [SubViewport](../../classes/class_subviewport.md#class-subviewport) located outside the window bounds.
...
- **Normal and Roughness**: Enabled when using SDFGI, VoxelGI, screen-space
  ...
  shader or [CompositorEffect](../../classes/class_compositoreffect.md#class-compositoreffect).
...
![Screenshot of an example of a hidden Node for an effect](tutorials/performance/img/pipeline_compilations_hidden_node.webp)
...
<a id="doc-pipeline-compilations-shader-baker"></a>
...
export preset in the Export dialog by ticking the Shader Baker > Enabled
export option.
