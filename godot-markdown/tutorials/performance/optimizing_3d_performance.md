<a id="doc-optimizing-3d-performance"></a>
...
using occluder nodes. See [Occlusion culling](../3d/occlusion_culling.md#doc-occlusion-culling) for instructions on
...
Godot sorts objects by [Material](../../classes/class_material.md#class-material) and [Shader](../../classes/class_shader.md#class-shader) to improve performance. This, however, can not be done with
...
For more information, see the [GPU optimizations](gpu_optimization.md#doc-gpu-optimization)
doc.
...
- An automatic approach on mesh import using [Mesh level of detail (LOD)](../3d/mesh_lod.md#doc-mesh-lod).
- A manual approach configured in the 3D node using [Visibility ranges (HLOD)](../3d/visibility_ranges.md#doc-visibility-ranges).
- [Decals](../3d/using_decals.md#doc-using-decals) and [lights](../3d/lights_and_shadows.md#doc-lights-and-shadows)
...
(for more information on fill rate, see [GPU optimization](gpu_optimization.md#doc-gpu-optimization)).
...
using [MultiMesh](../../classes/class_multimesh.md#class-multimesh) instead. MultiMesh allows the drawing
...
See also the [Using MultiMesh](using_multimesh.md#doc-using-multimesh) documentation.

## Bake lighting

Lighting objects is one of the most costly rendering operations. Realtime
lighting, shadows (especially multiple lights), and
[global illumination](../3d/global_illumination/introduction_to_global_illumination.md#doc-introduction-to-global-illumination) are especially
...
See [Using Lightmap global illumination](../3d/global_illumination/using_lightmap_gi.md#doc-using-lightmap-gi) for instructions on using baked lightmaps. For
...
and quality is to keep **Dynamic** for the [DirectionalLight3D](../../classes/class_directionallight3d.md#class-directionallight3d) node,
...
The [VisibleOnScreenEnabler3D](../../classes/class_visibleonscreenenabler3d.md#class-visibleonscreenenabler3d) and [VisibleOnScreenNotifier3D](../../classes/class_visibleonscreennotifier3d.md#class-visibleonscreennotifier3d)
...
large worlds. This can be resolved using [Large world coordinates](../physics/large_world_coordinates.md#doc-large-world-coordinates).
