...
![Screenshot of the Godot profiler](tutorials/performance/img/godot_profiler.png)
...
[Debugger panel](../scripting/debug/debugger_panel.md#doc-debugger-panel).
...
You can [use a number of third-party C++ profilers](../../engine_details/development/profiling/index.md#doc-using-cpp-profilers)
to do this.

![Screenshot of Callgrind](tutorials/performance/img/valgrind.png)
...
[GDScript](../scripting/gdscript/index.md#doc-gdscript) is designed to be easy to use and iterate,
...
[C#](../scripting/c_sharp/index.md#doc-c-sharp) is popular and has first-class support in Godot. It
...
GDExtensions and
[custom modules](../../engine_details/engine_api/custom_modules_in_cpp.md#doc-custom-modules-in-cpp).
...
For more information on threads, see [Using multiple threads](using_multiple_threads.md#doc-using-multiple-threads).
...
One quirk of the [SceneTree](../../classes/class_scenetree.md#class-scenetree) is that you can sometimes
...
[Node.remove_child(node)](../../classes/class_node.md#class-node-method-remove-child), then reattach
it later using [Node.add_child(node)](../../classes/class_node.md#class-node-method-add-child).
...
information, see [Optimization using Servers](using_servers.md#doc-using-servers).
...
[here](../physics/interpolation/index.md#doc-physics-interpolation).
