<a id="doc-gui-skinning"></a>

# Introduction to GUI skinning

It is essential for a game to provide clear, informative, and yet visually
pleasing user interface to its players. While [Control](../../classes/class_control.md#class-control)
...
![image](tutorials/ui/img/tank-kings-by-winterpixel-games.png)
...
The skinning system is driven by the [Theme](../../classes/class_theme.md#class-theme) resource. Every
...
[your own custom controls](custom_gui_controls.md#doc-custom-gui-controls).
...
as explained [below](#doc-gui-theme-in-project).
...
- **Color**
  ...
  A [color](../../classes/class_color.md#class-color) value, which is often used for fonts
...
- **Constant**
  ...
  controls (such as the item separation in a [BoxContainer](../../classes/class_boxcontainer.md#class-boxcontainer)),
  or for boolean flags (such as the drawing of relationship lines in a [Tree](../../classes/class_tree.md#class-tree)).
- **Font**

  A [font](../../classes/class_font.md#class-font) resource, which is used by controls that
...
- **Icon**
  ...
  A [texture](../../classes/class_texture2d.md#class-texture2d) resource, which is normally used
  to display an icon (on a [Button](../../classes/class_button.md#class-button), for example).
- **StyleBox**

  A [StyleBox](../../classes/class_stylebox.md#class-stylebox) resource, a collection of configuration
  options which define the way a UI panel should be displayed. This is
  not limited to the [Panel](../../classes/class_panel.md#class-panel) control, as styleboxes
...
[dedicated article](gui_theme_type_variations.md#doc-gui-theme-type-variations).
...
![image](tutorials/ui/img/themecheck.webp)
...
essential. Nodes such as [BoxContainer](../../classes/class_boxcontainer.md#class-boxcontainer) and
[GridContainer](../../classes/class_gridcontainer.md#class-gridcontainer) use theme constants for defining
separation between their children, and [MarginContainer](../../classes/class_margincontainer.md#class-margincontainer)
...
<a id="doc-gui-theme-in-project"></a>
...
[GUI > Theme > Custom](../../classes/class_projectsettings.md#class-projectsettings-property-gui-theme-custom) allows you to
set a custom project-wide theme, and [GUI > Theme > Custom Font](../../classes/class_projectsettings.md#class-projectsettings-property-gui-theme-custom-font)
...
a [theme](../../classes/class_control.md#class-control-property-theme) property, which allows you to set a
