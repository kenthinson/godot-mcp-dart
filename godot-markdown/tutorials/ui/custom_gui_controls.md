<a id="doc-custom-gui-controls"></a>
...
For drawing, it is recommended to check the [Custom drawing in 2D](../2d/custom_drawing_in_2d.md#doc-custom-drawing-in-2d) tutorial.
...
[Control.size](../../classes/class_control.md#class-control-property-size)
...
[Control.focus_mode](../../classes/class_control.md#class-control-property-focus-mode)
...
status, the [Control.has_focus()](../../classes/class_control.md#class-control-method-has-focus) method
exists. Example
...
each other using a [VBoxContainer](../../classes/class_vboxcontainer.md#class-vboxcontainer),
...
[Control._get_minimum_size()](../../classes/class_control.md#class-control-private-method-get-minimum-size),
for example:
...
This function is
[Control._gui_input()](../../classes/class_control.md#class-control-private-method-gui-input).
...
For more information about events themselves, check the [Using InputEvent](../inputs/inputevent.md#doc-inputevent)
tutorial.
