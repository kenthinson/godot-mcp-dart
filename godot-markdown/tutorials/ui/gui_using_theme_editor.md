<a id="doc-gui-using-theme-editor"></a>
...
basics behind GUI skinning/theming by reading [Introduction to GUI skinning](gui_skinning.md#doc-gui-skinning) before starting.

The theme editor is a bottom panel tool that activates automatically, when
a [Theme](../../classes/class_theme.md#class-theme) resource is selected for editing. It contains
...
![image](tutorials/ui/img/new_theme.webp)
...
Same applies to the contents of complex resource types, such as [StyleBoxes](../../classes/class_stylebox.md#class-stylebox)
and icons — they open for editing in the Inspector.

![image](tutorials/ui/img/default_font.webp)

## Theme editor overview

![image](tutorials/ui/img/theme_editor.webp)
...
![image](tutorials/ui/img/default_preview.webp)
...
![image](tutorials/ui/img/scene_preview.webp)
...
![image](tutorials/ui/img/theme_preview_picker.webp)
...
![image](tutorials/ui/img/theme_type_editor.webp)
...
![image](tutorials/ui/img/theme_item_inspector.webp)
...
![image](tutorials/ui/img/theme_pin_the_stylebox.webp)
...
![image](tutorials/ui/img/import_items.webp)
