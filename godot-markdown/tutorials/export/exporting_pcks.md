...
See [PCK versus ZIP pack file formats](exporting_projects.md#doc-exporting-projects-pck-versus-zip) for a comparison of the two formats.

#### SEE ALSO
If you want to load loose files at runtime (not packed in a PCK or ZIP by Godot),
consider using [Runtime file loading and saving](../io/runtime_file_loading_and_saving.md#doc-runtime-loading-and-saving) instead.
...
![image](tutorials/export/img/export_pck.webp)

Another method would be to [export from the command line](../editor/command_line_tutorial.md#doc-command-line-tutorial-exporting)
...
2. The developer uses Godot to build a GUI tool for adding their exact API
   ...
   [OS.execute()](../../classes/class_os.md#class-os-method-execute). The game itself shouldn't
...
[ProjectSettings.load_resource_pack()](../../classes/class_projectsettings.md#class-projectsettings-method-load-resource-pack).
...
[preload()](../../classes/class_@gdscript.md#class-gdscript-method-preload). This means that loading
...
To do so, create a new [autoload](../scripting/singletons_autoload.md#doc-singletons-autoload) script and
call [ProjectSettings.load_resource_pack()](../../classes/class_projectsettings.md#class-projectsettings-method-load-resource-pack)
