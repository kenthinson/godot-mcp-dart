...
- **Android:** Exports the project with debugging enabled and runs it on the
  connected device.
  > - Make sure to follow the steps described in [Exporting for Android](exporting_for_android.md#doc-exporting-for-android).
...
- **iOS:** Exports the project with debugging enabled and runs it on the
  connected device.
  > - Make sure to follow the steps described in [Exporting for iOS](exporting_for_ios.md#doc-exporting-for-ios).
  >   Otherwise, the one-click deploy button won't appear.
...
- **Web:** Starts a local web server and runs the exported project by opening
  ...
  See [Troubleshooting](#doc-one-click-deploy-troubleshooting-web)
...
- **iOS:**
  : - Install Xcode, accept Xcode license and login with your Apple Developer
      account.
    - If you are using Xcode 14 or earlier, install [ios-deploy](https://github.com/ios-control/ios-deploy)
...
![image](tutorials/export/img/remote_debug.webp)

<a id="doc-one-click-deploy-troubleshooting"></a>
...
<a id="doc-one-click-deploy-troubleshooting-web"></a>
...
[Troubleshooting](exporting_for_web.md#doc-exporting-for-web-troubleshooting) for instructions on unregistering
