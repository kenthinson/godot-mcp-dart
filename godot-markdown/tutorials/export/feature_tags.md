...
| **movie**            | [Movie Maker mode](../animation/creating_movies.md#doc-creating-movies) is active                                                                                                                            |
| **shader_baker**     | Project was exported with [shader baking](../performance/pipeline_compilations.md#doc-pipeline-compilations-shader-baker)<br/>enabled (only applies to the exported project, not when running in the editor) |
| **dedicated_server** | Project was exported as a [dedicated server](exporting_for_dedicated_servers.md#doc-exporting-for-dedicated-servers)<br/>(only applies to the exported project, not when running in the editor)              |
...
![image](tutorials/export/img/feature_tags1.webp)

#### NOTE
Custom feature tags are only used when running the exported project
(including with [One-click deploy](one-click_deploy.md#doc-one-click-deploy)). They are **not used** when
...
Custom feature tags are also not used in [EditorExportPlugin](../../classes/class_editorexportplugin.md#class-editorexportplugin)
scripts. Instead, feature tags in [EditorExportPlugin](../../classes/class_editorexportplugin.md#class-editorexportplugin)
...
![The Project Settings panel](tutorials/export/img/feature_tags2.webp)

After overriding, a new field is added for this specific configuration.

![image](tutorials/export/img/feature_tags3.webp)

#### NOTE
When using the
[project settings "override.cfg" functionality](../../classes/class_projectsettings.md#class-projectsettings)
...
![image](tutorials/export/img/feature_tags4.webp)
...
using the typical approaches ([ProjectSettings.get_setting](../../classes/class_projectsettings.md#class-projectsettings-method-get-setting)
or [ProjectSettings.get](../../classes/class_object.md#class-object-private-method-get)).
Instead, you must use [ProjectSettings.get_setting_with_override](../../classes/class_projectsettings.md#class-projectsettings-method-get-setting).
