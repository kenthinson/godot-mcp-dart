<a id="doc-android-gradle-build"></a>
...
you need to follow the steps in [exporting for android](exporting_for_android.md#doc-exporting-for-android)
...
![image](tutorials/export/img/gradle_build_install_template.webp)
...
![image](tutorials/export/img/gradle_build_enable.webp)
...
![image](tutorials/export/img/gradle_build_gradle.webp)
