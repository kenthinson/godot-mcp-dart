<a id="doc-changing-application-icon-for-windows"></a>
...
[application/config/icon](../../classes/class_projectsettings.md#class-projectsettings-property-application-config-icon)
...
![image](tutorials/export/img/icon_taskbar_icon.png)
...
![image](tutorials/export/img/icon_project_settings.webp)
...
<a id="doc-changing-application-icon-for-windows-changing-the-file-icon"></a>
...
![image](tutorials/export/img/icon_file_icon.png)
...
![image](tutorials/export/img/icon_export_settings.webp)

## Testing the result

You can now export the project. If it worked correctly, you should see this:

![image](tutorials/export/img/icon_result.png)
