<a id="doc-exporting-for-dedicated-servers"></a>
...
display server and `Dummy` [audio driver](../../classes/class_projectsettings.md#class-projectsettings-property-audio-driver-driver).
...
See [Exporting projects](exporting_projects.md#doc-exporting-projects) for more information.

<a id="doc-exporting-for-dedicated-servers-exporting-project"></a>
...
![Choosing the **Export as dedicated server** export mode in the export preset](tutorials/export/img/exporting_for_dedicated_servers_export_mode.webp)
...
![Choosing resources to keep, keep with stripped visuals or remove](tutorials/export/img/exporting_for_dedicated_servers_export_resources.webp)
...
If you [exported the project](#doc-exporting-for-dedicated-servers-exporting-project)
