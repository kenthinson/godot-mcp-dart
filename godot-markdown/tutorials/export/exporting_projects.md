...
[creating DLCs as extra package files](exporting_pcks.md#doc-exporting-pcks).
...
![image](tutorials/export/img/export_preset.webp)
...
![image](tutorials/export/img/export_error.webp)
...
![image](tutorials/export/img/export_templates.webp)

<a id="doc-exporting-projects-export-mode"></a>
...
![image](tutorials/export/img/export_resources.webp)
...
![image](tutorials/export/img/export_selected.webp)
...
#### SEE ALSO
See [Command line tutorial](../editor/command_line_tutorial.md#doc-command-line-tutorial) for more information about using Godot
from the command line.

<a id="doc-exporting-projects-pck-versus-zip"></a>
...
- Readable and writable using tools normally present on the user's operating system.
  This can be useful to make modding easier (see also [Exporting packs, patches, and mods](exporting_pcks.md#doc-exporting-pcks)).
