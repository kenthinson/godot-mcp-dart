...
read [Compiling for the Web](../../engine_details/development/compiling/compiling_for_web.md#doc-compiling-for-web).

HTML5 export allows publishing games made in Godot Engine to the browser.
This requires support for [WebAssembly](https://webassembly.org/) and [WebGL 2.0](https://www.khronos.org/webgl/)
in the user's browser.

#### ATTENTION
Projects written in C# using Godot 4 currently cannot be exported to the
web. See [this blog post](https://godotengine.org/article/platform-state-in-csharp-for-godot-4-2/#web)
...
[Poki](https://poki.com/) or [CrazyGames](https://crazygames.com/). The single-threaded export
...
For more information, see [this blog post about single-threaded Web export](https://godotengine.org/article/progress-report-web-export-in-4-3/#single-threaded-web-export).

#### SEE ALSO
See the
[list of open issues on GitHub related to the web export](https://github.com/godotengine/godot/issues?q=is%3Aopen+is%3Aissue+label%3Aplatform%3Aweb)
...
See [Can I use WebGL 2.0](https://caniuse.com/webgl2) for a list of browser
...
[Android](exporting_for_android.md#doc-exporting-for-android) and [iOS](exporting_for_ios.md#doc-exporting-for-ios)
...
WebAssembly instead of native code). See [Performance](../performance/index.md#doc-performance) section of the
documentation for advice on optimizing your project. If your project runs on
platforms other than Web, you can use [Feature tags](feature_tags.md#doc-feature-tags) to apply
...
[compile an optimized export template](../../engine_details/development/compiling/optimizing_for_size.md#doc-optimizing-for-size)
...
<a id="doc-exporting-for-web-audio-playback"></a>
...
- [Reverberation and doppler](../audio/audio_streams.md#doc-audio-streams-reverb-buses) effects are not supported.
...
[AudioStreamPlayer](../../classes/class_audiostreamplayer.md#class-audiostreamplayer), [AudioStreamPlayer2D](../../classes/class_audiostreamplayer2d.md#class-audiostreamplayer2d) or
[AudioStreamPlayer3D](../../classes/class_audiostreamplayer3d.md#class-audiostreamplayer3d) node. This leads to increased latency
(especially when thread support is disabled), but it allows the full suite
of Godot's audio features to work.

<a id="doc-javascript-export-options"></a>
...
If you plan to use [VRAM compression](../assets_pipeline/importing_images.md#doc-importing-images) make sure that
...
the default HTML page. See [Custom HTML page for Web export](../platform/web/customizing_html5_shell.md#doc-customizing-html5-shell).
...
[project settings](../rendering/multiple_resolutions.md#doc-multiple-resolutions).
...
<a id="doc-exporting-for-web-thread-extension-support"></a>

### Thread and extension support

If **Thread Support** is enabled, the exported project will be able to
[make use of multithreading](../performance/using_multiple_threads.md#doc-using-multiple-threads) to improve
...
[Serving the files](#doc-exporting-for-web-serving-the-files) section below.

If **Extensions Support** is enabled, [GDExtensions](../scripting/gdextension/what_is_gdextension.md#doc-what-is-gdextension)
...
<a id="doc-javascript-secure-contexts"></a>
...
Querying the [Input](../../classes/class_input.md#class-input) singleton is not sufficient, the relevant
...
[customization of the HTML page](../platform/web/customizing_html5_shell.md#doc-customizing-html5-shell).
...
Apple's Safari team also posted additional information about their [Auto-Play Policy Changes for macOS](https://webkit.org/blog/7734/auto-play-policy-changes-for-macos/).

#### WARNING
Access to microphone requires a
[secure context](#doc-javascript-secure-contexts).
...
Currently, only [HTTP client](../networking/http_client_class.md#doc-http-client-class),
[HTTP requests](../networking/http_request_class.md#doc-http-request-class),
[WebSocket (client)](../networking/websocket.md#doc-websocket) and [WebRTC](../networking/webrtc.md#doc-webrtc) are
supported.
...
#### WARNING
Requires a [secure context](#doc-javascript-secure-contexts).
...
<a id="doc-exporting-for-web-serving-the-files"></a>
...
used, see [Custom HTML page for Web export](../platform/web/customizing_html5_shell.md#doc-customizing-html5-shell).

#### WARNING
Only when exporting with **Use Threads**, to ensure low audio latency and the
ability to use [Thread](../../classes/class_thread.md#class-thread) in web exports, Godot 4 web exports use
[SharedArrayBuffer](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/SharedArrayBuffer).
This requires a [secure context](#doc-javascript-secure-contexts),
...
([supports manual gzip precompression](https://docs.gitlab.com/user/project/pages/introduction/#serving-compressed-assets))

## Interacting with the browser and JavaScript

See the [dedicated page](../platform/web/javascript_bridge.md#doc-web-javascript-bridge) on how to interact
...
<a id="doc-exporting-for-web-troubleshooting"></a>
...
Update on reload and reload the page, or click Unregister
next to the service worker that is currently registered, then reload the page.

![Unregistering the service worker in Chromium-based browsers' DevTools](tutorials/export/img/exporting_for_web_reset_unregister_service_worker_chromium.webp)
...
icon if the devtools pane is narrow). Click Unregister next to the
service worker that is currently registered, then reload the page.

![Unregistering the service worker in Firefox's DevTools](tutorials/export/img/exporting_for_web_reset_unregister_service_worker_firefox.webp)

## Export options

You can find a full list of export options available in the
[EditorExportPlatformWeb](../../classes/class_editorexportplatformweb.md#class-editorexportplatformweb) class reference.
