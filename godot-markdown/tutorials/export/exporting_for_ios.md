...
read [Compiling for iOS](../../engine_details/development/compiling/compiling_for_ios.md#doc-compiling-for-ios).
...
is experimental and [some limitations apply](../scripting/c_sharp/index.md#doc-c-sharp-platforms).
...
<br/>
You can find the code over at [developer.apple.com](https://developer.apple.com/account/resources/certificates/list) next to your name in the top right corner.
<br/>
...
![image](tutorials/export/img/ios_export_file.webp)
...
![image](tutorials/export/img/ios_export_output.webp)
...
![image](tutorials/export/img/ios_export_add_dir.webp)
...
![image](tutorials/export/img/ios_export_file_ref.webp)
1. See the **godot_project_to_export** folder in the Xcode file browser.
2. Select the godot project in the Project navigator. Then on the other side of the XCode window, in the File Inspector, make these selections:

> * **Location**: Relative to Project
> * **Build Rules**: Apply Once to Folder
> * add your project to **Target Membership**
![image](tutorials/export/img/ios_export_file_inspector.webp)![image](tutorials/export/img/ios_export_target_membership.webp)
1. Delete **exported_xcode_project_name.pck** from the Xcode project in the project navigator.

![image](tutorials/export/img/ios_export_delete_pck.webp)
...
![image](tutorials/export/img/ios_export_set_path.webp)
...
[Plugins for iOS](../platform/ios/plugins_for_ios.md#doc-plugins-for-ios) page.
...
[EditorExportPlatformIOS](../../classes/class_editorexportplatformios.md#class-editorexportplatformios) class reference.
