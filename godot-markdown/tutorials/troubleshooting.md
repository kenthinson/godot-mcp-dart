...
#### SEE ALSO
See [Using the Web editor](editor/using_the_web_editor.md#doc-using-the-web-editor) for caveats specific to the Web version
of the Godot editor.
...
This is a [known issue](https://github.com/godotengine/godot/issues/38219).
...
[known bug](https://github.com/godotengine/godot/issues/20566) on
...
![Correct appearance (left), oversharpened appearance due to graphics driver sharpening (right)](tutorials/img/troubleshooting_graphics_driver_sharpening.webp)
...
As [most displays are not designed to display SDR content in HDR mode](https://tftcentral.co.uk/articles/heres-why-you-should-only-enable-hdr-mode-on-your-pc-when-you-are-viewing-hdr-content),
...
result by ensuring the display is configured to use 
tonemapping (as opposed to ), then
[using the Windows HDR calibration app](https://support.microsoft.com/en-us/windows/calibrate-your-hdr-display-using-the-windows-hdr-calibration-app-f30f4809-3369-43e4-9b02-9eabebd23f19).
...
[option to preserve video memory after suspend](https://wiki.archlinux.org/title/NVIDIA/Tips_and_tricks#Preserve_video_memory_after_suspend)
...
[Resource options](export/exporting_projects.md#doc-exporting-projects-export-mode) for more information.
...
On Windows, this can also be due to [case sensitivity](best_practices/project_organization.md#doc-project-organization-case-sensitivity) issues. If you reference a resource
...
crashes. See the [Project Manager page](editor/project_manager.md#doc-project-manager) for more
information.
