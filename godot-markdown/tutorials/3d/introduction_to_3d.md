...
![An example 3D game demo created using Godot](tutorials/3d/img/godot-tps-demo.webp)
...
check out [Vector math](../math/vector_math.md#doc-vector-math) and [Using 3D transforms](using_transforms.md#doc-using-transforms).
...
![image](tutorials/3d/img/tuto_3d3.webp)
...
right docks should be familiar from [editor introduction](../editor/index.md#doc-editor-introduction).
...
![image](tutorials/3d/img/3d_toolbar.webp)
...
- **Move Mode** (`W`): Enables move (or translate) mode for the selected nodes.
  See [Space and manipulation gizmos](#doc-introduction-to-3d-space-and-manipulation) for more details.
- **Rotate Mode** (`E`): Enables rotation mode for the selected nodes. See
  [Space and manipulation gizmos](#doc-introduction-to-3d-space-and-manipulation) for more details.
- **Scale Mode** (`R`): Enables scaling and displays scaling gizmos in different
  axes for the selected nodes. See [Space and manipulation gizmos](#doc-introduction-to-3d-space-and-manipulation)
  for more details.
...
- **Use Local Space** (`T`): If enabled, gizmos of a node are drawn using the current node's
  rotation angle instead of the [global viewport axes](#doc-introduction-to-3d-coordinate-system).
...
- **Toggle preview sunlight**: If no DirectionalLight3D exist in the scene, a preview
  ...
  [Preview environment and light](#doc-introduction-to-3d-preview-environment-light) for more details.
...
- **Edit Sun and Environment Settings (three dots)**: Opens the menu to configure preview
  sunlight and environment settings. See [Preview environment and light](#doc-introduction-to-3d-preview-environment-light)
  for more details.
...
![image](tutorials/3d/img/tuto_3d6.webp)
...
![image](tutorials/3d/img/tuto_3d6_2.webp)
...
![image](tutorials/3d/img/tuto_3d6_1.webp)
...
<a id="doc-introduction-to-3d-coordinate-system"></a>
...
![3D coordinate systems comparison chart](tutorials/3d/img/introduction_to_3d_coordinate_systems.webp)

<a id="doc-introduction-to-3d-space-and-manipulation"></a>
...
![image](tutorials/3d/img/tuto_3d5.webp)
...
![image](tutorials/3d/img/tuto_3d4.webp)
...
![image](tutorials/3d/img/tuto_3d_gizmo.webp)
...
![image](tutorials/3d/img/tuto_3d_updated_view_menu.webp)
...
[Node2D](../../classes/class_node2d.md#class-node2d) is the base node for 2D.
[Control](../../classes/class_control.md#class-control) is the base node for everything GUI.
Following this reasoning, the 3D engine uses the [Node3D](../../classes/class_node3d.md#class-node3d)
node for everything 3D.

![image](tutorials/3d/img/tuto_3d1.webp)
...
[Transform3D](../../classes/class_transform3d.md#class-transform3d), or as 3 [Vector3](../../classes/class_vector3.md#class-vector3)
members representing location, Euler rotation (X, Y and Z angles) and
scale.

![image](tutorials/3d/img/tuto_3d2.webp)
...
#### SEE ALSO
See [Importing 3D scenes](../assets_pipeline/importing_3d_scenes/index.md#doc-importing-3d-scenes) for more on importing.

### Generated geometry

It is possible to create custom geometry by using the
[ArrayMesh](../../classes/class_arraymesh.md#class-arraymesh) resource directly. Simply create your arrays
and use the [ArrayMesh.add_surface_from_arrays()](../../classes/class_arraymesh.md#class-arraymesh-method-add-surface-from-arrays)
function. A helper class is also available, [SurfaceTool](../../classes/class_surfacetool.md#class-surfacetool),
...
[Prototyping levels with CSG](csg_tools.md#doc-csg-tools).

### Immediate geometry

If, instead, you need to generate simple geometry that will be updated often,
Godot provides a special [ImmediateMesh](../../classes/class_immediatemesh.md#class-immediatemesh) resource
that can be used in a [MeshInstance3D](../../classes/class_meshinstance3d.md#class-meshinstance3d) node.
...
[Sprite3D](../../classes/class_sprite3d.md#class-sprite3d) and
[AnimatedSprite3D](../../classes/class_animatedsprite3d.md#class-animatedsprite3d)
...
Godot provides a [WorldEnvironment](../../classes/class_worldenvironment.md#class-worldenvironment)
...
<a id="doc-introduction-to-3d-preview-environment-light"></a>

### Preview environment and light

By default, any 3D scene that doesn't have a [WorldEnvironment](../../classes/class_worldenvironment.md#class-worldenvironment)
node, or a [DirectionalLight3D](../../classes/class_directionallight3d.md#class-directionallight3d), will have
...
![image](tutorials/3d/img/tuto_3d8.webp)
...
![image](tutorials/3d/img/tuto_3d9.webp)
...
displayed unless a [Camera3D](../../classes/class_camera3d.md#class-camera3d) is
also added to the scene. Cameras can work in either orthogonal or
perspective projections:

![image](tutorials/3d/img/tuto_3d10.webp)
...
![image](tutorials/3d/img/tuto_3d11.png)
...
See [3D lights and shadows](lights_and_shadows.md#doc-lights-and-shadows) for more information on setting up lights in Godot.
