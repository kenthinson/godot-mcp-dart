<a id="doc-3d-rendering-limitations"></a>
...
<a id="doc-3d-rendering-limitations-color-banding"></a>
...
- If using the Forward+ or Forward Mobile rendering methods, enable
  [Use Debanding](../../classes/class_projectsettings.md#class-projectsettings-property-rendering-anti-aliasing-quality-use-debanding)
...
- Alternatively, bake some noise into your textures. This is mainly effective in
  ...
  shader](https://github.com/fractilegames/godot-gles2-debanding-material) to
...
![Color banding comparison (contrast increased for more visibility)](tutorials/3d/img/3d_rendering_limitations_banding.webp)

#### SEE ALSO
See [Banding in Games: A Noisy Rant (PDF)](https://loopit.dk/banding_in_games.pdf)
...
![Z-fighting comparison (before and after tweaking the scene by offsetting the Label3D away from the floor)](tutorials/3d/img/3d_rendering_limitations_z_fighting.webp)

<a id="doc-3d-rendering-limitations-transparency-sorting"></a>
...
[Render Priority](../../classes/class_material.md#class-material-property-render-priority)
property or the node's
[Sorting Offset](../../classes/class_visualinstance3d.md#class-visualinstance3d-property-sorting-offset).
...
![Transparency sorting comparison (alpha-blended materials on the left, alpha scissor materials on the right)](tutorials/3d/img/3d_rendering_limitations_transparency_sorting.webp)
