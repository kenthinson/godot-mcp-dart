<a id="doc-standard-material-3d"></a>
...
![image](tutorials/3d/img/add_material.webp)
...
![image](tutorials/3d/img/spatial_material1.webp)
...
![image](tutorials/3d/img/spatial_material12.png)

#### WARNING
Alpha-blended transparency has several
[limitations](3d_rendering_limitations.md#doc-3d-rendering-limitations-transparency-sorting):
...
<a id="doc-standard-material-3d-alpha-antialiasing"></a>
...
techniques](3d_antialiasing.md#doc-3d-antialiasing) such as FXAA and TAA, this is not always
...
![image](tutorials/3d/img/spatial_material8.png)
...
![image](tutorials/3d/img/material_depth_draw.png)
...
![image](tutorials/3d/img/spatial_material3.png)
...
![image](tutorials/3d/img/material_depth_test.webp)
...
![Three spheres showing the Per-Pixel, Per-Vertex, and Unshaded modes.](tutorials/3d/img/standard_material_shading_modes.webp)
...
![Two cubes with a brick texture, one shaded and one unshaded.](tutorials/3d/img/standard_material_shading_modes_textured.webp)
...
![image](tutorials/3d/img/spatial_material6.webp)
...
![image](tutorials/3d/img/spatial_material7.webp)
...
![image](tutorials/3d/img/spatial_material4.webp)
...
![image](tutorials/3d/img/spatial_material13.png)
...
![image](tutorials/3d/img/spatial_material14.png)

## Emission

*Emission* specifies how much light is emitted by the material (keep in mind this
does not include light surrounding geometry unless [VoxelGI](global_illumination/using_voxel_gi.md#doc-using-voxel-gi)
or [SDFGI](global_illumination/using_sdfgi.md#doc-using-sdfgi) are used). This value is added to the resulting
final image and is not affected by other lighting in the scene.

![image](tutorials/3d/img/spatial_material15.png)
...
![image](tutorials/3d/img/spatial_material16.png)
...
![image](tutorials/3d/img/spatial_material_bentnormals.webp)
...
![image](tutorials/3d/img/spatial_material17.png)
...
![image](tutorials/3d/img/clearcoat_comparison.png)
...
![image](tutorials/3d/img/spatial_material18.png)
...
![image](tutorials/3d/img/spatial_material19.png)
...
for physics collision (such as terrain), see [HeightMapShape3D](../../classes/class_heightmapshape3d.md#class-heightmapshape3d). It
...
![image](tutorials/3d/img/spatial_material20.png)
...
![image](tutorials/3d/img/spatial_material21.png)
...
![image](tutorials/3d/img/spatial_material22.png)
...
![image](tutorials/3d/img/spatial_material23.png)
...
- [Transparency sorting](3d_rendering_limitations.md#doc-3d-rendering-limitations-transparency-sorting)
  issues may occur.
...
![image](tutorials/3d/img/spatial_material24.png)
...
<a id="doc-standard-material-3d-triplanar-mapping"></a>
...
![image](tutorials/3d/img/spatial_material25.png)
...
<a id="doc-standard-material-3d-sampling"></a>

## Sampling

### Filter

The filtering method for the textures used by the material. See [this page](../../classes/class_basematerial3d.md#class-basematerial3d-property-texture-filter)
for a full list of options and their description.

### Repeat

if the textures used by the material repeat, and how they repeat. See [this page](../../classes/class_basematerial3d.md#class-basematerial3d-property-texture-repeat)
for a full list of options and their description.
...
* **Particle Billboard:** Most suited for particle systems, because it allows
  specifying [flipbook animation](particles/process_material_properties.md#doc-process-material-properties-animation).

![image](tutorials/3d/img/spatial_material9.webp)
...
<a id="ref-standard-material-3d-grow"></a>

## Grow

Grows the object vertices in the direction pointed by their normals:

![image](tutorials/3d/img/spatial_material10.png)
...
![image](tutorials/3d/img/spatial_material11.png)
...
using the **Outline** [stencil mode](#doc-standard-material-3d-stencil).
...
![image](tutorials/3d/img/spatial_material_proxfade.gif)
...
![image](tutorials/3d/img/standart_material_distance_fade_pixel_alpha_mode.webp)

**Pixel Dither** mode: What this does is sort of approximate the transparency
by only having a fraction of the pixels rendered.

![image](tutorials/3d/img/standart_material_distance_fade_pixel_dither_mode.webp)

**Object Dither** mode: Like the previous mode, but the calculated transparency
is the same across the entire object's surface.

![image](tutorials/3d/img/standart_material_distance_fade_object_dither_mode.webp)

<a id="doc-standard-material-3d-stencil"></a>
...
![image](tutorials/3d/img/material_stencil.webp)

Materials that write to the stencil buffer are always drawn in the transparent pass,
so they are subject to the usual
[transparency limitations](3d_rendering_limitations.md#doc-3d-rendering-limitations-transparency-sorting).

#### NOTE
Like with the [Grow property](#ref-standard-material-3d-grow), for the
...
Objects are sorted by an opaque/transparent queue, then [render_priority](../../classes/class_material.md#class-material-property-render-priority),
...
Setting [next_pass](../../classes/class_material.md#class-material-property-next-pass) on a material
will cause an object to be rendered again with that next material.

Materials are sorted by an opaque/transparent queue, then [render_priority](../../classes/class_material.md#class-material-property-render-priority),
with higher priority being drawn later.

![image](tutorials/3d/img/next_pass.webp)

Depth will test equal between both materials unless the grow setting or other vertex transformations are used.
Multiple transparent passes should use [render_priority](../../classes/class_material.md#class-material-property-render-priority) to ensure correct ordering.
