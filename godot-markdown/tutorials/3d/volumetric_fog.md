...
As described in [Environment and post-processing](environment_and_post_processing.md#doc-environment-and-post-processing), Godot supports
...
cannot be customized with [Fog shaders](../shaders/shader_reference/fog_shader.md#doc-fog-shader).
...
[Volumetric Fog demo project](https://github.com/godotengine/godot-demo-projects/tree/master/3d/volumetric_fog).
...
![image](tutorials/3d/img/volumetric_fog_comparison.png)
...
![image](tutorials/3d/img/volumetric_fog_lighting.png)
...
- **Material:** The material used by the FogVolume. Can be either a
  built-in FogMaterial or a custom ShaderMaterial ([Fog shaders](../shaders/shader_reference/fog_shader.md#doc-fog-shader)).
...
- **Density Texture:** The 3D texture that is used to scale the member density
  ...
  [fog shader](../shaders/shader_reference/fog_shader.md#doc-fog-shader).
  You can import any image as a 3D texture by
  [changing its import type in the Import dock](../assets_pipeline/importing_images.md#doc-importing-images-changing-import-type).
...
![FogMaterial comparison (without and with density texture)](tutorials/3d/img/volumetric_fog_fog_material_density_texture.webp)
...
FogVolume nodes' appearance can be customized using [Fog shaders](../shaders/shader_reference/fog_shader.md#doc-fog-shader).
...
4. Set the **Albedo > Texture** to the texture below (right-click and choose **Save as…**):
   ![image](tutorials/3d/img/volumetric_fog_quad_mesh_texture.webp)
