...
simulated using the `viewport` stretch mode. See [Multiple resolutions](../rendering/multiple_resolutions.md#doc-multiple-resolutions)
...
- **Bilinear:** Standard bilinear filtering (default). This is used as a fallback
  ...
  all renderers.*
- **FSR 1.0:** [AMD FidelityFX Super Resolution 1.0](https://gpuopen.com/fidelityfx-superresolution/).
...
![image](tutorials/3d/img/resolution_scaling_bilinear_0.5.png)![image](tutorials/3d/img/resolution_scaling_fsr1_0.5.png)![image](tutorials/3d/img/resolution_scaling_fsr2_0.5.webp)
...
![image](tutorials/3d/img/resolution_scaling_bilinear_msaa_4x_0.5.png)![image](tutorials/3d/img/resolution_scaling_fsr1_msaa_4x_0.5.png)![image](tutorials/3d/img/resolution_scaling_fsr2_msaa_4x_0.5.webp)
...
property on a [Viewport](../../classes/class_viewport.md#class-viewport) node.
...
**not recommended** for most use cases. See [3D antialiasing](3d_antialiasing.md#doc-3d-antialiasing) for more
information.
...
<a id="doc-resolution-scaling-mipmap-bias"></a>
...
can also be changed at runtime on [Viewports](../../classes/class_viewport.md#class-viewport) by
...
![image](tutorials/3d/img/resolution_scaling_texture_mipmap_bias_comparison.png)
...
See the [Performance](../performance/index.md#doc-performance) tutorials for more information.
