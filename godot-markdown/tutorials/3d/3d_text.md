...
[3D Labels and Texts demo project](https://github.com/godotengine/godot-demo-projects/tree/master/3d/labels_and_texts).
...
[GUI in 3D](https://github.com/godotengine/godot-demo-projects/tree/master/viewport/gui_in_3d)
demo project.

## Label3D

![image](tutorials/3d/img/label_3d.png)
...
#### SEE ALSO
See [Using Fonts](../ui/gui_using_fonts.md#doc-gui-using-fonts) for guidelines on configuring font imports.
...
See [Transparency sorting](3d_rendering_limitations.md#doc-3d-rendering-limitations-transparency-sorting)
...
text rendering quality, [enable mipmaps on the font](../ui/gui_using_fonts.md#doc-using-fonts-mipmaps) or
[switch the font to use MSDF rendering](../ui/gui_using_fonts.md#doc-using-fonts-msdf).

## TextMesh

![image](tutorials/3d/img/text_mesh.png)
...
![image](tutorials/3d/img/text_mesh_texture.png)![image](tutorials/3d/img/text_mesh_textured.png)
...
- Antialiasing the text rendering requires a full-scene antialiasing method to
  ...
  distance. See [3D antialiasing](3d_antialiasing.md#doc-3d-antialiasing) for more information.
...
return value of [unproject_position](../../classes/class_camera3d.md#class-camera3d-method-unproject-position)
...
See the [3D waypoints](https://github.com/godotengine/godot-demo-projects/tree/master/3d/waypoints)
