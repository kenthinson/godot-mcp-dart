<a id="doc-procedural-geometry"></a>
...
* [Using the ArrayMesh](arraymesh.md)
* [Using the MeshDataTool](meshdatatool.md)
* [Using the SurfaceTool](surfacetool.md)
* [Using ImmediateMesh](immediatemesh.md)
...
Many things in Godot have mesh in their name: the [Mesh](../../../classes/class_mesh.md#class-mesh), the
[ArrayMesh](../../../classes/class_arraymesh.md#class-arraymesh), the [ImmediateMesh](../../../classes/class_immediatemesh.md#class-immediatemesh), the [MeshInstance3D](../../../classes/class_meshinstance3d.md#class-meshinstance3d), the
[MultiMesh](../../../classes/class_multimesh.md#class-multimesh), and the [MultiMeshInstance3D](../../../classes/class_multimeshinstance3d.md#class-multimeshinstance3d). While they are all related, they have slightly
different uses.
...
hidden from the user in the [RenderingServer](../../../classes/class_renderingserver.md#class-renderingserver), but with ArrayMeshes, the user can construct a Mesh
...
in the Mesh when you use a MeshInstance3D using the [material_override](../../../classes/class_geometryinstance3d.md#class-geometryinstance3d-property-material-override) property.
...
`ArrayMesh.ARRAY_NORMAL` is a [PackedVector3Array](../../../classes/class_packedvector3array.md#class-packedvector3array) of vertex normals.
See [Mesh.ArrayType](../../../classes/class_mesh.md#enum-mesh-arraytype) for more information.
...
For more information about the ArrayMesh, please see the [ArrayMesh tutorial](arraymesh.md#doc-arraymesh).
...
For more information about the MeshDataTool, please see the [MeshDataTool tutorial](meshdatatool.md#doc-meshdatatool).

### SurfaceTool

The SurfaceTool allows the creation of Meshes using an OpenGL 1.x immediate mode style interface.

For more information about the SurfaceTool, please see the [SurfaceTool tutorial](surfacetool.md#doc-surfacetool).
...
For more information about ImmediateMesh, please see the [ImmediateMesh tutorial](immediatemesh.md#doc-immediatemesh).
