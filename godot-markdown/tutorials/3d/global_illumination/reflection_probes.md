<a id="doc-reflection-probes"></a>

# Reflection probes

As stated in the [Standard Material 3D and ORM Material 3D](../standard_material_3d.md#doc-standard-material-3d), objects can show reflected and/or
...
more accurate reflections than [VoxelGI](using_voxel_gi.md#doc-using-voxel-gi) and
[SDFGI](using_sdfgi.md#doc-using-sdfgi) while being fairly cheap on system resources.

Since reflection probes can also store ambient light, they can be used as a
low-end alternative to VoxelGI and SDFGI when [baked lightmaps](using_lightmap_gi.md#doc-using-lightmap-gi) aren't viable (e.g. in procedurally generated levels).
...
![Reflection probe disabled. Environment sky is used as a fallback.](tutorials/3d/global_illumination/img/gi_none.webp)![Reflection probe enabled.](tutorials/3d/global_illumination/img/gi_none_reflection_probe.webp)![Reflection probe enabled.](tutorials/3d/global_illumination/img/gi_lightmap_gi_indirect_only_reflection_probe.webp)
...
![Reflections in a room using ReflectionProbe only.](tutorials/3d/global_illumination/img/reflection_probes_reflection_probe.webp)![Reflections in a room using screen-space reflections only.](tutorials/3d/global_illumination/img/reflection_probes_ssr.webp)![Reflections in a room using ReflectionProbe and screen-space reflections together.](tutorials/3d/global_illumination/img/reflection_probes_reflection_probe_ssr.webp)

## Setting up a ReflectionProbe

- Add a [ReflectionProbe](../../../classes/class_reflectionprobe.md#class-reflectionprobe) node.
...
- **Enable Shadows:** Controls whether real-time light shadows should be
  ...
  reflections with shadows every frame. Fully [baked light](using_lightmap_gi.md#doc-using-lightmap-gi)
...
[reflection probe](#doc-reflection-probes). This limit can be increased by adjusting
