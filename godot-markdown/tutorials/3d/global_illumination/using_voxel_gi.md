...
![VoxelGI disabled.](tutorials/3d/global_illumination/img/gi_none.webp)![VoxelGI enabled.](tutorials/3d/global_illumination/img/gi_voxel_gi.webp)
...
to make use of custom shaders ([ShaderMaterial](../../../classes/class_shadermaterial.md#class-shadermaterial)). These meshes will be
...
For [BaseMaterial3D](../../../classes/class_basematerial3d.md#class-basematerial3d), some properties are currently ignored during baking.
...
#### SEE ALSO
See [Which global illumination mode should I use on meshes and lights?](introduction_to_global_illumination.md#doc-introduction-to-global-illumination-gi-mode-recommendations)
