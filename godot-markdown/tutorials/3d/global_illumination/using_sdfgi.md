...
[baked lightmaps](using_lightmap_gi.md#doc-using-lightmap-gi), but worse real-time ability than
[VoxelGI](using_voxel_gi.md#doc-using-voxel-gi).
...
![SDFGI disabled.](tutorials/3d/global_illumination/img/gi_none.webp)![SDFGI enabled.](tutorials/3d/global_illumination/img/gi_sdfgi.webp)
...
3. Enable **SDFGI > Enabled**. SDFGI will automatically follow the camera when it
