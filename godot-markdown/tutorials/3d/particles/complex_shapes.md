<a id="doc-3d-particles-complex-shapes"></a>

# Complex emission shapes

![Complex emission shapes](tutorials/3d/particles/img/particle_complex_emission.webp)

When it is not enough to emit particles from one of the simple shapes available
in the [process material](process_material_properties.md#doc-process-material-properties-shapes), Godot provides
...
![Creating emission points](tutorials/3d/particles/img/particle_create_emission_points.webp)![Select mesh for emission](tutorials/3d/particles/img/particle_select_emission_mesh.webp)![Set emission density](tutorials/3d/particles/img/particle_emission_density.webp)
...
![Emission textures](tutorials/3d/particles/img/particle_emission_textures.webp)
