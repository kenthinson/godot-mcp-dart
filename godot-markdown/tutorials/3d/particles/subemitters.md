<a id="doc-3d-particles-subemitters"></a>

# Particle sub-emitters

![Chained sub-emitters](tutorials/3d/particles/img/particle_sub_chain.webp)
...
![Assign sub-emitter](tutorials/3d/particles/img/particle_sub_assign.webp)![List particle systems](tutorials/3d/particles/img/particle_sub_list.webp)
...
of the [ParticleProcessMaterial](process_material_properties.md#doc-process-material-properties-subemitter) to something other than `Disabled`.
