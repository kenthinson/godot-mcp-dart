<a id="doc-3d-particles-properties"></a>

# 3D Particle system properties

## Emitter properties

![image](tutorials/3d/particles/img/particle_props_emitter.webp)
...
particle. See the [Sub-emitters](subemitters.md#doc-3d-particles-subemitters) section in this manual for a detailed explanation of how
to add a sub-emitter to a particle system.

<a id="doc-3d-particles-properties-time"></a>

## Time properties

![image](tutorials/3d/particles/img/particle_props_time.webp)
...
![image](tutorials/3d/particles/img/particle_preprocess.webp)
...
![image](tutorials/3d/particles/img/particle_speed_scale.webp)
...
![Particles running at low FPS](tutorials/3d/particles/img/particle_interpolate.webp)
...
#### NOTE
When using [particle collision](collision.md#doc-3d-particles-collision), tunneling can occur
if the particles move fast and colliders are thin. This can be remedied by increasing
`Fixed FPS` (at a performance cost).

<a id="doc-3d-particles-properties-collision"></a>

## Collision properties

#### SEE ALSO
Setting up particle collision requires following further steps described in
[3D Particle collisions](collision.md#doc-3d-particles-collision).
...
<a id="doc-3d-particles-properties-draw"></a>

## Drawing properties

![Particle drawing properties](tutorials/3d/particles/img/particle_drawing.webp)
...
![image](tutorials/3d/particles/img/particle_coords.webp)
...
similar to the `Billboard` property in the [Standard Material](../standard_material_3d.md#doc-standard-material-3d).
...
![Particle trails](tutorials/3d/particles/img/particle_trail.webp)
...
See the [Particle trails](trails.md#doc-3d-particles-trails) section in this manual for a detailed
