<a id="doc-physical-light-and-camera-units"></a>
...
have a [CameraAttributes](../../classes/class_cameraattributes.md#class-cameraattributes) resource assigned to the
...
On the Camera3D node, you can add a [CameraAttributes](../../classes/class_cameraattributes.md#class-cameraattributes)
resource to its **Attributes** property. This resource is used to control the
camera's depth of field and exposure. When using
[CameraAttributesPhysical](../../classes/class_cameraattributesphysical.md#class-cameraattributesphysical), its focal length property is also used to
...
See [Setting up physical camera units](#doc-physical-light-and-camera-units-setting-up-physical-camera-units)
...
If you haven't added a [WorldEnvironment](../../classes/class_worldenvironment.md#class-worldenvironment) and [Camera3D](../../classes/class_camera3d.md#class-camera3d)
...
the [Environment](../../classes/class_environment.md#class-environment) resource:
...
- **Intensity:** The light's intensity in [lux](https://en.wikipedia.org/wiki/Lux) (DirectionalLight3D) or
  [lumens](https://en.wikipedia.org/wiki/Lumen_(unit)) (OmniLight3D/SpotLight3D).
...
![Color temperature chart from 1,000 Kelvin (left) to 12,500 Kelvin (right)](tutorials/3d/img/physical_light_units_color_temperature_chart.webp)
...
<a id="doc-physical-light-and-camera-units-setting-up-physical-camera-units"></a>

## Setting up physical camera units

Physical camera units can be enabled separately from physical light units.

After adding a [CameraAttributesPhysical](../../classes/class_cameraattributesphysical.md#class-cameraattributesphysical) resource to the **Camera
...
[this table](https://en.wikipedia.org/wiki/Exposure_value#Tabulated_exposure_values)
