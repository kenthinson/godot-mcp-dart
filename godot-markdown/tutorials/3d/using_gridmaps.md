<a id="doc-using-gridmaps"></a>

# Using GridMaps

## Introduction

[Gridmaps](../../classes/class_gridmap.md#class-gridmap) are a tool for creating 3D
game levels, similar to the way [TileMap](../2d/using_tilemaps.md#doc-using-tilemaps)
works in 2D. You start with a predefined collection of 3D meshes (a
[MeshLibrary](../../classes/class_meshlibrary.md#class-meshlibrary)) that can be placed on a grid,
...
To begin, you need a [MeshLibrary](../../classes/class_meshlibrary.md#class-meshlibrary), which is a collection
...
![image](tutorials/3d/img/gridmap_meshlibrary1.webp)

As you can see, this scene has a [Node3D](../../classes/class_node3d.md#class-node3d) node as its root, and
a number of [MeshInstance3D](../../classes/class_meshinstance3d.md#class-meshinstance3d) node children.
...
You can manually assign a [StaticBody3D](../../classes/class_staticbody3d.md#class-staticbody3d) and
[CollisionShape3D](../../classes/class_collisionshape3d.md#class-collisionshape3d) to each mesh. Alternatively, you can use the "Mesh" menu
to automatically create the collision body based on the mesh data.

![image](tutorials/3d/img/gridmap_create_body.webp)
...
![image](tutorials/3d/img/gridmap_mesh_scene.webp)
...
Like all mesh instances, MeshLibrary items can be assigned a [NavigationMesh](../../classes/class_navigationmesh.md#class-navigationmesh)
...
[NavigationRegion3D](../../classes/class_navigationregion3d.md#class-navigationregion3d) child node below the main MeshInstance3D for the GridMap
...
![image](tutorials/3d/img/meshlibrary_scene.png)
...
See [Using Lightmap global illumination](global_illumination/using_lightmap_gi.md#doc-using-lightmap-gi) for more information about lightmap baking.
...
- Be a [MeshInstance3D](../../classes/class_meshinstance3d.md#class-meshinstance3d), which will become the MeshLibrary item. Only
  this visual mesh will be exported.
- Have a material, in the mesh's material slot, *not* the MeshInstance3D's
  material slots.
- Have up to one [StaticBody3D](../../classes/class_staticbody3d.md#class-staticbody3d) child, for collision. The
  StaticBody3D should have one or more [CollisionShape3D](../../classes/class_collisionshape3d.md#class-collisionshape3d) children.
- Have up to one [NavigationRegion3D](../../classes/class_navigationregion3d.md#class-navigationregion3d) child, for navigation. The
  NavigationRegion3D can have one or more additional [MeshInstance3D](../../classes/class_meshinstance3d.md#class-meshinstance3d)
...
![image](tutorials/3d/img/gridmap_export.webp)
...
![image](tutorials/3d/img/gridmap_mesh_library_inspector.webp)
...
[Physics](../physics/index.md#doc-physics-index) section.
...
![image](tutorials/3d/img/gridmap_mesh_library_settings.webp)
...
![image](tutorials/3d/img/gridmap_panel.webp)
...
![image](tutorials/3d/img/gridmap_dropdown.webp)
...
See [GridMap](../../classes/class_gridmap.md#class-gridmap) for details on the node's methods and member variables.
