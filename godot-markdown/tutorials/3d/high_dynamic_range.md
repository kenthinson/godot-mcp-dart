...
![image](tutorials/3d/img/hdr_gamma.png)
...
in the current [Environment](../../classes/class_environment.md#class-environment) (more on that below).
...
HDR settings can be found in the [Environment](../../classes/class_environment.md#class-environment)
resource. Most of the time, these are found inside a
[WorldEnvironment](../../classes/class_worldenvironment.md#class-worldenvironment)
node or set in a Camera node. For more information, see
[Environment and post-processing](environment_and_post_processing.md#doc-environment-and-post-processing).
