<a id="doc-variable-rate-shading"></a>
...
[3D antialiasing](3d_antialiasing.md#doc-3d-antialiasing) technique (MSAA, FXAA, TAA, SSAA).
...
![Variable rate shading disabled in textured scene](tutorials/3d/img/variable_rate_shading_textured_disabled.webp)![Variable rate shading enabled in textured scene (lower quality, but higher performance)](tutorials/3d/img/variable_rate_shading_textured_enabled.webp)
...
![Variable rate shading disabled in untextured scene](tutorials/3d/img/variable_rate_shading_untextured_disabled.webp)![Variable rate shading enabled in untextured scene (lower quality, but higher performance)](tutorials/3d/img/variable_rate_shading_untextured_enabled.webp)
...
For XR, you can use [foveation level](../xr/openxr_settings.md#doc-openxr-settings-foveation-level)
as an alternative.
...
[Viewport](../../classes/class_viewport.md#class-viewport) node.
...
[command line argument](../editor/command_line_tutorial.md#doc-command-line-tutorial).
...
![Example VRS density map texture, simulating foveated rendering](tutorials/3d/img/variable_rate_shading_texture_example.webp)
