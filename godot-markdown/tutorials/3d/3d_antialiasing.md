...
[2D antialiasing](../2d/2d_antialiasing.md#doc-2d-antialiasing) page.
...
![Image is scaled by 2× with nearest-neighbor filtering to make aliasing more noticeable.](tutorials/3d/img/antialiasing_none_scaled.webp)
...
[3D Antialiasing demo project](https://github.com/godotengine/godot-demo-projects/tree/master/3d/antialiasing).
...
[alpha antialiasing](standard_material_3d.md#doc-standard-material-3d-alpha-antialiasing)
...
To make specular aliasing less noticeable, use the [Screen-space roughness limiter](),
which is enabled by default.

MSAA can be enabled in the Project Settings by changing the value of the
[Rendering > Anti Aliasing > Quality > MSAA 3D](../../classes/class_projectsettings.md#class-projectsettings-property-rendering-anti-aliasing-quality-msaa-3d)
...
![image](tutorials/3d/img/antialiasing_msaa_2x.webp)![image](tutorials/3d/img/antialiasing_msaa_4x.webp)![image](tutorials/3d/img/antialiasing_msaa_8x.webp)

<a id="doc-3d-antialiasing-taa"></a>
...
[Rendering > Anti Aliasing > Quality > TAA](../../classes/class_projectsettings.md#class-projectsettings-property-rendering-anti-aliasing-quality-use-taa)
setting.

Comparison between no antialiasing (left) and TAA (right):

![image](tutorials/3d/img/antialiasing_taa.webp)

<a id="doc-3d-antialiasing-fsr2"></a>
...
[AMD FidelityFX Super Resolution](https://www.amd.com/en/products/graphics/technologies/fidelityfx/super-resolution.html)
2.2. This is an [upscaling method](resolution_scaling.md#doc-resolution-scaling)
...
![image](tutorials/3d/img/antialiasing_fsr2_native.webp)
...
<a id="doc-3d-antialiasing-fxaa"></a>
...
[Rendering > Anti Aliasing > Quality > Screen Space AA](../../classes/class_projectsettings.md#class-projectsettings-property-rendering-anti-aliasing-quality-screen-space-aa)
setting to `FXAA`.

Comparison between no antialiasing (left) and FXAA (right):

![image](tutorials/3d/img/antialiasing_fxaa.webp)
...
![image](tutorials/3d/img/antialiasing_smaa.webp)
...
useful for [offline rendering](../animation/creating_movies.md#doc-creating-movies).

Supersample antialiasing is performed by increasing the
[Rendering > Scaling 3D > Scale](../../classes/class_projectsettings.md#class-projectsettings-property-rendering-scaling-3d-scale)
advanced project setting above `1.0` while ensuring
[Rendering > Scaling 3D > Mode](../../classes/class_projectsettings.md#class-projectsettings-property-rendering-scaling-3d-mode)
...
![image](tutorials/3d/img/antialiasing_ssaa_2.25x.webp)![image](tutorials/3d/img/antialiasing_ssaa_4x.webp)
...
[non-real-time rendering](../animation/creating_movies.md#doc-creating-movies). For example, to make
...
| Transparency antialiasing | 🟡 Some <sup>[1](#id5)</sup> | 🟢 Yes <sup>[2](#id6)</sup> | 🟢 Yes <sup>[2](#id6)</sup> | 🟢 Yes      | 🟢 Yes     | 🟢 Yes                       | 🔴 No   |
| Added blur                | 🟢 None                      | 🟡 Some                     | 🟡 Some                     | 🟡 Some     | 🟢 Low     | 🟡 Some <sup>[3](#id7)</sup> | 🟢 None |
...
* <a id='id5'>**[1]**</a> MSAA does not work well with materials with Alpha Scissor (1-bit transparency). This can be mitigated by enabling `alpha antialiasing` on the material.
* <a id='id6'>**[2]**</a> TAA/FSR2 transparency antialiasing is most effective when using Alpha Scissor.
* <a id='id7'>**[3]**</a> SSAA has some blur from bilinear downscaling. This can be mitigated by using an integer scaling factor of `2.0`.
