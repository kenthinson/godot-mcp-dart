...
[Variant](../../engine_details/architecture/variant_class.md#doc-variant-class) class.
Variants can store Variant-compatible data structures such as
[Array](../../classes/class_array.md#class-array) and [Dictionary](../../classes/class_dictionary.md#class-dictionary) as well
as [Objects](../../classes/class_object.md#class-object).
...
[PackedStringArray](../../classes/class_packedstringarray.md#class-packedstringarray) would be something like
a `Vector<String>`.
...
its [script](../../classes/class_script.md#class-script) or the [ClassDB](../../classes/class_classdb.md#class-classdb).
One can find more information about what objects are and how they work in
the [Applying object-oriented principles in Godot](what_are_godot_classes.md#doc-what-are-godot-classes) article.
...
[AnimatedTexture](../../classes/class_animatedtexture.md#class-animatedtexture) is a texture that
...
Godot's [RenderingServer](../../classes/class_renderingserver.md#class-renderingserver) then draws
...
Also note that AnimatedTexture is a [Resource](../../classes/class_resource.md#class-resource) unlike
the other [Node](../../classes/class_node.md#class-node) objects discussed here. One might create
a [Sprite2D](../../classes/class_sprite2d.md#class-sprite2d) node that uses AnimatedTexture as its texture.
Or (something the others can't do) one could add AnimatedTextures as tiles
in a [TileSet](../../classes/class_tileset.md#class-tileset) and integrate it with a
[TileMapLayer](../../classes/class_tilemaplayer.md#class-tilemaplayer) for many auto-animating backgrounds that
all render in a single batched draw call.

The [AnimatedSprite2D](../../classes/class_animatedsprite2d.md#class-animatedsprite2d) node, in combination with the
[SpriteFrames](../../classes/class_spriteframes.md#class-spriteframes) resource, allows one to create a
...
an [AnimationPlayer](../../classes/class_animationplayer.md#class-animationplayer) node in conjunction with
...
their object. These are the cases where the [AnimationTree](../../classes/class_animationtree.md#class-animationtree)
shines. One can find an in-depth guide on using the AnimationTree
[here](../animation/animation_tree.md#doc-animation-tree).
