...
For all [Object](../../classes/class_object.md#class-object)s, the most basic way of referencing them
...
The same principle applies for [RefCounted](../../classes/class_refcounted.md#class-refcounted) objects.
While users often access [Node](../../classes/class_node.md#class-node) and
[Resource](../../classes/class_resource.md#class-resource) this way, alternative measures are available.
...
3. Keep in mind that loading a resource fetches the cached resource
   ...
   [duplicate](../../classes/class_resource.md#class-resource-method-duplicate) an existing reference
...
<a id="doc-accessing-data-or-logic-from-object"></a>
...
For example, the [CanvasItem](../../classes/class_canvasitem.md#class-canvasitem) class has a `visible`
...
[CanvasItem.visible](../../classes/class_canvasitem.md#class-canvasitem-property-visible), then Godot would do the
...
- If the script does not have the property, it performs a HashMap lookup in
  ...
  [data preferences](data_preferences.md#doc-data-preferences) docs.
...
- A method check. In the case of
  [CanvasItem.visible](../../classes/class_canvasitem.md#class-canvasitem-property-visible), one can
  ...
  ```
- Outsource the access to a [Callable](../../classes/class_callable.md#class-callable). These may be useful
