...
[preload](../../classes/class_@gdscript.md#class-gdscript-method-preload) method. It loads resources as
...
Its counterpart, the [load](../../classes/class_@gdscript.md#class-gdscript-method-load) method, loads a
...
[ResourceLoader.load(path)](../../classes/class_resourceloader.md#class-resourceloader-method-load) which is
...
3. If one wishes only to 'import' another class resource (script or scene),
   ...
   2. If the script requires a great many dependencies, and one does not wish
      ...
      [RefCounted](../../classes/class_refcounted.md#class-refcounted)-extending type, will cause the
...
please see the ["Change scenes manually"](../scripting/change_scenes_manually.md#doc-change-scenes-manually)
documentation.
