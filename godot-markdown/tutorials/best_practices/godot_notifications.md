<a id="doc-godot-notifications"></a>

# Godot notifications

Every Object in Godot implements a
[\_notification](../../classes/class_object.md#class-object-private-method-notification) method. Its purpose is to
...
[CanvasItem](../../classes/class_canvasitem.md#class-canvasitem) to "draw", it will call
...
- [Object::NOTIFICATION_POSTINITIALIZE](../../classes/class_object.md#class-object-constant-notification-postinitialize):
  a callback that triggers during object initialization. Not accessible to scripts.
- [Object::NOTIFICATION_PREDELETE](../../classes/class_object.md#class-object-constant-notification-predelete):
...
- [Node::NOTIFICATION_PARENTED](../../classes/class_node.md#class-node-constant-notification-parented):
  a callback that triggers anytime one adds a child node to another node.
- [Node::NOTIFICATION_UNPARENTED](../../classes/class_node.md#class-node-constant-notification-unparented):
...
[\_init](../../classes/class_object.md#class-object-private-method-init) method in Object. While it has no
...
can use the [PARENTED](../../classes/class_node.md#class-node-constant-notification-parented) notification.
