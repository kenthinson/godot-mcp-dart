<a id="doc-scenes-versus-scripts"></a>
...
- [Custom Types](../plugins/editor/making_plugins.md#doc-making-plugins)
  ...
  > - Set up using [EditorPlugin.add_custom_type](../../classes/class_editorplugin.md#class-editorplugin-method-add-custom-type).
- [Script Classes](../scripting/gdscript/gdscript_basics.md#doc-gdscript-basics-class-name)
...
Scenes help to avoid this performance issue. [PackedScene](../../classes/class_packedscene.md#class-packedscene), the base type that scenes inherit from, defines resources
