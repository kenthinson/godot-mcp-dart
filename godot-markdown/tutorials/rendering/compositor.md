<a id="doc-compositor"></a>

# The Compositor

The compositor is a new feature in Godot 4 that allows control over
the rendering pipeline when rendering the contents of a [Viewport](../../classes/class_viewport.md#class-viewport).

It can be configured on a [WorldEnvironment](../../classes/class_worldenvironment.md#class-worldenvironment)
node where it applies to all Viewports, or it can be configured on
a [Camera3D](../../classes/class_camera3d.md#class-camera3d) and apply only to
the Viewport using that camera.

The [Compositor](../../classes/class_compositor.md#class-compositor) resource is used to configure
the compositor. To get started, create a new compositor on the appropriate node:

![image](tutorials/rendering/img/new_compositor.webp)
...
You can find the finished demo project [here](https://github.com/godotengine/godot-demo-projects/tree/master/compute/post_shader).
...
We need to extend our node from [CompositorEffect](../../classes/class_compositoreffect.md#class-compositoreffect).
...
please check [Using compute shaders](../shaders/compute_shaders.md#doc-compute-shaders).
...
Note the use of a [Mutex](../../classes/class_mutex.md#class-mutex) in our code.
...
Note that we cast this to [RenderSceneBuffersRD](../../classes/class_renderscenebuffersrd.md#class-renderscenebuffersrd)
...
Note the use of our [UniformSetCacheRD](../../classes/class_uniformsetcacherd.md#class-uniformsetcacherd) cache
...
![image](tutorials/rendering/img/add_compositor_effect.webp)
...
![image](tutorials/rendering/img/post_process_shader.webp)

#### NOTE
For a more advanced example of post effects, check out the
[Radial blur based sky rays](https://github.com/BastiaanOlij/RERadialSunRays)
