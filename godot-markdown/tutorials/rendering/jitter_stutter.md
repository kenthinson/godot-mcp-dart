...
[physics interpolation](../physics/interpolation/physics_interpolation_quick_start_guide.md#doc-physics-interpolation-quick-start-guide)
...
[Physics Interpolation](../physics/interpolation/index.md#doc-physics-interpolation) documentation for details.
...
tick rate as described in the [Input lag](#doc-jitter-stutter-input-lag) section.
...
[optimization](../performance/general_optimization.md#doc-general-optimization).
...
for the first time. See [Reducing stutter from shader (pipeline) compilations](../performance/pipeline_compilations.md#doc-pipeline-compilations) for more information.
...
[ColorRect](../../classes/class_colorrect.md#class-colorrect) node) so that it's not visible to the player.
...
[Feral GameMode](https://github.com/FeralInteractive/gamemode) can be used
...
<a id="doc-jitter-stutter-input-lag"></a>
...
rate as per [this page](https://blurbusters.com/howto-low-lag-vsync-on/).
...
If your mouse offers multiple  settings, consider also
[using the highest possible setting and reducing in-game sensitivity to reduce mouse latency](https://www.youtube.com/watch?v=6AoRfv9W110).
