<a id="doc-localization-using-spreadsheets"></a>
...
locales](locales.md#doc-locales) supported by the engine, or they must start with an underscore (`_`),
...
[plural forms](internationalizing_games.md#doc-internationalizing-games-pluralization) in CSV files.
...
translate the string manually using [tr_n()](../../classes/class_object.md#class-object-method-tr-n).

### Specifying translation contexts

Since Godot 4.6, it is possible to specify
[translation contexts](internationalizing_games.md#doc-internationalizing-games-translation-contexts)
...
translate the string manually using [tr()](../../classes/class_object.md#class-object-method-tr)
or [tr_n()](../../classes/class_object.md#class-object-method-tr-n).
...
![image](tutorials/i18n/img/import_csv.webp)
...
[Configuring the imported translation](internationalizing_games.md#doc-internationalizing-games-configuring-imported-translation) so that the
