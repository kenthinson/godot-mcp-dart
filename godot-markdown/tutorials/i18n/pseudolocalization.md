...
[Pseudolocalizaton demo project](https://github.com/godotengine/godot-demo-projects/tree/master/gui/pseudolocalization).
...
![image](tutorials/i18n/img/pseudolocalization_settings.webp)

Pseudolocalization can also be [toggled at runtime from a script](#doc-pseudolocalization-runtime).
...
<a id="doc-pseudolocalization-runtime"></a>

## Configuring pseudolocalization at runtime

Pseudolocalization can be toggled at runtime using the
[pseudolocalization_enabled](../../classes/class_translationserver.md#class-translationserver-property-pseudolocalization-enabled) property
...
[ProjectSettings.set_setting(property, value)](../../classes/class_projectsettings.md#class-projectsettings-method-set-setting)
and then calling
[TranslationServer.reload_pseudolocalization()](../../classes/class_translationserver.md#class-translationserver-method-reload-pseudolocalization)
