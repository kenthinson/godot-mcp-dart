<a id="doc-random-number-generation"></a>
...
Godot internally uses the [PCG Family](https://www.pcg-random.org/)
of pseudorandom number generators.

## Global scope versus RandomNumberGenerator class

Godot exposes two ways to generate random numbers: via *global scope* methods or
using the [RandomNumberGenerator](../../classes/class_randomnumbergenerator.md#class-randomnumbergenerator) class.
...
In global scope, you can find a [randomize()](../../classes/class_@globalscope.md#class-globalscope-method-randomize) method. **This method should be called only
...
You can also set a fixed random seed instead using [seed()](../../classes/class_@globalscope.md#class-globalscope-method-seed). Doing so will give you *deterministic* results
across runs:
...
The function [randi()](../../classes/class_@globalscope.md#class-globalscope-method-randi) returns a random
...
[randf()](../../classes/class_@globalscope.md#class-globalscope-method-randf) returns a random floating-point
number between 0 and 1. This is useful to implement a
[Weighted random probability](#doc-random-number-generation-weighted-random-probability) system, among
other things.

[randfn()](../../classes/class_@globalscope.md#class-globalscope-method-randfn) returns a random
floating-point number following a [normal distribution](https://en.wikipedia.org/wiki/Normal_distribution). This means the returned
...
[randf_range()](../../classes/class_@globalscope.md#class-globalscope-method-randf-range) takes two arguments
...
[randi_range()](../../classes/class_@globalscope.md#class-globalscope-method-randi-range) takes two arguments `from`
...
or use the [Array.pick_random](../../classes/class_array.md#class-array-method-pick-random) method
to do it for us:
...
[Array.pick_random](../../classes/class_array.md#class-array-method-pick-random) since it lacks a way to
prevent repetition:
...
limited set of values. To prevent this, use the [shuffle bag](#doc-random-number-generation-shuffle-bags) pattern instead.
...
<a id="doc-random-number-generation-weighted-random-probability"></a>

## Weighted random probability

The [randf()](../../classes/class_@globalscope.md#class-globalscope-method-randf) method returns a
...
[rand_weighted()](../../classes/class_randomnumbergenerator.md#class-randomnumbergenerator-method-rand-weighted) method
...
<a id="doc-random-number-generation-shuffle-bags"></a>
...
terrain. Godot provides [FastNoiseLite](../../classes/class_fastnoiselite.md#class-fastnoiselite) for this, which supports
...
Godot offers a [Crypto](../../classes/class_crypto.md#class-crypto) class for this. This class can perform
...
self-signed [X509Certificate](../../classes/class_x509certificate.md#class-x509certificate)s.
...
#### SEE ALSO
See [PackedByteArray](../../classes/class_packedbytearray.md#class-packedbytearray)'s documentation for other methods you can
