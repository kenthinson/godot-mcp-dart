...
They rely on [interpolation](interpolation.md#doc-interpolation), which we saw in the
...
![image](tutorials/math/img/bezier_quadratic_points.png)
...
![image](tutorials/math/img/bezier_quadratic_points2.gif)
...
![image](tutorials/math/img/bezier_cubic_points.png)
...
![image](tutorials/math/img/bezier_cubic_points.gif)
...
![image](tutorials/math/img/bezier_cubic_handles.png)
...
There are two objects that contain curves: [Curve3D](../../classes/class_curve3d.md#class-curve3d) and [Curve2D](../../classes/class_curve2d.md#class-curve2d) (for 3D and 2D respectively).

They can contain several points, allowing for longer paths. It is also possible to set them to nodes: [Path3D](../../classes/class_path3d.md#class-path3d) and [Path2D](../../classes/class_path2d.md#class-path2d) (also for 3D and 2D respectively):

![image](tutorials/math/img/bezier_path_2d.png)
...
![image](tutorials/math/img/bezier_interpolation_speed.gif)
...
![image](tutorials/math/img/bezier_point_amount.png)
...
[Curve2D.tessellate()](../../classes/class_curve2d.md#class-curve2d-method-tessellate) function (which receives optional `stages` of recursion and angle `tolerance` arguments). This way, drawing something based on a curve is easier.
...
To make this easier, the curves need to be *baked* into equidistant points. This way, they can be approximated with regular interpolation (which can be improved further with a cubic option). To do this, just use the [Curve3D.sample_baked()](../../classes/class_curve3d.md#class-curve3d-method-sample-baked) method together with
[Curve2D.get_baked_length()](../../classes/class_curve2d.md#class-curve2d-method-get-baked-length). The first call to either of them will bake the curve internally.
...
![image](tutorials/math/img/bezier_interpolation_baked.gif)
