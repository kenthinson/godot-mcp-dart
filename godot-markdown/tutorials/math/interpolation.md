...
There are other types of interpolations, which will not be covered here. A recommended read afterwards is the [Bezier](beziers_and_curves.md#doc-beziers-and-curves) page.

## Vector interpolation

Vector types ([Vector2](../../classes/class_vector2.md#class-vector2) and [Vector3](../../classes/class_vector3.md#class-vector3)) can also be interpolated, they come with handy functions to do it
[Vector2.lerp()](../../classes/class_vector2.md#class-vector2-method-lerp) and [Vector3.lerp()](../../classes/class_vector3.md#class-vector3-method-lerp).

For cubic interpolation, there are also [Vector2.cubic_interpolate()](../../classes/class_vector2.md#class-vector2-method-cubic-interpolate) and [Vector3.cubic_interpolate()](../../classes/class_vector3.md#class-vector3-method-cubic-interpolate), which do a [Bezier](beziers_and_curves.md#doc-beziers-and-curves) style interpolation.
...
![image](tutorials/math/img/interpolation_vector.gif)
...
For this, the function [Transform3D.interpolate_with()](../../classes/class_transform3d.md#class-transform3d-method-interpolate-with) can be used.

Here is an example of transforming a monkey from Position1 to Position2:

![image](tutorials/math/img/interpolation_positions.png)
...
![image](tutorials/math/img/interpolation_monkey.gif)
...
![image](tutorials/math/img/interpolation_follow.gif)
...
see [Improved Lerp Smoothing](https://www.gamedeveloper.com/programming/improved-lerp-smoothing-)
or watch [Lerp smoothing is broken](https://www.youtube.com/watch?v=LSNQuFEDOyQ).
