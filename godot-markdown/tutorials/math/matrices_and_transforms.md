<a id="doc-matrices-and-transforms"></a>
...
and understand the [Vector math](vector_math.md#doc-vector-math) tutorial, as this tutorial
...
Most of this guide focuses on 2D, using [Transform2D](../../classes/class_transform2d.md#class-transform2d) and
[Vector2](../../classes/class_vector2.md#class-vector2), but the way things work in 3D is very similar.
...
![image](tutorials/math/img/matrices_and_transforms/identity.png)
...
![image](tutorials/math/img/matrices_and_transforms/identity-godot.png)
...
![image](tutorials/math/img/matrices_and_transforms/scale.png)
...
![image](tutorials/math/img/matrices_and_transforms/rotate1.png)
...
![image](tutorials/math/img/matrices_and_transforms/rotate2.png)
...
![image](tutorials/math/img/matrices_and_transforms/rotate3.png)
...
You might have noticed that [Transform2D](../../classes/class_transform2d.md#class-transform2d) actually
has three [Vector2](../../classes/class_vector2.md#class-vector2) values: `x`, `y`, and `origin`.
...
Note that in 3D, Godot has a separate [Basis](../../classes/class_basis.md#class-basis) structure
for holding the three [Vector3](../../classes/class_vector3.md#class-vector3) values of the basis,
since the code can get complex and it makes sense to separate
it from [Transform3D](../../classes/class_transform3d.md#class-transform3d) (which is composed of one
[Basis](../../classes/class_basis.md#class-basis) and one extra [Vector3](../../classes/class_vector3.md#class-vector3) for the origin).
...
![image](tutorials/math/img/matrices_and_transforms/identity-origin.png)

If we want to move the object to a position of (1, 2), we need
to set its `origin` vector to (1, 2):

![image](tutorials/math/img/matrices_and_transforms/translate.png)
...
![image](tutorials/math/img/matrices_and_transforms/putting-all-together.png)
...
matrix has four total numbers in two [Vector2](../../classes/class_vector2.md#class-vector2) values, while
...
![image](tutorials/math/img/matrices_and_transforms/identity-grid.png)
...
![image](tutorials/math/img/matrices_and_transforms/shear.png)
...
transforms by having multiple [Node2D](../../classes/class_node2d.md#class-node2d) or [Node3D](../../classes/class_node3d.md#class-node3d)
nodes parented to each other.

However, it's useful to understand how to manually calculate the values we
need. We will go over how you could use [Transform2D](../../classes/class_transform2d.md#class-transform2d) or
[Transform3D](../../classes/class_transform3d.md#class-transform3d) to manually calculate transforms of nodes.
...
![image](tutorials/math/img/matrices_and_transforms/apply.png)
...
axis is of type [Vector3](../../classes/class_vector3.md#class-vector3), and also that Godot stores
the [Basis](../../classes/class_basis.md#class-basis) separately from the [Transform3D](../../classes/class_transform3d.md#class-transform3d),
...
![image](tutorials/math/img/matrices_and_transforms/3d-identity.png)
...
[Basis](../../classes/class_basis.md#class-basis) vectors and the origin in both 2D and 3D:
[https://github.com/godotengine/godot-demo-projects/tree/master/misc/matrix_transform](https://github.com/godotengine/godot-demo-projects/tree/master/misc/matrix_transform)
...
[https://www.youtube.com/watch?v=rHLEWRxRGiM](https://www.youtube.com/watch?v=rHLEWRxRGiM)
...
represent quaternions using the [Quaternion](../../classes/class_quaternion.md#class-quaternion) struct. My suggestion
