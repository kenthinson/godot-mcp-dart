...
([ResourceLoader.load](../../classes/class_resourceloader.md#class-resourceloader-method-load) or GDScript's simpler
[load](../../classes/class_@gdscript.md#class-gdscript-method-load)) blocks your
...
[ResourceLoader.load_threaded_request](../../classes/class_resourceloader.md#class-resourceloader-method-load-threaded-request),
which will then be loaded in threads in the background.

You can check the status with
[ResourceLoader.load_threaded_get_status](../../classes/class_resourceloader.md#class-resourceloader-method-load-threaded-get-status).
...
[ResourceLoader.load_threaded_get](../../classes/class_resourceloader.md#class-resourceloader-method-load-threaded-get).
