<a id="doc-runtime-loading-and-saving"></a>

# Runtime file loading and saving

#### SEE ALSO
See [Saving games](saving_games.md#doc-saving-games) for information on saving and loading game progression.

Sometimes, [exporting packs, patches, and mods](../export/exporting_pcks.md#doc-exporting-pcks) is not
...
Runtime file loading can be combined with [HTTP requests](../networking/http_request_class.md#doc-http-request-class)
...
[Import process](../assets_pipeline/import_process.md#doc-import-process) for details.

#### SEE ALSO
You can see how saving and loading works in action using the
[Run-time File Saving and Loading (Serialization) demo project](https://github.com/godotengine/godot-demo-projects/blob/master/loading/runtime_save_load).

## Plain text and binary files

Godot's [FileAccess](../../classes/class_fileaccess.md#class-fileaccess) class provides methods to access files on the
...
Godot), [FileAccess](../../classes/class_fileaccess.md#class-fileaccess) provides several methods to read/write integers,
...
streams that are not part of a file, [PackedByteArray](../../classes/class_packedbytearray.md#class-packedbytearray) provides
...
`decode_` and `encode_`. See also [Binary serialization API](binary_serialization_api.md#doc-binary-serialization-api).

<a id="doc-runtime-file-loading-and-saving-images"></a>

## Images

Image's [Image.load_from_file](../../classes/class_image.md#class-image-method-load-from-file) static method
...
- [Image.load_jpg_from_buffer](../../classes/class_image.md#class-image-method-load-jpg-from-buffer)
- [Image.load_ktx_from_buffer](../../classes/class_image.md#class-image-method-load-ktx-from-buffer)
- [Image.load_png_from_buffer](../../classes/class_image.md#class-image-method-load-png-from-buffer)
- [Image.load_svg_from_buffer](../../classes/class_image.md#class-image-method-load-svg-from-buffer)
  or [Image.load_svg_from_string](../../classes/class_image.md#class-image-method-load-svg-from-string)
- [Image.load_tga_from_buffer](../../classes/class_image.md#class-image-method-load-tga-from-buffer)
- [Image.load_webp_from_buffer](../../classes/class_image.md#class-image-method-load-webp-from-buffer)

Several image formats can also be saved by Godot at runtime using the following
methods:

- [Image.save_png](../../classes/class_image.md#class-image-method-save-png)
  or [Image.save_png_to_buffer](../../classes/class_image.md#class-image-method-save-png-to-buffer)
- [Image.save_webp](../../classes/class_image.md#class-image-method-save-webp)
  or [Image.save_webp_to_buffer](../../classes/class_image.md#class-image-method-save-webp-to-buffer)
- [Image.save_jpg](../../classes/class_image.md#class-image-method-save-jpg)
  or [Image.save_jpg_to_buffer](../../classes/class_image.md#class-image-method-save-jpg-to-buffer)
- [Image.save_exr](../../classes/class_image.md#class-image-method-save-exr)
  or [Image.save_exr_to_buffer](../../classes/class_image.md#class-image-method-save-exr-to-buffer)
...
[Image.generate_mipmaps](../../classes/class_image.md#class-image-method-generate-mipmaps)
...
[reducing aliasing when downsampling](../rendering/multiple_resolutions.md#doc-multiple-resolutions-reducing-aliasing-on-downsampling).

Example of loading an image and displaying it in a [TextureRect](../../classes/class_texturerect.md#class-texturerect) node
(which requires conversion to [ImageTexture](../../classes/class_imagetexture.md#class-imagetexture)):
...
<a id="doc-runtime-file-loading-and-saving-audio-video-files"></a>
...
Example of loading an Ogg Vorbis audio file in an [AudioStreamPlayer](../../classes/class_audiostreamplayer.md#class-audiostreamplayer) node:
...
Example of loading an Ogg Theora video file in a [VideoStreamPlayer](../../classes/class_videostreamplayer.md#class-videostreamplayer) node:
...
<a id="doc-runtime-file-loading-and-saving-3d-scenes"></a>

## 3D scenes

Godot has first-class support for glTF 2.0, both in the editor and exported
projects. Using [GLTFDocument](../../classes/class_gltfdocument.md#class-gltfdocument) and [GLTFState](../../classes/class_gltfstate.md#class-gltfstate) together,
...
[FBXDocument](../../classes/class_fbxdocument.md#class-fbxdocument) and [FBXState](../../classes/class_fbxstate.md#class-fbxstate) classes. The code to do so
...
[GLTFState.base_path](../../classes/class_gltfstate.md#class-gltfstate-property-base-path) on your
GLTFState instance *before* calling
[GLTFDocument.append_from_buffer](../../classes/class_gltfdocument.md#class-gltfdocument-method-append-from-buffer)
or [GLTFDocument.append_from_file](../../classes/class_gltfdocument.md#class-gltfdocument-method-append-from-file).

<a id="doc-runtime-file-loading-and-saving-fonts"></a>

## Fonts

[FontFile.load_dynamic_font](../../classes/class_fontfile.md#class-fontfile-method-load-bitmap-font) supports the following
font file formats: TTF, OTF, WOFF, WOFF2, PFB, PFM

On the other hand, [FontFile.load_bitmap_font](../../classes/class_fontfile.md#class-fontfile-method-load-bitmap-font) supports
...
Godot's support for [System fonts](../ui/gui_using_fonts.md#doc-using-fonts-system-fonts).

Example of loading a font file automatically according to its file extension,
then adding it as a theme override to a [Label](../../classes/class_label.md#class-label) node:
...
Godot supports reading and writing ZIP archives using the [ZIPReader](../../classes/class_zipreader.md#class-zipreader)
and [ZIPPacker](../../classes/class_zippacker.md#class-zippacker) classes. This supports any ZIP file, including files
...
#### NOTE
Use [ProjectSettings.load_resource_pack](../../classes/class_projectsettings.md#class-projectsettings-method-load-resource-pack)
to load PCK or ZIP files exported by Godot as
[additional data packs](../export/exporting_pcks.md#doc-exporting-pcks). That approach is preferred
...
Example that lists files in a ZIP archive in an [ItemList](../../classes/class_itemlist.md#class-itemlist) node,
