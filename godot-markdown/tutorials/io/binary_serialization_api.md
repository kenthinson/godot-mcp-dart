<a id="doc-binary-serialization-api"></a>
...
via the global [bytes_to_var()](../../classes/class_@globalscope.md#class-globalscope-method-bytes-to-var)
and [var_to_bytes()](../../classes/class_@globalscope.md#class-globalscope-method-var-to-bytes) functions,
but it is also used in the `get_var` and `store_var` methods of
[FileAccess](../../classes/class_fileaccess.md#class-fileaccess) as well as the packet APIs for [PacketPeer](../../classes/class_packetpeer.md#class-packetpeer).
...
### 1: [bool](../../classes/class_bool.md#class-bool)

|   Offset |   Len | Type    | Description             |
|----------|-------|---------|-------------------------|
|        4 |     4 | Integer | 0 for False, 1 for True |

### 2: [int](../../classes/class_int.md#class-int)
...
### 3: [float](../../classes/class_float.md#class-float)
...
### 4: [String](../../classes/class_string.md#class-string)
...
### 5: [Vector2](../../classes/class_vector2.md#class-vector2)
...
### 6: [Rect2](../../classes/class_rect2.md#class-rect2)
...
### 7: [Vector3](../../classes/class_vector3.md#class-vector3)
...
### 8: [Transform2D](../../classes/class_transform2d.md#class-transform2d)
...
### 9: [Plane](../../classes/class_plane.md#class-plane)
...
### 10: [Quaternion](../../classes/class_quaternion.md#class-quaternion)
...
### 11: [AABB](../../classes/class_aabb.md#class-aabb)
...
### 12: [Basis](../../classes/class_basis.md#class-basis)
...
### 13: [Transform3D](../../classes/class_transform3d.md#class-transform3d)
...
### 14: [Color](../../classes/class_color.md#class-color)
...
### 15: [NodePath](../../classes/class_nodepath.md#class-nodepath)
...
### 16: [RID](../../classes/class_rid.md#class-rid) (unsupported)

### 17: [Object](../../classes/class_object.md#class-object)
...
[PROPERTY_USAGE_STORAGE](../../classes/class_@globalscope.md#class-globalscope-constant-property-usage-storage)
flag set will be serialized. You can add a new usage flag to a property by overriding the
[\_get_property_list](../../classes/class_object.md#class-object-private-method-get-property-list)
method in your class. You can also check how property usage is configured by
calling `Object._get_property_list` See
[PropertyUsageFlags](../../classes/class_@globalscope.md#enum-globalscope-propertyusageflags) for the
possible usage flags.

### 18: [Dictionary](../../classes/class_dictionary.md#class-dictionary)
...
### 19: [Array](../../classes/class_array.md#class-array)
...
### 20: [PackedByteArray](../../classes/class_packedbytearray.md#class-packedbytearray)
...
### 21: [PackedInt32Array](../../classes/class_packedint32array.md#class-packedint32array)
...
### 22: [PackedInt64Array](../../classes/class_packedint64array.md#class-packedint64array)
...
### 23: [PackedFloat32Array](../../classes/class_packedfloat32array.md#class-packedfloat32array)
...
### 24: [PackedFloat64Array](../../classes/class_packedfloat64array.md#class-packedfloat64array)
...
### 25: [PackedStringArray](../../classes/class_packedstringarray.md#class-packedstringarray)
...
### 26: [PackedVector2Array](../../classes/class_packedvector2array.md#class-packedvector2array)
...
### 27: [PackedVector3Array](../../classes/class_packedvector3array.md#class-packedvector3array)
...
### 28: [PackedColorArray](../../classes/class_packedcolorarray.md#class-packedcolorarray)
