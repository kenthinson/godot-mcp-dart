...
#### SEE ALSO
If you are interested in displaying 3D meshes on a 2D viewport, see the [Using a SubViewport as a texture](../shaders/using_viewport_as_texture.md#doc-viewport-as-texture) tutorial.
