<a id="doc-2d-sprite-animation"></a>
...
First, we'll use [AnimatedSprite2D](../../classes/class_animatedsprite2d.md#class-animatedsprite2d) to
...
with [AnimationPlayer](../../classes/class_animationplayer.md#class-animationplayer) and the *Animation*
property of [Sprite2D](../../classes/class_sprite2d.md#class-sprite2d).
...
![image](tutorials/2d/img/2d_animation_run_preview.gif)
...
![image](tutorials/2d/img/2d_animation_tree1.webp)

#### NOTE
The root node could also be [Area2D](../../classes/class_area2d.md#class-area2d) or
[RigidBody2D](../../classes/class_rigidbody2d.md#class-rigidbody2d). The animation will still be
made in the same way. Once the animation is completed, you can
assign a shape to the CollisionShape2D. See
[Physics Introduction](../physics/physics_introduction.md#doc-physics-introduction) for more
information.

Now select the `AnimatedSprite2D` and in its *SpriteFrames* property, select
"New SpriteFrames".

![image](tutorials/2d/img/2d_animation_new_spriteframes.webp)

Click on the new SpriteFrames resource and you'll see a new panel appear at the
bottom of the editor window:

![image](tutorials/2d/img/2d_animation_spriteframes.webp)

From the FileSystem dock on the left side, drag the 8 individual images into
the center part of the SpriteFrames panel. On the left side, change the name
of the animation from "default" to "run".

![image](tutorials/2d/img/2d_animation_spriteframes_done.webp)
...
![image](tutorials/2d/img/2d_animation_frog_spritesheet.png)
...
![image](tutorials/2d/img/2d_animation_add_from_spritesheet.webp)
...
![image](tutorials/2d/img/2d_animation_spritesheet_select_rows.webp)
...
![image](tutorials/2d/img/2d_animation_spritesheet_selectframes.webp)
...
![image](tutorials/2d/img/2d_animation_spritesheet_animation.webp)

Finally, check the play button on the SpriteFrames editor to see your frog jump!

![image](tutorials/2d/img/2d_animation_play_spritesheet_animation.webp)

## Sprite sheet with AnimationPlayer

Another way that you can animate when using a sprite sheet is to use a standard
[Sprite2D](../../classes/class_sprite2d.md#class-sprite2d) node to display the texture, and then animating the
change from texture to texture with [AnimationPlayer](../../classes/class_animationplayer.md#class-animationplayer).

Consider this sprite sheet, which contains 6 frames of animation:

![image](tutorials/2d/img/2d_animation_player-run.png)
...
![image](tutorials/2d/img/2d_animation_tree2.webp)
...
![image](tutorials/2d/img/2d_animation_setframes.webp)
...
![image](tutorials/2d/img/2d_animation_new_animation.webp)

Now select the `Sprite2D` node and click the key icon to add a new track.

![image](tutorials/2d/img/2d_animation_new_track.webp)

Continue adding frames at each point in the timeline (`0.1` seconds by
default), until you have all the frames from 0 to 5. You'll see the frames
actually appearing in the animation track:

![image](tutorials/2d/img/2d_animation_full_animation.webp)

Press "Play" on the animation to see how it looks.

![image](tutorials/2d/img/2d_animation_running.gif)
...
Instead, it's applied the next time the [AnimationPlayer](../../classes/class_animationplayer.md#class-animationplayer) is processed.
