<a id="doc-2d-lights-and-shadows"></a>
...
![No 2D lights or shadows, scene is unshaded](tutorials/2d/img/2d_lights_and_shadows_disabled.webp)![2D lights enabled (without shadows)](tutorials/2d/img/2d_lights_and_shadows_enabled_no_shadows.webp)![2D lights and shadows enabled](tutorials/2d/img/2d_lights_and_shadows_enabled.webp)

## Nodes

There are several nodes involved in a complete 2D lighting setup:

- [CanvasModulate](../../classes/class_canvasmodulate.md#class-canvasmodulate) (to darken the rest of the scene)
- [PointLight2D](../../classes/class_pointlight2d.md#class-pointlight2d) (for omnidirectional or spot lights)
- [DirectionalLight2D](../../classes/class_directionallight2d.md#class-directionallight2d) (for sunlight or moonlight)
- [LightOccluder2D](../../classes/class_lightoccluder2d.md#class-lightoccluder2d) (for light shadow casters)
- Other 2D nodes that receive lighting, such as Sprite2D or TileMapLayer.

[CanvasModulate](../../classes/class_canvasmodulate.md#class-canvasmodulate) is used to darken the scene by
...
[Sprite2Ds](../../classes/class_sprite2d.md#class-sprite2d) are used to display the textures for the light
blobs, the background, and for the shadow casters.

[PointLight2Ds](../../classes/class_pointlight2d.md#class-pointlight2d) are used to light the scene. The way a
light typically works is by adding a selected texture over the rest of the scene
to simulate lighting.

[LightOccluder2Ds](../../classes/class_lightoccluder2d.md#class-lightoccluder2d) are used to tell the shader
...
The shadows appear only on areas covered by the [PointLight2D](../../classes/class_pointlight2d.md#class-pointlight2d) and their direction is based on the center of the
[Light](../../classes/class_pointlight2d.md#class-pointlight2d).
...
![Neutral point light texture](tutorials/2d/img/2d_lights_and_shadows_neutral_point_light.webp)
...
<a id="doc-2d-lights-and-shadows-setting-up-shadows"></a>
...
For more information on canvas item shaders, see [CanvasItem shaders](../shaders/shader_reference/canvas_item_shader.md#doc-canvas-item-shader).

![Hard shadows](tutorials/2d/img/2d_lights_and_shadows_hard_shadow.webp)![Soft shadows (PCF13, Filter Smooth 1.5)](tutorials/2d/img/2d_lights_and_shadows_soft_shadow.webp)![Soft shadows with streaking artifacts due to Filter Smooth being too high (PCF5, Filter Smooth 4)](tutorials/2d/img/2d_lights_and_shadows_soft_shadow_streaks.webp)
...
![Creating a CanvasTexture resource for a Sprite2D node](tutorials/2d/img/2d_lights_and_shadows_create_canvastexture.webp)
