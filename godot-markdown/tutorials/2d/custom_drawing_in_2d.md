<a id="doc-custom-drawing-in-2d"></a>
...
[Control](../../classes/class_control.md#class-control) or [Node2D](../../classes/class_node2d.md#class-node2d)-based)
...
Add a script to any [CanvasItem](../../classes/class_canvasitem.md#class-canvasitem)
derived node, like [Control](../../classes/class_control.md#class-control) or
[Node2D](../../classes/class_node2d.md#class-node2d). Then override the
[\_draw()](../../classes/class_canvasitem.md#class-canvasitem-private-method-draw) function.
...
Draw commands are described in the [CanvasItem](../../classes/class_canvasitem.md#class-canvasitem)
class reference. There are plenty of them and we will see some of them
in the examples below.

## Updating

The [\_draw](../../classes/class_canvasitem.md#class-canvasitem-private-method-draw) function is only called
...
call [CanvasItem.queue_redraw](../../classes/class_canvasitem.md#class-canvasitem-method-queue-redraw)
...
[setter](../scripting/gdscript/gdscript_basics.md#doc-gdscript-basics-setters-getters), it forces a redraw
...
call [queue_redraw](../../classes/class_canvasitem.md#class-canvasitem-method-queue-redraw)
from the [\_process](../../classes/class_node.md#class-node-private-method-process) method, like this:
...
[draw_set_transform](../../classes/class_canvasitem.md#class-canvasitem-method-draw-set-transform) or
[draw_set_transform_matrix](../../classes/class_canvasitem.md#class-canvasitem-method-draw-set-transform-matrix).

When using [draw_line](../../classes/class_canvasitem.md#class-canvasitem-method-draw-line), you should
...
![image](tutorials/2d/img/draw_line.png)
...
The same applies to the [draw_rect](../../classes/class_canvasitem.md#class-canvasitem-method-draw-rect)
method with `filled = false`.

![image](tutorials/2d/img/draw_rect.png)
...
Godot offers method parameters in [draw_line](../../classes/class_canvasitem.md#class-canvasitem-method-draw-line)
...
on specific elements. See [2D antialiasing](2d_antialiasing.md#doc-2d-antialiasing) for more information.
...
![image](tutorials/2d/img/draw_antialiasing_options.webp)
...
To do this, you can use the [tool annotation](../scripting/gdscript/gdscript_basics.md#doc-gdscript-tool-mode)
on both GDScript and C#. See
[the example below](#doc-draw-show-drawing-while-editing-example) and
[Running code in the editor](../plugins/running_code_in_the_editor.md#doc-running-code-in-the-editor) for more information.

<a id="doc-draw-custom-example-1"></a>
...
[Display > Window > Stretch > Scale](../../classes/class_projectsettings.md#class-projectsettings-property-display-window-stretch-scale)
...
[Polygon2D](../../classes/class_polygon2d.md#class-polygon2d)), we will use in this case exclusively lower
...
[draw_polygon](../../classes/class_canvasitem.md#class-canvasitem-method-draw-polygon)
...
![image](tutorials/2d/img/draw_godot_logo_polygon.webp)
...
[example 2](#doc-draw-custom-example-2)).
...
[draw_polyline](../../classes/class_canvasitem.md#class-canvasitem-method-draw-polyline) to actually
...
![image](tutorials/2d/img/draw_godot_logo_polyline.webp)
...
code or a predefined color name. Check the class [Color](../../classes/class_color.md#class-color) for other
...
[draw_circle](../../classes/class_canvasitem.md#class-canvasitem-method-draw-circle) method. The first
parameter is a [Vector2](../../classes/class_vector2.md#class-vector2) with the coordinates of its center, the second is
...
![image](tutorials/2d/img/draw_godot_logo_circle.webp)

For partial, unfilled arcs (portions of a circle shape between certain
arbitrary angles), you can use the method
[draw_arc](../../classes/class_canvasitem.md#class-canvasitem-method-draw-arc).

### Drawing lines

To draw the final shape (the nose) we will use a line to approximate it.

[draw_line](../../classes/class_canvasitem.md#class-canvasitem-method-draw-line) can be used to draw
...
![image](tutorials/2d/img/draw_godot_logo_line.webp)
...
the [draw_multiline](../../classes/class_canvasitem.md#class-canvasitem-method-draw-multiline) method.

### Drawing text

While using the [Label](../../classes/class_label.md#class-label) Node is the most common way to add
...
We will use the [draw_string](../../classes/class_canvasitem.md#class-canvasitem-method-draw-string) method
to do it, like this:
...
![image](tutorials/2d/img/draw_godot_logo_text.webp)

Additional parameters as well as other methods related to text and characters
can be found on the [CanvasItem](../../classes/class_canvasitem.md#class-canvasitem) class reference.

<a id="doc-draw-show-drawing-while-editing-example"></a>
...
[@tool](../scripting/gdscript/gdscript_basics.md#doc-gdscript-tool-mode) annotation to request the custom drawing
...
[draw_set_transform](../../classes/class_canvasitem.md#class-canvasitem-method-draw-set-transform)
...
![image](tutorials/2d/img/draw_godot_rotation.webp)
...
changing the width of its mouth line follow a sinusoidal ([sin](../../classes/class_@globalscope.md#class-globalscope-method-sin)) curve:
...
![image](tutorials/2d/img/draw_godot_mouth_animation.webp)
...
standard and high-level methods such as a [Tween](../../classes/class_tween.md#class-tween) or an
[AnimationPlayer](../../classes/class_animationplayer.md#class-animationplayer) Node. The only difference is
that a `queue_redraw()` call is needed to apply those changes so they get
shown on screen.

<a id="doc-draw-custom-example-2"></a>
...
[sprites](../../classes/class_sprite2d.md#class-sprite2d) or
[AnimatedSprites](../../classes/class_animatedsprite2d.md#class-animatedsprite2d) loading SVG resources (which are
also images defined with vectors) and the
[AnimationPlayer](../../classes/class_animationplayer.md#class-animationplayer) node.
...
[get_mouse_position](../../classes/class_viewport.md#class-viewport-method-get-mouse-position). If the
...
![image](tutorials/2d/img/draw_line_between_2_points.webp)
...
![image](tutorials/2d/img/draw_dynamic_exported_properties.webp)

To draw the arc, we can use the method
[draw_arc](../../classes/class_canvasitem.md#class-canvasitem-method-draw-arc). There are many
...
![image](tutorials/2d/img/draw_arc_between_2_points.webp)
