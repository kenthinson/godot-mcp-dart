<a id="doc-particle-systems-2d"></a>
...
Godot provides two different nodes for 2D particles, [GPUParticles2D](../../classes/class_gpuparticles2d.md#class-gpuparticles2d)
and [CPUParticles2D](../../classes/class_cpuparticles2d.md#class-cpuparticles2d). GPUParticles2D is more advanced and uses the
...
While GPUParticles2D is configured via a [ParticleProcessMaterial](../../classes/class_particleprocessmaterial.md#class-particleprocessmaterial)
...
![image](tutorials/2d/img/particles_convert.webp)
...
![image](tutorials/2d/img/particles_material.webp)

Your GPUParticles2D node should now be emitting
white points downward.

![image](tutorials/2d/img/particles1.png)
...
![image](tutorials/2d/img/particles2.webp)

<a id="doc-particle-systems-2d-using-flipbook"></a>
...
flipbook images online, or pre-render them using external tools such as [Blender](https://www.blender.org/) or [EmberGen](https://jangafx.com/software/embergen/).

![Example of a particle system that uses a flipbook texture](tutorials/2d/img/particles_flipbook_result.webp)
...
![Particle flipbook texture example](tutorials/2d/img/particles_flipbook_example.webp)
...
![Creating a CanvasItemMaterial at the bottom of the particles node inspector](tutorials/2d/img/particles_flipbook_create_canvasitemmaterial.webp)
...
![Configuring the CanvasItemMaterial for the example flipbook texture](tutorials/2d/img/particles_flipbook_configure_canvasitemmaterial.webp)

Once this is done, the [Animation section](particle_process_material_2d.md#doc-particle-systems-2d-animation)
...
![image](tutorials/2d/img/paranim14.gif)

Lifetime: 4.0

![image](tutorials/2d/img/paranim15.gif)
...
![image](tutorials/2d/img/paranim18.gif)
...
![image](tutorials/2d/img/paranim21.gif)
...
![image](tutorials/2d/img/paranim20.gif)
...
For information on the settings in the ParticleProcessMaterial see [this page](particle_process_material_2d.md#doc-particle-process-material-2d).
