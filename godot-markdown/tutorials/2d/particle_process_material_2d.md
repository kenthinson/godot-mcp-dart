<a id="doc-particle-process-material-2d"></a>

# ParticleProcessMaterial 2D Usage

## Process material properties

![ParticleProcessMaterial properties](tutorials/2d/img/particle_minmaxcurve.webp)
...
For information on how to use it in a 3D scene see [Process material properties](../3d/particles/process_material_properties.md#doc-process-material-properties).
...
the same amount of time, set by the [Lifetime](../3d/particles/properties.md#doc-3d-particles-properties-time) property. A value of `1` means
...
![image](tutorials/2d/img/paranim11.gif)
...
![image](tutorials/2d/img/direction1.png)
...
![image](tutorials/2d/img/direction2.png)
...
![image](tutorials/2d/img/paranim3.gif)
...
![image](tutorials/2d/img/paranim4.gif)
...
![image](tutorials/2d/img/paranim5.gif)

### Orbit Velocity

Orbit velocity is used to make particles turn around their center.

![image](tutorials/2d/img/paranim6.gif)
...
![image](tutorials/2d/img/paranim7.gif)
...
![image](tutorials/2d/img/paranim8.gif)
...
![image](tutorials/2d/img/paranim9.gif)
...
![image](tutorials/2d/img/paranim10.gif)
...
![image](tutorials/2d/img/paranim12.gif)
...
<a id="doc-particle-systems-2d-animation"></a>
...
[configured accordingly](particle_systems_2d.md#doc-particle-systems-2d-using-flipbook).

To set up the particle flipbook for linear playback, set the **Speed Min** and **Speed Max** values to 1:

![Setting up particle animation for playback during the particle's lifetime](tutorials/2d/img/particles_flipbook_configure_animation_speed.webp)
...
![Setting up particle animation for random offset on emission](tutorials/2d/img/particles_flipbook_configure_animation_offset.webp)
...
![image](tutorials/2d/img/emission_shapes1.webp)

Open it and select "Load Emission Mask":

![image](tutorials/2d/img/emission_shapes2.webp)

Then select which texture you want to use as your mask:

![image](tutorials/2d/img/emission_shapes3.webp)
...
![image](tutorials/2d/img/emission_mask_solid.gif)
- Border Pixels: Particles will spawn from the outer edges of the texture.

![image](tutorials/2d/img/emission_mask_border.gif)
...
![image](tutorials/2d/img/emission_mask_directed_border.gif)
...
![image](tutorials/2d/img/emission_shapes4.webp)
