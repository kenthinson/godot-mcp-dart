...
#### NOTE
Godot Android plugin leverages the [Gradle build system](../../export/android_gradle_build.md#doc-android-gradle-build).
...
At its core, a Godot Android plugin v2 is an Android library with a dependency on the [Godot Android library](android_library.md#doc-android-library),
...
which is provided by the [Godot Android library](android_library.md#doc-android-library).
...
Godot EditorExportPlugin format, delivery and installation flow](https://docs.godotengine.org/en/stable/tutorials/plugins/editor/installing_plugins.html).
...
A github project template **is provided** at [https://github.com/m4gr3d/Godot-Android-Plugin-Template](https://github.com/m4gr3d/Godot-Android-Plugin-Template) as a **quickstart for building
...
A github project template is provided at [https://github.com/m4gr3d/GDExtension-Android-Plugin-Template](https://github.com/m4gr3d/GDExtension-Android-Plugin-Template) as a quickstart for building
...
For GDExtension, we follow the same steps as for [Packaging a v2 Android plugin]() and add the [GDExtension config file](https://docs.godotengine.org/en/stable/tutorials/scripting/cpp/gdextension_cpp_example.html#using-the-gdextension-module) in
...
Since they are also Android libraries, Godot v2 Android plugins can be stripped from their `EditorExportPlugin` packaging and provided as raw `AAR` binaries for use as libraries alongside the [Godot Android library](android_library.md#doc-android-library) by Android apps.
