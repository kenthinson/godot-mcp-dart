<a id="doc-android-in-app-purchases"></a>
...
Make sure you have enabled and successfully set up [Android Gradle Builds](../../export/android_gradle_build.md#doc-android-gradle-build).
Follow the installation instructions on the `GodotGooglePlayBilling` [github page](https://github.com/godotengine/godot-google-play-billing).
...
The signal has a single parameter: a [Dictionary](../../../classes/class_dictionary.md#class-dictionary) with
...
offers are [personallised](https://developer.android.com/google/play/billing/integrate#personalized-price)
...
of purchases in [Dictionary](../../../classes/class_dictionary.md#class-dictionary) format. The purchase Dictionary
...
[Handling pending transactions](https://developer.android.com/google/play/billing/integrate#pending)
