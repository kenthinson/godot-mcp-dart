<a id="doc-resolving-crashes-on-android"></a>
...
![image](tutorials/platform/android/img/play_console_latest_release_bundles.webp)
1. Now choose the relevant bundle and open it.

![image](tutorials/platform/android/img/play_console_latest_release_bundles2.webp)
1. Select the `Downloads` tab, and scroll down to the `Assets` section.

![image](tutorials/platform/android/img/play_console_app_bundle_explorer.webp)
1. Next to `Native debug symbols`, click the upload arrow icon.

![image](tutorials/platform/android/img/play_console_app_bundle_explorer2.webp)
1. Select and upload the corresponding native debug symbols file for that build version.

![image](tutorials/platform/android/img/play_console_upload_native_debug_symbols.webp)
...
![image](tutorials/platform/android/img/play_console_create_new_release.webp)
1. Click the three-dot menu beside it.
2. Choose `Upload native debug symbols (.zip)` from the menu.

![image](tutorials/platform/android/img/play_console_create_new_release2.webp)
1. Select and upload the corresponding native debug symbols file for that build version.
...
Otherwise, you can download the NDK directly from the [NDK downloads page](https://developer.android.com/ndk/downloads).
