<a id="doc-web-javascript-bridge"></a>

# The JavaScriptBridge singleton

In web builds, the [JavaScriptBridge](../../../classes/class_javascriptbridge.md#class-javascriptbridge) singleton
...
a Godot [JavaScriptObject](../../../classes/class_javascriptobject.md#class-javascriptobject) that tries to feel
natural in the context of Godot scripting (e.g. GDScript and C#).

The [JavaScriptBridge.get_interface()](../../../classes/class_javascriptbridge.md#class-javascriptbridge-method-get-interface)
...
The [JavaScriptBridge.create_object()](../../../classes/class_javascriptbridge.md#class-javascriptbridge-method-create-object)
...
#### WARNING
Callback methods created via [JavaScriptBridge.get_interface()](../../../classes/class_javascriptbridge.md#class-javascriptbridge-method-get-interface)
(`_my_callback` in the above example) **must** take exactly one [Array](../../../classes/class_array.md#class-array)
argument, which is going to be the JavaScript [arguments object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/arguments)
converted to an array. Otherwise, the callback method will not be called.

Here is another example that asks the user for the [Notification permission](https://developer.mozilla.org/en-US/docs/Web/API/Notifications_API)
...
[Head Include](../../export/exporting_for_web.md#doc-javascript-export-options) during export (see below),
or even [write your own template](customizing_html5_shell.md#doc-customizing-html5-shell).

In the example below, we customize the `Head Include` to add an external library
([axios](https://axios-http.com/)) from a content delivery network, and a
...
> * JavaScript `number` is returned as [float](../../../classes/class_float.md#class-float)
> * JavaScript `boolean` is returned as [bool](../../../classes/class_bool.md#class-bool)
> * JavaScript `string` is returned as [String](../../../classes/class_string.md#class-string)
> * JavaScript `ArrayBuffer`, `TypedArray`, and `DataView` are returned as [PackedByteArray](../../../classes/class_packedbytearray.md#class-packedbytearray)
...
HTML5 export templates may be [built](../../../engine_details/development/compiling/compiling_for_web.md#doc-compiling-for-web) without
...
`web` [feature tag](../../export/feature_tags.md#doc-feature-tags):
...
<a id="doc-web-downloading-files"></a>
...
a dedicated [JavaScriptBridge.download_buffer()](../../../classes/class_javascriptbridge.md#class-javascriptbridge-method-download-buffer)
