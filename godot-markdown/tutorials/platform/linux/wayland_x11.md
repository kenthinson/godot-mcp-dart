...
To change your display server to Wayland click on Project > project settings,
from here, go to Display Server and change the driver.linuxbsd
option to `wayland`.
