<a id="doc-navigation-overview-3d"></a>
...
- [Astar3D](../../classes/class_astar3d.md#class-astar3d)
...
- [NavigationServer3D](../../classes/class_navigationserver3d.md#class-navigationserver3d)
...
- [NavigationRegion3D](../../classes/class_navigationregion3d.md#class-navigationregion3d) Node
...
- [NavigationLink3D](../../classes/class_navigationlink3d.md#class-navigationlink3d) Node
...
- [NavigationAgent3D](../../classes/class_navigationagent3d.md#class-navigationagent3d) Node
...
- [NavigationObstacle3D](../../classes/class_navigationobstacle3d.md#class-navigationobstacle3d) Node
...
- [NavigationMesh](../../classes/class_navigationmesh.md#class-navigationmesh) Resource
...
[3D Navigation demo project](https://github.com/godotengine/godot-demo-projects/tree/master/3d/navigation).
...
2. Click on the region node and add a new [NavigationMesh](../../classes/class_navigationmesh.md#class-navigationmesh) Resource to
   the region node.
   ![image](tutorials/navigation/img/nav_3d_min_setup_step1.png)
...
5. Select the region node again and press the "Bake Navmesh" button on the top bar.
   ![image](tutorials/navigation/img/nav_3d_min_setup_step2.png)
6. Now a transparent navigation mesh appears that hovers some distance on top of the PlaneMesh.
   ![image](tutorials/navigation/img/nav_3d_min_setup_step3.png)
...
8. Add a NavigationAgent3D node below the character node.
   ![image](tutorials/navigation/img/nav_3d_min_setup_step4.webp)
