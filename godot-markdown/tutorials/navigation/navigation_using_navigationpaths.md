<a id="doc-navigation-using-navigationpaths"></a>
...
For more customizable navigation path queries that require additional setup see [Using NavigationPathQueryObjects](navigation_using_navigationpathqueryobjects.md#doc-navigation-using-navigationpathqueryobjects).
