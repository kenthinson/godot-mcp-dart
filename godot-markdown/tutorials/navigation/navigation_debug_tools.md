<a id="doc-navigation-debug-tools"></a>
...
![image](tutorials/navigation/img/navigation_debug_toggle.png)
...
Debug visualizations are currently based on Nodes in the SceneTree. If the [NavigationServer2D](../../classes/class_navigationserver2d.md#class-navigationserver2d) or [NavigationServer3D](../../classes/class_navigationserver3d.md#class-navigationserver3d)
...
![image](tutorials/navigation/img/nav_debug_settings.png)
...
![image](tutorials/navigation/img/nav_debug_xray_edge_lines.png)
...
![image](tutorials/navigation/img/nav_edge_connection2d.gif)![image](tutorials/navigation/img/nav_edge_connection3d.gif)
...
![image](tutorials/navigation/img/navigation_debug_performance1.webp)
...
![image](tutorials/navigation/img/navigation_debug_performance2.webp)
