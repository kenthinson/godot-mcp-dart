<a id="doc-navigation-using-navigationmeshes"></a>

# Using navigation meshes

![image](tutorials/navigation/img/nav_meshes.webp)

2D and 3D versions of the navigation mesh are available as
[NavigationPolygon](../../classes/class_navigationpolygon.md#class-navigationpolygon) and
[NavigationMesh](../../classes/class_navigationmesh.md#class-navigationmesh)  respectively.
...
![Navigation mesh polygon convex vs concave comparison](tutorials/navigation/img/nav_mesh_vs_physics.webp)
...
<a id="doc-navigation-navmesh-baking"></a>

Navigation mesh baking can be done either by using a [NavigationRegion2D](../../classes/class_navigationregion2d.md#class-navigationregion2d) or [NavigationRegion3D](../../classes/class_navigationregion3d.md#class-navigationregion3d), or by using the
[NavigationServer2D](../../classes/class_navigationserver2d.md#class-navigationserver2d) and [NavigationServer3D](../../classes/class_navigationserver3d.md#class-navigationserver3d) API directly.

<a id="doc-navigation-using-navigationmeshes-baking-navigation-mesh-with-navigationregion"></a>

## Baking a navigation mesh with a NavigationRegion

![Navigation mesh baking steps](tutorials/navigation/img/nav_mesh_baking_steps.gif)
...
The nodes are available in 2D and 3D as [NavigationRegion2D](../../classes/class_navigationregion2d.md#class-navigationregion2d) and [NavigationRegion3D](../../classes/class_navigationregion3d.md#class-navigationregion3d) respectively.
...
![image](tutorials/navigation/img/nav_region_baking_01.webp)

In order for the region to work a [NavigationPolygon](../../classes/class_navigationpolygon.md#class-navigationpolygon) resource needs to be added.
...
![image](tutorials/navigation/img/nav_region_baking_02.webp)

The result of the source geometry parsing can be influenced with the following properties.

- The `parsed_geometry_type` that filters if visual objects or physics objects or both should be parsed from the [SceneTree](../../classes/class_scenetree.md#class-scenetree).
...
- The `source_geometry_mode` that defines on which node(s) to start the parsing, and how to traverse the [SceneTree](../../classes/class_scenetree.md#class-scenetree).
...
- Add a [NavigationRegion2D](../../classes/class_navigationregion2d.md#class-navigationregion2d).
- Add a [NavigationPolygon](../../classes/class_navigationpolygon.md#class-navigationpolygon) resource to the NavigationRegion2D.
- Add a [Polygon2D](../../classes/class_polygon2d.md#class-polygon2d) below the NavigationRegion2D.
...
![image](tutorials/navigation/img/nav_region_baking_01.webp)![image](tutorials/navigation/img/nav_mesh_mini_2d.webp)
...
![image](tutorials/navigation/img/nav_mesh_bake_toolbar.webp)

In order for the region to work a [NavigationMesh](../../classes/class_navigationmesh.md#class-navigationmesh) resource needs to be added.

The properties to parse and bake a navigation mesh are then part of the used resource and can be found in the resource Inspector.

![image](tutorials/navigation/img/nav_region3d_baking_01.webp)
...
- Add a [NavigationRegion3D](../../classes/class_navigationregion3d.md#class-navigationregion3d).
- Add a [NavigationMesh](../../classes/class_navigationmesh.md#class-navigationmesh) resource to the NavigationRegion3D.
- Add a [MeshInstance3D](../../classes/class_meshinstance3d.md#class-meshinstance3d) below the NavigationRegion3D.
- Add a [PlaneMesh](../../classes/class_planemesh.md#class-planemesh) to the MeshInstance3D.
- Hit the Editor bake button and a navigation mesh should appear.

![image](tutorials/navigation/img/nav_mesh_bake_toolbar.webp)![image](tutorials/navigation/img/nav_mesh_mini_3d.webp)

<a id="doc-navigation-using-navigationmeshes-baking-navigation-mesh-with-navigationserver"></a>

## Baking a navigation mesh with the NavigationServer

The [NavigationServer2D](../../classes/class_navigationserver2d.md#class-navigationserver2d) and [NavigationServer3D](../../classes/class_navigationserver3d.md#class-navigationserver3d) have API functions to call each step of the navigation mesh baking process individually.
...
[NavigationMeshSourceGeometryData2D](../../classes/class_navigationmeshsourcegeometrydata2d.md#class-navigationmeshsourcegeometrydata2d) and
[NavigationMeshSourceGeometryData3D](../../classes/class_navigationmeshsourcegeometrydata3d.md#class-navigationmeshsourcegeometrydata3d)  respectively.
...
![Building navigation mesh chunks](tutorials/navigation/img/navmesh_chunk_build.gif)

#### SEE ALSO
You can see the navigation mesh chunk baking in action in the
[Navigation Mesh Chunks 2D](https://github.com/godotengine/godot-demo-projects/tree/master/2d/navigation_mesh_chunks)
and [Navigation Mesh Chunks 3D](https://github.com/godotengine/godot-demo-projects/tree/master/3d/navigation_mesh_chunks)
demo projects.
...
![Navigation mesh chunk with bake bound and border size](tutorials/navigation/img/navmesh_bound_bordersize.webp)

The baking bound, which is an axis-aligned [Rect2](../../classes/class_rect2.md#class-rect2) for 2D and [AABB](../../classes/class_aabb.md#class-aabb) for 3D,
limits the used source geometry by discarding all the geometry that is outside of the bounds.

The [NavigationPolygon](../../classes/class_navigationpolygon.md#class-navigationpolygon) properties `baking_rect` and `baking_rect_offset`
can be used to create and place the 2D baking bound.

The [NavigationMesh](../../classes/class_navigationmesh.md#class-navigationmesh) properties `filter_baking_aabb` and `filter_baking_aabb_offset`
...
![Navigation mesh chunks with gaps](tutorials/navigation/img/navmesh_chunk_gaps.webp)
...
![Navigation mesh chunks without gaps](tutorials/navigation/img/navmesh_chunks.webp)
...
- Navigation mesh appears inside geometry in 3D.
  : The navigation mesh baking in 3D has no concept of "inside". The voxel cells used to rasterize the geometry are either occupied or not.
    ...
    <br/>
    A [NavigationObstacle3D](../../classes/class_navigationobstacle3d.md#class-navigationobstacle3d) shape set to bake with navigation mesh can be used to discard geometry as well.

![NavigationObstacle3D unwanted geometry discard](tutorials/navigation/img/nav_mesh_obstacles_discard.webp)
