<a id="doc-navigation-using-navigationregions"></a>
...
Both 2D and 3D version are available as [NavigationRegion2D](../../classes/class_navigationregion2d.md#class-navigationregion2d)
and [NavigationRegion3D](../../classes/class_navigationregion3d.md#class-navigationregion3d) respectively.
...
All regions require a navigation mesh resource to function. See [Using navigation meshes](navigation_using_navigationmeshes.md#doc-navigation-using-navigationmeshes) to learn how to create and apply navigation meshes.
...
The NavigationServer will attempt to connect the navigation meshes of individual regions when they are close enough. For more details see [Connecting navigation meshes](navigation_connecting_navmesh.md#doc-navigation-connecting-navmesh).
To connect NavigationRegions over arbitrary distances see [Using NavigationLinks](navigation_using_navigationlinks.md#doc-navigation-using-navigationlinks) to learn how to create and use `NavigationLinks`.
