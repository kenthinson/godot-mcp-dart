<a id="doc-navigation-using-navigationobstacles"></a>

# Using NavigationObstacles

2D and 3D versions of NavigationObstacles nodes are available as
[NavigationObstacle2D](../../classes/class_navigationobstacle2d.md#class-navigationobstacle2d) and
[NavigationObstacle3D](../../classes/class_navigationobstacle3d.md#class-navigationobstacle3d)  respectively.
...
![Navigation obstacles affecting navigation mesh baking](tutorials/navigation/img/nav_mesh_obstacles.webp)
...
![Navigation obstacles discard of unwanted navigation mesh](tutorials/navigation/img/nav_mesh_obstacles_discard.webp)
...
For more details on the navigation mesh baking see [Using navigation meshes](navigation_using_navigationmeshes.md#doc-navigation-using-navigationmeshes).

![image](tutorials/navigation/img/nav_mesh_obstacles_properties.webp)
...
![Static obstacle drawn in the editor to block or contain navigation agents](tutorials/navigation/img/nav_static_obstacle_build.gif)
