<a id="doc-navigation-using-navigationagents"></a>
...
[NavigationAgent2D](../../classes/class_navigationagent2d.md#class-navigationagent2d) and
[NavigationAgent3D](../../classes/class_navigationagent3d.md#class-navigationagent3d) respectively.

New NavigationAgent nodes will automatically join the default navigation map on the [World2D](../../classes/class_world2d.md#class-world2d)/[World3D](../../classes/class_world3d.md#class-world3d).
...
![image](tutorials/navigation/img/agent_avoidance_enabled.png)
...
![image](tutorials/navigation/img/agent_safevelocity_signal.png)
...
NavigationObstacles can be used to add some environment constrains to the avoidance simulation, see [Using NavigationObstacles](navigation_using_navigationobstacles.md#doc-navigation-using-navigationobstacles).
