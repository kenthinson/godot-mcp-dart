<a id="doc-navigation-using-navigationlinks"></a>

# Using NavigationLinks

![image](tutorials/navigation/img/nav_navmesh_links.png)

NavigationLinks are used to connect navigation mesh polygons from [NavigationRegion2D](../../classes/class_navigationregion2d.md#class-navigationregion2d)
and [NavigationRegion3D](../../classes/class_navigationregion3d.md#class-navigationregion3d) over arbitrary distances for pathfinding.
...
[NavigationLink2D](../../classes/class_navigationlink2d.md#class-navigationlink2d) and
[NavigationLink3D](../../classes/class_navigationlink3d.md#class-navigationlink3d) respectively.
...
See [Using NavigationRegions](navigation_using_navigationregions.md#doc-navigation-using-navigationregions) to learn more about the use of navigation regions.
See [Connecting navigation meshes](navigation_connecting_navmesh.md#doc-navigation-connecting-navmesh) to learn more about how to connect navigation meshes.

![image](tutorials/navigation/img/nav_link_properties.png)
...
![image](tutorials/navigation/img/nav_link_debug_visuals.webp)

The link debug visuals can be changed in the Editor [ProjectSettings](../../classes/class_projectsettings.md#class-projectsettings) under `debug/shapes/navigation`.
