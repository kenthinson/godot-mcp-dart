<a id="doc-import-plugins"></a>

# Import plugins

#### NOTE
This tutorial assumes you already know how to make generic plugins. If
in doubt, refer to the [Making plugins](making_plugins.md#doc-making-plugins) page. This also
...
[add_import_plugin()](../../../classes/class_editorplugin.md#class-editorplugin-method-add-import-plugin) method. We store
a reference to it in a class member `import_plugin` so we can refer to it
later when removing it. The
[remove_import_plugin()](../../../classes/class_editorplugin.md#class-editorplugin-method-remove-import-plugin) method is
...
[EditorImportPlugin class](../../../classes/class_editorimportplugin.md#class-editorimportplugin). It is responsible for
...
[\_get_importer_name()](../../../classes/class_editorimportplugin.md#class-editorimportplugin-private-method-get-importer-name). This is a
...
The [\_get_visible_name()](../../../classes/class_editorimportplugin.md#class-editorimportplugin-private-method-get-visible-name) method is
...
[\_get_recognized_extensions()](../../../classes/class_editorimportplugin.md#class-editorimportplugin-private-method-get-recognized-extensions)
...
In our case it's a [StandardMaterial3D](../../../classes/class_standardmaterial3d.md#class-standardmaterial3d), which can be applied to 3D
objects.
...
![image](tutorials/plugins/editor/img/import_plugin_options.png)
...
The [\_get_preset_count()](../../../classes/class_editorimportplugin.md#class-editorimportplugin-private-method-get-preset-count) method
...
Here we have the
[\_get_preset_name()](../../../classes/class_editorimportplugin.md#class-editorimportplugin-private-method-get-preset-name) method, which
...
[\_get_import_options()](../../../classes/class_editorimportplugin.md#class-editorimportplugin-private-method-get-import-options) returns
...
| `property_hint` | Enum value | One of the [PropertyHint](../../../classes/class_@globalscope.md#enum-globalscope-propertyhint) values to use as hint.                  |
| `hint_string`   | String     | The hint text of the property. The same as you'd add in the `export` statement in GDScript.                                             |
| `usage`         | Enum value | One of the [PropertyUsageFlags](../../../classes/class_@globalscope.md#enum-globalscope-propertyusageflags) values to define the usage. |
...
For the
[\_get_option_visibility()](../../../classes/class_editorimportplugin.md#class-editorimportplugin-private-method-get-option-visibility)
...
resources, is covered by the [\_import()](../../../classes/class_editorimportplugin.md#class-editorimportplugin-private-method-import)
...
[FileAccess](../../../classes/class_fileaccess.md#class-fileaccess) class to do that, passing the `source_file`
...
Then it creates a new [Color](../../../classes/class_color.md#class-color) variable and sets its values
...
This part makes a new [StandardMaterial3D](../../../classes/class_standardmaterial3d.md#class-standardmaterial3d) that is the
...
extension, so we add it using [string formatting](../../scripting/gdscript/gdscript_format_string.md#doc-gdscript-printf). For
...
[ResourceSaver.save()](../../../classes/class_resourcesaver.md#class-resourcesaver-method-save) method, so if there's an
...
variants, it is based on the presence of [feature tags](../../export/feature_tags.md#doc-feature-tags),
...
![image](tutorials/plugins/editor/img/import_plugin_trying.png)
