<a id="doc-visual-shader-plugins"></a>

# Visual Shader plugins

Visual Shader plugins are used to create custom [VisualShader](../../../classes/class_visualshader.md#class-visualshader) nodes
in GDScript.
...
code from this [GPU noise shaders plugin](https://github.com/curly-brace/Godot-3.0-Noise-Shaders/blob/master/assets/gpu_noise_shaders/classic_perlin3d.tres).

Create a Sprite2D and assign a [ShaderMaterial](../../../classes/class_shadermaterial.md#class-shadermaterial) to its material slot:

![image](tutorials/plugins/editor/img/visual_shader_plugins_start.png)

Assign [VisualShader](../../../classes/class_visualshader.md#class-visualshader) to the shader slot of the material:

![image](tutorials/plugins/editor/img/visual_shader_plugins_start2.png)

Don't forget to change its mode to "CanvasItem" (if you are using a Sprite2D):

![image](tutorials/plugins/editor/img/visual_shader_plugins_start3.png)

Create a script which derives from [VisualShaderNodeCustom](../../../classes/class_visualshadernodecustom.md#class-visualshadernodecustom). This is
...
![image](tutorials/plugins/editor/img/visual_shader_plugins_result1.png)

Place it on a graph and connect the required ports:

![image](tutorials/plugins/editor/img/visual_shader_plugins_result2.png)
