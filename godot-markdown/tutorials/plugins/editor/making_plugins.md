...
![image](tutorials/plugins/editor/img/making_plugins-create_plugin_dialog.webp)
...
![image](tutorials/plugins/editor/img/making_plugins-my_custom_mode_folder.webp)
...
editor, and it must inherit from [EditorPlugin](../../../classes/class_editorplugin.md#class-editorplugin).
...
[\_enter_tree()](../../../classes/class_node.md#class-node-private-method-enter-tree) to initialize your plugin and
[\_exit_tree()](../../../classes/class_node.md#class-node-private-method-exit-tree) to clean it up. Thankfully,
the dialog generates these callbacks for you. Your script should look something
like this:

<a id="doc-making-plugins-template-code"></a>
...
[Button](../../../classes/class_button.md#class-button). It could also extend
[BaseButton](../../../classes/class_basebutton.md#class-basebutton) if you prefer:
...
![image](tutorials/plugins/editor/img/making_plugins-custom_node_icon.png)
...
![image](tutorials/plugins/editor/img/making_plugins-custom_node_create.webp)
...
![image](tutorials/plugins/editor/img/making_plugins-custom_node_console.webp)
...
[template we've seen before](#doc-making-plugins-template-code) to get a
good start.
...
For an editor dock, the root node **must** be a [Control](../../../classes/class_control.md#class-control)
or one of its child classes. For this tutorial, you can create a single button.
Don't forget to add some text to your button.

![image](tutorials/plugins/editor/img/making_plugins-my_custom_dock_scene.webp)
...
[add_dock()](../../../classes/class_editorplugin.md#class-editorplugin-method-add-dock) from the
[EditorPlugin](../../../classes/class_editorplugin.md#class-editorplugin) class.
...
![image](tutorials/plugins/editor/img/making_plugins-project_settings.webp)
...
![image](tutorials/plugins/editor/img/making_plugins-custom_dock.webp)

<a id="doc-making-plugins-autoload"></a>

## Registering autoloads/singletons in plugins

It is possible for editor plugins to automatically register
[autoloads](../../scripting/singletons_autoload.md#doc-singletons-autoload) when the plugin is enabled.
...
![image](tutorials/plugins/editor/img/sub_plugin_creation.webp)

Then move the sub plugins into the main plugin folder:

![image](tutorials/plugins/editor/img/sub_plugin_moved.webp)
