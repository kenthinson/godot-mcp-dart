...
This guide explains how to use the [EditorInspectorPlugin](../../../classes/class_editorinspectorplugin.md#class-editorinspectorplugin) and
[EditorProperty](../../../classes/class_editorproperty.md#class-editorproperty) classes to create a custom interface for integers,
replacing the default behavior with a button that generates random values
between 0 and 99.

![image](tutorials/plugins/editor/img/inspector_plugin_example.png)
...
#### SEE ALSO
See [Making plugins](making_plugins.md#doc-making-plugins) guide to set up your new plugin.
...
As before, `plugin.gd` is a script extending [EditorPlugin](../../../classes/class_editorplugin.md#class-editorplugin) and you
...
extend the [EditorInspectorPlugin](../../../classes/class_editorinspectorplugin.md#class-editorinspectorplugin) class. This class provides several
...
method. This function is called for each edited [Object](../../../classes/class_object.md#class-object) and must
return `true` if this plugin should handle the object or its properties.

#### NOTE
This includes any [Resource](../../../classes/class_resource.md#class-resource) attached to the object.
...
specifically add [EditorProperty](../../../classes/class_editorproperty.md#class-editorproperty)-based controls.
...
The [EditorProperty](../../../classes/class_editorproperty.md#class-editorproperty) class is a special type of [Control](../../../classes/class_control.md#class-control)
...
[EditorProperty](../../../classes/class_editorproperty.md#class-editorproperty):
...
replaces the default [SpinBox](../../../classes/class_spinbox.md#class-spinbox) control for integers with a
[Button](../../../classes/class_button.md#class-button) that generates random values.
