<a id="doc-running-code-in-the-editor"></a>
...
<a id="doc-running-code-in-the-editor-important-information"></a>
...
this are [static variables](../scripting/gdscript/gdscript_basics.md#doc-gdscript-basics-static-variables).
...
[version control](../best_practices/version_control_systems.md#doc-version-control-systems) to avoid losing work in
...
See [Overview of debugging tools](../scripting/debug/overview_of_debugging_tools.md#doc-overview-of-debugging-tools) for more information.
...
![image](tutorials/plugins/img/rotating_in_editor.gif)
...
[update_configuration_warnings](../../classes/class_node.md#class-node-method-update-configuration-warnings) .
...
<a id="doc-running-code-in-the-editor-editorscript"></a>
...
This is available in Godot by extending [EditorScript](../../classes/class_editorscript.md#class-editorscript) in a script.
...
![Creating an editor script in the script editor creation dialog](tutorials/plugins/img/running_code_in_the_editor_creating_editor_script.webp)
...
- Use File > Run at the top of the script editor with the EditorScript
  being the current tab.
- Press the keyboard shortcut `Ctrl + Shift + X` while the EditorScript is
...
- Add a `class_name <name>` at the top of the script, bring up the command
  palette by pressing `Ctrl + Shift + P`, and enter the class name to run
...
[EditorInterface.get_edited_scene_root()](../../classes/class_editorinterface.md#class-editorinterface-method-get-edited-scene-root)
...
[EditorScript.mark_scene_as_unsaved()](../../classes/class_editorinterface.md#class-editorinterface-method-mark-scene-as-unsaved)
...
[Node.add_child(node)](../../classes/class_node.md#class-node-method-add-child) are **not** visible
...
the scene, you need to set the child node's [owner](../../classes/class_node.md#class-node-property-owner)
...
If you are using [EditorScript](../../classes/class_editorscript.md#class-editorscript):
