<a id="doc-c-sharp-variant"></a>

# C# Variant

For a detailed explanation of Variant in general, see the [Variant](../../../classes/class_variant.md#class-variant) documentation page.

`Godot.Variant` is used to represent Godot's native [Variant](../../../classes/class_variant.md#class-variant) type. Any
[Variant-compatible type](#c-sharp-variant-compatible-types) can be converted from/to it.
...
For example, the third argument of [tween_property](../../../classes/class_tween.md#class-tween-method-tween-property)
...
<a id="c-sharp-variant-compatible-types"></a>
...
* `string`.
* Classes derived from [GodotObject](../../../classes/class_object.md#class-object).
