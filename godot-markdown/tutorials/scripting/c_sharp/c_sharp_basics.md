...
[how to use specific features](c_sharp_features.md#doc-c-sharp-features), read about the
[differences between the C# and the GDScript API](c_sharp_differences.md#doc-c-sharp-differences),
and (re)visit the [Scripting section](../../../getting_started/step_by_step/scripting_languages.md#doc-scripting) of the
...
experimental and [some limitations apply](index.md#doc-c-sharp-platforms).
...
[Microsoft C# guide](https://docs.microsoft.com/en-us/dotnet/csharp/index)
or look for a suitable introduction elsewhere.

<a id="doc-c-sharp-setup"></a>
...
.NET support in your build as outlined in the [Compiling with .NET](../../../engine_details/development/compiling/compiling_with_dotnet.md#doc-compiling-with-dotnet)
page.

<a id="doc-c-sharp-setup-external-editor"></a>

## Configuring an external editor

C# support in Godot's built-in script editor is minimal. Consider using an
external IDE or editor, such as  [Visual Studio Code](https://code.visualstudio.com/)
or [Visual Studio](https://visualstudio.microsoft.com/). These provide autocompletion, debugging, and other
...
After reading the "Prerequisites" section, you can download and install
[Visual Studio Code](https://code.visualstudio.com/download) (aka VS Code).
...
![image](tutorials/scripting/c_sharp/img/attachcsharpscript.webp)
...
the tutorials on [Scripting languages](../../../getting_started/step_by_step/scripting_languages.md#doc-scripting) at this point.
...
[@GDScript](../../../classes/class_@gdscript.md#class-gdscript) and [@GlobalScope](../../../classes/class_@globalscope.md#class-globalscope).
...
<a id="doc-c-sharp-general-differences"></a>
...
For more information, see the [C# API differences to GDScript](c_sharp_differences.md#doc-c-sharp-differences) page.
...
![image](tutorials/scripting/c_sharp/img/build_dotnet.webp)
...
see [Which programming language is fastest?](../../../about/faq.md#doc-faq-which-programming-language-is-fastest).
