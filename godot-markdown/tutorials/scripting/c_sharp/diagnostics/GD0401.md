...
| **Rule ID**                         | GD0401                                                                                                         |
| **Category**                        | Usage                                                                                                          |
| **Fix is breaking or non-breaking** | Breaking - If changing the inheritance chain<br/><br/>Non-breaking - If removing the `[GlobalClass]` attribute |
...
Every [global class](../c_sharp_global_classes.md#doc-c-sharp-global-classes) must ultimately derive from
