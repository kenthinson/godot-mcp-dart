...
| **Rule ID**                         | GD0110                                                                                                                                     |
| **Category**                        | Usage                                                                                                                                      |
| **Fix is breaking or non-breaking** | Breaking - If the property's type is changed to `Callable`<br/><br/>Non-breaking - If the `[ExportToolButton]` is replaced with `[Export]` |
