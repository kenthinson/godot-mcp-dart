...
| **Rule ID**                         | GD0202                                                                                                     |
| **Category**                        | Usage                                                                                                      |
| **Fix is breaking or non-breaking** | Breaking - If the parameter type is changed<br/><br/>Non-breaking - If the `[Signal]` attribute is removed |
...
[Variant-compatible type](../c_sharp_variant.md#c-sharp-variant-compatible-types) is expected.
...
Take a look at the [C# signals](../c_sharp_signals.md#doc-c-sharp-signals) documentation for more
