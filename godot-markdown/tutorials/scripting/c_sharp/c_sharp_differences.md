<a id="doc-c-sharp-differences"></a>
...
As explained in [General differences between C# and GDScript](c_sharp_basics.md#doc-c-sharp-general-differences), `PascalCase` is used
...
reasonably possible. See the [C# style guide](c_sharp_style_guide.md#doc-c-sharp-styleguide), which we encourage
...
are considered essential. See [Configuring an external editor](c_sharp_basics.md#doc-c-sharp-setup-external-editor).
...
This attribute can also be provided with optional [PropertyHint](../../../classes/class_@globalscope.md#enum-globalscope-propertyhint) and `hintString` parameters.
...
See also: [C# exported properties](c_sharp_exports.md#doc-c-sharp-exports).
...
See also: [C# signals](c_sharp_signals.md#doc-c-sharp-signals).

## @onready annotation

GDScript has the ability to defer the initialization of a member variable until the ready function
is called with @onready (cf. [@onready annotation](../gdscript/gdscript_basics.md#doc-gdscript-onready-annotation)).
For example:
...
See [File paths in Godot projects](../../io/data_paths.md#doc-data-paths).
...
the `await` keyword. See [await keyword](#doc-c-sharp-differences-await).

Instead of using the `Signal` type, the recommended way to use Godot signals in C# is
to use the generated C# events. See [C# signals](c_sharp_signals.md#doc-c-sharp-signals).
...
See also [PackedArray in C#](c_sharp_collections.md#doc-c-sharp-collections-packedarray).
...
See also [Array in C#](c_sharp_collections.md#doc-c-sharp-collections-array).
...
See also [Dictionary in C#](c_sharp_collections.md#doc-c-sharp-collections-dictionary).

## Variant

`Godot.Variant` is used to represent Godot's native [Variant](../../../classes/class_variant.md#class-variant) type.
Any [Variant-compatible type](c_sharp_variant.md#c-sharp-variant-compatible-types) can be converted from/to it.

See also: [C# Variant](c_sharp_variant.md#doc-c-sharp-variant).

## Communicating with other scripting languages

This is explained extensively in [Cross-language scripting](../cross_language_scripting.md#doc-cross-language-scripting).

<a id="doc-c-sharp-differences-await"></a>

## `await` keyword

Something similar to GDScript's `await` keyword can be achieved with C#'s
[await keyword](https://docs.microsoft.com/en-US/dotnet/csharp/language-reference/keywords/await).

The `await` keyword in C# can be used with any awaitable expression. It's commonly
used with operands of the types [Task](https://learn.microsoft.com/en-us/dotnet/api/system.threading.tasks.task), [Task<TResult>](https://learn.microsoft.com/en-us/dotnet/api/system.threading.tasks.task-1), [ValueTask](https://learn.microsoft.com/en-us/dotnet/api/system.threading.tasks.valuetask), or [ValueTask<TResult>](https://learn.microsoft.com/en-us/dotnet/api/system.threading.tasks.valuetask-1).
