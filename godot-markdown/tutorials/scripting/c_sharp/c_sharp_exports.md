...
Exporting can only be done with [Variant-compatible types](c_sharp_variant.md#c-sharp-variant-compatible-types).

#### NOTE
Exporting properties can also be done in GDScript, for information on that
see [GDScript exported properties](../gdscript/gdscript_exports.md#doc-gdscript-exports).
...
[\_PropertyCanRevert()](../../../classes/class_object.md#class-object-private-method-property-can-revert) and
[\_PropertyGetRevert()](../../../classes/class_object.md#class-object-private-method-property-get-revert) methods.
...
`GD.Load` and `GetNode`. See [Nodes and Resources](#doc-c-sharp-exports-nodes).
...
Display a visual representation of the [ease](../../../classes/class_@globalscope.md#class-globalscope-method-ease)
...
<a id="doc-c-sharp-exports-nodes"></a>
...
[global class](c_sharp_global_classes.md#doc-c-sharp-global-classes).
...
see [C# global classes](c_sharp_global_classes.md#doc-c-sharp-global-classes).

It must be noted that even if the script is not being run while in the
editor, the exported properties are still editable. This can be used
in conjunction with a [script in "tool" mode](../gdscript/gdscript_basics.md#doc-gdscript-tool-mode).
...
a clickable button. Since this runs in the editor, usage of the [[Tool]](../../plugins/running_code_in_the_editor.md#doc-running-code-in-the-editor) attribute is required. When the button is
...
icon will be fetched via [GetThemeIcon()](../../../classes/class_control.md#class-control-method-get-theme-icon),
...
As explained in the [C# Variant](c_sharp_variant.md#doc-c-sharp-variant) documentation, only
...
C# arrays can exported as long as the element type is a [Variant-compatible type](c_sharp_variant.md#c-sharp-variant-compatible-types).
...
[Tool mode](../gdscript/gdscript_basics.md#doc-gdscript-tool-mode), the value in the inspector won't be updated
automatically. To update it, call
[NotifyPropertyListChanged()](../../../classes/class_object.md#class-object-method-notify-property-list-changed)
...
[\_GetPropertyList()](../../../classes/class_object.md#class-object-private-method-get-property-list) methods as
