<a id="doc-c-sharp-signals"></a>

# C# signals

For a detailed explanation of signals in general, see the [Using signals](../../../getting_started/step_by_step/signals.md#doc-signals) section in the step
by step tutorial.

Signals are implemented using C# events, the idiomatic way to represent
[the observer pattern](../../../getting_started/introduction/key_concepts_overview.md#doc-key-concepts-signals) in C#. This is the
recommended way to use signals in C# and the focus of this page.

In some cases it's necessary to use the older
[Connect()](../../../classes/class_object.md#class-object-method-connect) and
[Disconnect()](../../../classes/class_object.md#class-object-method-disconnect) APIs.
See [Using Connect and Disconnect](#using-connect-and-disconnect) for more details.

If you encounter a `System.ObjectDisposedException` while handling a signal,
you might be missing a signal disconnection. See
[Disconnecting automatically when the receiver is freed](#disconnecting-automatically-when-the-receiver-is-freed) for more details.
...
`SignalName` class. This is useful when, for example, you want to await on a signal (see [await keyword](c_sharp_differences.md#doc-c-sharp-differences-await)).
...
Signals support arguments of any [Variant-compatible type](c_sharp_variant.md#c-sharp-variant-compatible-types).
...
Here, the [Button.Pressed](../../../classes/class_basebutton.md#class-basebutton-signal-pressed) signal does not take any argument. But we
...
<a id="using-connect-and-disconnect"></a>

## Using Connect and Disconnect

In general, it isn't recommended to use
[Connect()](../../../classes/class_object.md#class-object-method-connect) and
[Disconnect()](../../../classes/class_object.md#class-object-method-disconnect). These APIs don't provide as
much type safety as the events. However, they're necessary for
[connecting to signals defined by GDScript](../cross_language_scripting.md#connecting-to-signals-cross-language)
and passing [ConnectFlags](../../../classes/class_object.md#enum-object-connectflags).
...
<a id="disconnecting-automatically-when-the-receiver-is-freed"></a>
