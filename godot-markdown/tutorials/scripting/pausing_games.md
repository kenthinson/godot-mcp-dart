...
`true` to the [SceneTree.paused](../../classes/class_scenetree.md#class-scenetree-property-paused) property:
...
be found and changed under a node's [Node](../../classes/class_node.md#class-node) properties in the inspector.

![image](tutorials/scripting/img/pausemode.webp)
