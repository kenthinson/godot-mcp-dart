<a id="doc-creating-script-templates"></a>
...
![image](tutorials/scripting/img/script_create_dialog_templates.webp)
...
[Editor > Script > Templates Search Path](../../classes/class_projectsettings.md#class-projectsettings-property-editor-script-templates-search-path),
...
* `node_type` is the node it will apply to (for example, [Node](../../classes/class_node.md#class-node), or [CharacterBody3D](../../classes/class_characterbody3d.md#class-characterbody3d)),
...
![image](tutorials/scripting/img/script_create_dialog_custom_templates.webp)
...
`basic_movement` for both [CharacterBody2D](../../classes/class_characterbody2d.md#class-characterbody2d) and
[CharacterBody3D](../../classes/class_characterbody3d.md#class-characterbody3d) and `plugin` for
[EditorPlugin](../../classes/class_editorplugin.md#class-editorplugin).
...
| `_CLASS_SNAKE_CASE_`   | The name of the new class as `snake_case`<br/>(used in GDScript only).                                                                                                                                                                                                                                                                                                                |
| `_BASE_`               | The base type a new script inherits from.                                                                                                                                                                                                                                                                                                                                             |
| `_TS_`                 | Indentation placeholder. The exact type and number<br/>of whitespace characters used for indentation is<br/>determined by the `text_editor/indent/type` and<br/>`text_editor/indent/size` settings in the<br/>[EditorSettings](../../classes/class_editorsettings.md#class-editorsettings)<br/>respectively. Can be overridden by the<br/>`meta-space-indent` header on the template. |
...
[EditorSettings](../../classes/class_editorsettings.md#class-editorsettings) is disabled, type hints
