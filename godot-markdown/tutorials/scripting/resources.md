...
Up to this tutorial, we focused on the [Node](../../classes/class_node.md#class-node)
...
[Resource](../../classes/class_resource.md#class-resource).
...
or a `.scn` file), an image, a script... Here are some [Resource](../../classes/class_resource.md#class-resource) examples:

- [Texture](../../classes/class_texture.md#class-texture)
- [Script](../../classes/class_script.md#class-script)
- [Mesh](../../classes/class_mesh.md#class-mesh)
- [Animation](../../classes/class_animation.md#class-animation)
- [AudioStream](../../classes/class_audiostream.md#class-audiostream)
- [Font](../../classes/class_font.md#class-font)
- [Translation](../../classes/class_translation.md#class-translation)
...
![image](tutorials/scripting/img/nodes_resources.webp)
...
To be more specific, here's a [Texture2D](../../classes/class_texture2d.md#class-texture2d)
in a [Sprite2D](../../classes/class_sprite2d.md#class-sprite2d) node:

![image](tutorials/scripting/img/spriteprop.webp)

Clicking the resource preview allows us to view the resource's properties.

![image](tutorials/scripting/img/resourcerobi.webp)
...
resources of type [PackedScene](../../classes/class_packedscene.md#class-packedscene). The
scene is packed inside a [Resource](../../classes/class_resource.md#class-resource).

To get an instance of the scene, you have to use the
[PackedScene.instantiate()](../../classes/class_packedscene.md#class-packedscene-method-instantiate) method.
...
The approach has several advantages. As the [PackedScene.instantiate()](../../classes/class_packedscene.md#class-packedscene-method-instantiate) function is fast, you can create new
...
When a [Resource](../../classes/class_resource.md#class-resource) is no longer in use, it will automatically free itself.
...
assets as a [Dictionary](../../classes/class_dictionary.md#class-dictionary) (JSON) or as a
[FileAccess](../../classes/class_fileaccess.md#class-fileaccess) to parse. What sets Resources apart is their
inheritance of [Object](../../classes/class_object.md#class-object), [RefCounted](../../classes/class_refcounted.md#class-refcounted),
and [Resource](../../classes/class_resource.md#class-resource) features:
...
If the script's language supports [script classes](gdscript/gdscript_basics.md#doc-gdscript-basics-class-name),
...
Create a [Resource](../../classes/class_resource.md#class-resource) and name it `bot_stats`.
...
Now, create a [CharacterBody3D](../../classes/class_characterbody3d.md#class-characterbody3d), name it `Bot`, and add the following script to it:
...
Now, select the [CharacterBody3D](../../classes/class_characterbody3d.md#class-characterbody3d) node which we named `bot`, and drag&drop the `bot_stats.tres` resource onto the Inspector. It should print 10! Obviously, this setup can be used for more advanced features than this, but as long you really understand *how* it all worked, you should figure out everything else related to Resources.
...
with an [EditorPlugin](../../classes/class_editorplugin.md#class-editorplugin) to create custom
...
or a [Curve](../../classes/class_curve.md#class-curve)/[Curve2D](../../classes/class_curve2d.md#class-curve2d) resource object.
