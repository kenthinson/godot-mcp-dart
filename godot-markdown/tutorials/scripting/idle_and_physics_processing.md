<a id="doc-idle-and-physics-processing"></a>
...
class to do so: [Node._process()](../../classes/class_node.md#class-node-private-method-process) and
[Node._physics_process()](../../classes/class_node.md#class-node-private-method-physics-process). If you
...
script. You can turn it off and back on by calling [Node.set_process()](../../classes/class_node.md#class-node-method-set-process).
