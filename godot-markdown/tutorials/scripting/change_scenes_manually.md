<a id="doc-change-scenes-manually"></a>

# Change scenes manually

Sometimes it helps to have more control over how you swap scenes around.
A [Viewport](../../classes/class_viewport.md#class-viewport)'s child nodes will render to the image
...
from view of the [Viewport](../../classes/class_viewport.md#class-viewport). The tradeoffs involve
balancing operation speed and memory consumption, as well as balancing data
access and integrity.

1. **Delete the existing scene.**
   [SceneTree.change_scene_to_file()](../../classes/class_scenetree.md#class-scenetree-method-change-scene-to-file) and
   [SceneTree.change_scene_to_packed()](../../classes/class_scenetree.md#class-scenetree-method-change-scene-to-packed)
   ...
   >   >   or even directly to the [SceneTree](../../classes/class_scenetree.md#class-scenetree).
   > - Processing stops.
...
2. **Hide the existing scene.** By changing the visibility or collision
   ...
   [CanvasItem.hide()](../../classes/class_canvasitem.md#class-canvasitem-method-hide) to hide a scene and
   [CanvasItem.show()](../../classes/class_canvasitem.md#class-canvasitem-method-show) to show it again.
   > - Memory still exists.
...
3. **Remove the existing scene from the tree.** Assign a variable
   ...
   [Node.remove_child(Node)](../../classes/class_node.md#class-node-method-remove-child) to detach the entire
   scene from the tree. To attach it later, use
   [Node.add_child(Node)](../../classes/class_node.md#class-node-method-add-child).
   ...
   >   or other data that is derived from [SceneTree](../../classes/class_scenetree.md#class-scenetree)
   >   access.
...
[SubViewportContainers](../../classes/class_subviewportcontainer.md#class-subviewportcontainer). This is optimal for
