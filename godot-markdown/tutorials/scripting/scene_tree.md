...
[OS](../../classes/class_os.md#class-os) class,
...
When initialization is complete, [OS](../../classes/class_os.md#class-os) needs to be
supplied a [MainLoop](../../classes/class_mainloop.md#class-mainloop)
...
The scene system is the game engine, while the [OS](../../classes/class_os.md#class-os)
and servers are the low-level API.

The scene system provides its own main loop to OS,
[SceneTree](../../classes/class_scenetree.md#class-scenetree).
...
- It contains the root [Viewport](../../classes/class_viewport.md#class-viewport), to which a
...
[Node.get_tree()](../../classes/class_node.md#class-node-method-get-tree).

## Root viewport

The root [Viewport](../../classes/class_viewport.md#class-viewport)
...
[Viewport](../../classes/class_viewport.md#class-viewport)
...
![image](tutorials/scripting/img/activescene.webp)
...
![image](tutorials/scripting/img/toptobottom.webp)
...
[SceneTree.change_scene_to_file()](../../classes/class_scenetree.md#class-scenetree-method-change-scene-to-file)
function:
...
[PackedScene](../../classes/class_packedscene.md#class-packedscene) resources using the equivalent
function
[SceneTree.change_scene_to_packed(PackedScene scene)](../../classes/class_scenetree.md#class-scenetree-method-change-scene-to-packed):
...
loading. This must be done manually using [Singletons (Autoload)](singletons_autoload.md#doc-singletons-autoload)
and [Background loading](../io/background_loading.md#doc-background-loading).
