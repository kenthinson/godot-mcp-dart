...
- During execution, by calling [Node.add_to_group()](../../classes/class_node.md#class-node-method-add-to-group)
  or [Node.remove_from_group()](../../classes/class_node.md#class-node-method-remove-from-group).

### Using the Node dock

You can create new groups using the Groups tab in the Node dock.

![image](tutorials/scripting/img/groups_node_tab.webp)

Select a node in the Scene dock then click the add button with the + symbol.

![image](tutorials/scripting/img/groups_add_new_group_button.webp)
...
![image](tutorials/scripting/img/groups_add_new_group_modal.webp)
...
![image](tutorials/scripting/img/groups_node_tab_with_created_groups.webp)
...
![image](tutorials/scripting/img/groups_node_tab_with_multiple_types_of_groups.webp)
...
![image](tutorials/scripting/img/groups_global_groups_settings.webp)
...
[SceneTree.get_nodes_in_group()](../../classes/class_scenetree.md#class-scenetree-method-get-nodes-in-group):
...
The [SceneTree](../../classes/class_scenetree.md#class-scenetree) class provides many more useful methods
