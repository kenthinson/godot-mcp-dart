<a id="doc-evaluating-expressions"></a>

# Evaluating expressions

Godot provides an [Expression](../../classes/class_expression.md#class-expression) class you can use to evaluate expressions.
...
- A method call on a user-provided script like `update_health()`,
  ...
  [Expression.execute()](../../classes/class_expression.md#class-expression-method-execute).
...
| Operator             | Notes                                                                                                                                                |
|----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|
| Addition `+`         | Can also be used to concatenate strings and arrays:<br/>- `"hello" + " world"` = `hello world`<br/>- `[1, 2] + [3, 4]` = `[1, 2, 3, 4]`              |
| Subtraction (`-`)    |                                                                                                                                                      |
| Multiplication (`*`) |                                                                                                                                                      |
| Division (`/`)       | Performs and integer division if both operands are integers.<br/>If at least one of them is a floating-point number, returns a floating-point value. |
| Remainder (`%`)      | Returns the remainder of an integer division (modulo).<br/>The result will always have the sign of the dividend.                                     |
...
When calling [Expression.execute()](../../classes/class_expression.md#class-expression-method-execute),
...
All methods in the [Global Scope](../../classes/class_@globalscope.md#class-globalscope) are available in the
