<a id="doc-singletons-autoload"></a>
...
[Node](../../classes/class_node.md#class-node).

#### NOTE
When autoloading a script, a [Node](../../classes/class_node.md#class-node) will be created and the script will be
attached to it. This node will be added to the root viewport before any
other scenes are loaded.

![image](tutorials/scripting/img/singleton.webp)

To autoload a scene or script, start from the menu and navigate to
**Project > Project Settings > Globals > Autoload**.

![image](tutorials/scripting/img/autoload_tab.webp)
...
![image](tutorials/scripting/img/autoload_example.webp)
...
![image](tutorials/scripting/img/autoload_runtime.webp)
...
method (see [Using SceneTree](scene_tree.md#doc-scene-tree) for details). However, if you need more
...
![image](tutorials/scripting/img/autoload_script.webp)
...
![image](tutorials/scripting/img/autoload_tutorial1.webp)
...
Using [Object.call_deferred()](../../classes/class_object.md#class-object-method-call-deferred),
...
To learn how to handle this, see the next tutorial: [Background loading](../io/background_loading.md#doc-background-loading).
