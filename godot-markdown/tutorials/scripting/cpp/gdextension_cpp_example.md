<a id="doc-godot-cpp-getting-started"></a>

# Getting started

## Workflow overview

As a GDExtension, godot-cpp is more complicated to use than [GDScript](../gdscript/index.md#doc-gdscript) and [C#](../c_sharp/index.md#doc-c-sharp).
...
* Develop your code with your [favorite IDE](../../../engine_details/development/configuring_an_ide/index.md#toc-devel-configuring-an-ide) locally.
...
godot-cpp. After you're done, you can use the [godot-cpp template](https://github.com/godotengine/godot-cpp-template),
...
See also [Configuring an IDE](../../../engine_details/development/configuring_an_ide/index.md#toc-devel-configuring-an-ide)
and [Compiling](../../../engine_details/development/compiling/index.md#toc-devel-compiling) as the build tools are identical
to the ones you need to compile Godot from source.

You can download the [godot-cpp repository](https://github.com/godotengine/godot-cpp) from GitHub or let Git do the work for you.
...
#### NOTE
To use [GDExtension](https://godotengine.org/article/introducing-gd-extensions)
...
Godot 4.1 and later (see [Updating your GDExtension for 4.1](../../migrating/upgrading_to_godot_4.1.md#updating-your-gdextension-for-godot-4-1)).
...
#### NOTE
You can find information about `GDREGISTER_CLASS` (and alternatives) at [Object class](../../../engine_details/architecture/object_class.md#doc-object-class).
...
[`the SConstruct file we prepared`](files/cpp_example/SConstruct).
...
You can learn more about `.gdextension` files at [The .gdextension file](../gdextension/gdextension_file.md#doc-gdextension-file).
...
![image](tutorials/scripting/cpp/img/gdextension_cpp_nodes.webp)

We're going to assign the Godot logo to this node as our texture, disable the
`centered` property:

![image](tutorials/scripting/cpp/img/gdextension_cpp_sprite.webp)
...
To learn more about `Callable`, check out the class reference here: [Callable](../../../classes/class_callable.md#class-callable).
...
[godot-cpp template](https://github.com/godotengine/godot-cpp-template), and base your project off of that.
