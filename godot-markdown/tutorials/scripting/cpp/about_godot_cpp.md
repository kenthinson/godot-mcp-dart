<a id="doc-about-godot-cpp"></a>

# About godot-cpp

[godot-cpp](https://github.com/godotengine/godot-cpp) are the official C++ GDExtension bindings, maintained
as part of the Godot project.

godot-cpp is built with the [GDExtension system](../gdextension/index.md#doc-gdextension), which allows access to Godot in almost the
same way as [modules](../../../engine_details/engine_api/custom_modules_in_cpp.md#doc-custom-modules-in-cpp): A lot of [engine code](https://github.com/godotengine/godot)
can be used in your godot-cpp project almost exactly as it is.

In particular, godot-cpp has access to all functions that [GDScript](../gdscript/index.md#doc-gdscript) and [C#](../c_sharp/index.md#doc-c-sharp)
...
and [C++ modules](../../../engine_details/engine_api/custom_modules_in_cpp.md#doc-custom-modules-in-cpp) to run C or C++ code in a Godot project.
...
[asset library](../../../community/asset_library/what_is_assetlib.md#doc-what-is-assetlib).
...
We recommend [C++ modules](../../../engine_details/engine_api/custom_modules_in_cpp.md#doc-custom-modules-in-cpp) in cases where
...
<a id="doc-what-is-gdextension-version-compatibility"></a>
...
file generated by your custom engine build. See [Large world coordinates](../../physics/large_world_coordinates.md#doc-large-world-coordinates)
for details.
...
`extension_api.json` files in the [build system section](build_system/scons.md#doc-godot-cpp-build-system).
