...
#### SEE ALSO
See [Printing messages](debug/output_panel.md#doc-output-panel-printing-messages) for instructions on printing
...
in the [Output panel](debug/output_panel.md#doc-output-panel).
...
- **Application > Run > Disable stdout:** Disables logging to standard output entirely.
  ...
  by setting [Engine.print_to_stdout](../../classes/class_engine.md#class-engine-property-print-to-stdout).
- **Application > Run > Disable stderr:** Disables logging to standard error entirely.
  This also affects what custom loggers receive. This can be controlled at runtime
  by setting [Engine.print_error_messages](../../classes/class_engine.md#class-engine-property-print-error-messages).
- **Debug > Settings > stdout > Verbose stdout:** Enables verbose logging to standard output.
  Prints from [print_verbose()](../../classes/class_@globalscope.md#class-globalscope-method-print-verbose) are only
...
- **Debug > Settings > stdout > Print GPU Profile:** Prints a report of GPU utilization
  every second, using the same data source as the [Visual Profiler](debug/debugger_panel.md#doc-debugger-panel-visual-profiler).

Some of these project settings can also be overridden using
[command line arguments](../editor/command_line_tutorial.md#doc-command-line-tutorial) such as `--quiet`,
...
[Debugging symbols](../../engine_details/development/compiling/introduction_to_the_buildsystem.md#doc-introduction-to-the-buildsystem-debugging-symbols)
for guidance on compiling binaries with debugging symbols enabled.

#### NOTE
Log files for [print()](../../classes/class_@globalscope.md#class-globalscope-method-print)
...
(used by [printerr()](../../classes/class_@globalscope.md#class-globalscope-method-printerr),
[push_error()](../../classes/class_@globalscope.md#class-globalscope-method-push-error), and
[push_warning()](../../classes/class_@globalscope.md#class-globalscope-method-push-warning)) is always
...
contains [debugging symbols](../../engine_details/development/compiling/introduction_to_the_buildsystem.md#doc-introduction-to-the-buildsystem-debugging-symbols).
...
(`Program crashed with signal`) using [FileAccess](../../classes/class_fileaccess.md#class-fileaccess). This allows you to access
...
A custom logger can be registered by creating a class that inherits from [Logger](../../classes/class_logger.md#class-logger),
then passing an instance of this class to [OS.add_logger](../../classes/class_os.md#class-os-method-add-logger),
in a script's [\_init()](../../classes/class_object.md#class-object-private-method-init) method. A good place to do this
is an [autoload](singletons_autoload.md#doc-singletons-autoload).

The class must define two methods: [\_log_message()](../../classes/class_logger.md#class-logger-private-method-log-message)
and [\_log_error()](../../classes/class_logger.md#class-logger-private-method-log-error).
...
[print()](../../classes/class_@globalscope.md#class-globalscope-method-print) and its related methods in
`_log_message()`. You also can't effectively use
[push_error()](../../classes/class_@globalscope.md#class-globalscope-method-push-error)
or [push_warning()](../../classes/class_@globalscope.md#class-globalscope-method-push-warning) in
...
[Custom Logging demo project](https://github.com/godotengine/godot-demo-projects/tree/master/misc/custom_logging).
