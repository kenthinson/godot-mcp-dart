<a id="doc-gdextension-c-example"></a>
...
inherits from [Sprite2D](../../../classes/class_sprite2d.md#class-sprite2d).
...
create a [StringName](../../../classes/class_stringname.md#class-stringname) and for that we have to get a
...
See [Version compatibility](../cpp/about_godot_cpp.md#doc-what-is-gdextension-version-compatibility) for more information.
...
are working on for the example. Using [feature tags](../../export/feature_tags.md#doc-feature-tags) you
...
![image](tutorials/scripting/gdextension/img/gdextension_c_running.webp)
...
this tutorial, check the page about the [Object class](../../../engine_details/architecture/object_class.md#doc-object-class)
...
![image](tutorials/scripting/gdextension/img/gdextension_c_methods_doc.webp)
...
![image](tutorials/scripting/gdextension/img/gdextension_c_inspector_properties.webp)
...
[\_process()](../../../classes/class_node.md#class-node-private-method-process) and make our custom sprite
move a little bit.
...
First, let's add [Vector2](../../../classes/class_vector2.md#class-vector2) to our `defs.h` file, so we
...
![image](tutorials/scripting/gdextension/img/gdextension_c_moving_sprite.gif)
...
[emit_signal()](../../../classes/class_object.md#class-object-method-emit-signal) method on our custom node.
...
![image](tutorials/scripting/gdextension/img/gdextension_c_signal_doc.webp)
...
![image](tutorials/scripting/gdextension/img/gdextension_c_signal_print.webp)
...
[godot-cpp documentation](../cpp/index.md#doc-godot-cpp) to see how you can
do this.
