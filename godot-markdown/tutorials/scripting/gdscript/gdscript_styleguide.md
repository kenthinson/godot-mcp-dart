<a id="doc-gdscript-styleguide"></a>
...
Use PascalCase for enum *names* and keep them singular, as they represent a type. Use CONSTANT_CASE for their members, as they
are constants:
...
[Formatting](#formatting). For naming conventions, see [Naming conventions](#naming-conventions).
...
information, see [Registering named classes](gdscript_basics.md#doc-gdscript-basics-class-name). If the class is meant
to be an [abstract class](gdscript_basics.md#doc-gdscript-basics-abstract-class),
add `@abstract` *before* the `class_name` keyword.

Then, add the `extends` keyword if the class extends a built-in type.

Following that, you should have the class's optional
[documentation comments](gdscript_documentation_comments.md#doc-gdscript-documentation-comments).
...
GDScript supports [optional static typing](static_typing.md#doc-gdscript-static-typing).
...
#### NOTE
This option is considered more [type-safe](static_typing.md#doc-gdscript-static-typing-safe-lines) than type hints,
