<a id="doc-gdscript-reference"></a>

# GDScript reference

[GDScript](index.md#doc-gdscript) is a high-level, [object-oriented](https://en.wikipedia.org/wiki/Object-oriented_programming), [imperative](https://en.wikipedia.org/wiki/Imperative_programming), and [gradually typed](https://en.wikipedia.org/wiki/Gradual_typing) programming language built for Godot.
...
[Frequently Asked Questions](../../../about/faq.md#doc-faq-what-is-gdscript).
...
read this tutorial: [GDScript: An introduction to dynamic languages](gdscript_advanced.md#doc-gdscript-more-efficiently).
...
| while      | See [while]().                                                                                                                                                                                                                |
| match      | See [match]().                                                                                                                                                                                                                |
| when       | Used by [pattern guards]()<br/><br/><a id="pattern-guards"></a><br/> in `match` statements.                                                                                                                                   |
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `(` `)`                                                                                                                                                                                                                                                                           | Grouping (highest priority)<br/><br/>Parentheses are not really an operator, but allow you to explicitly specify<br/>the precedence of an operation.                                                                                                                                                                                                |
| `x[index]`                                                                                                                                                                                                                                                                        | Subscription                                                                                                                                                                                                                                                                                                                                        |
| `x.attribute`                                                                                                                                                                                                                                                                     | Attribute reference                                                                                                                                                                                                                                                                                                                                 |
| `foo()`                                                                                                                                                                                                                                                                           | Function call                                                                                                                                                                                                                                                                                                                                       |
| `await x`                                                                                                                                                                                                                                                                         | [Awaiting signals or coroutines]()                                                                                                                                                                                                                                                                                                                  |
| `x is Node`<br/><br/><br/>`x is not Node`<br/><br/>                                                                                                                                                                                                                               | Type checking<br/><br/>See also [is_instance_of()](../../../classes/class_@gdscript.md#class-gdscript-method-is-instance-of)<br/>function.                                                                                                                                                                                                          |
| `x ** y`                                                                                                                                                                                                                                                                          | Power<br/><br/>Multiplies `x` by itself `y` times, similar to calling<br/>[pow()](../../../classes/class_@globalscope.md#class-globalscope-method-pow) function.                                                                                                                                                                                    |
| `~x`                                                                                                                                                                                                                                                                              | Bitwise NOT                                                                                                                                                                                                                                                                                                                                         |
| `+x`<br/><br/><br/>`-x`<br/><br/>                                                                                                                                                                                                                                                 | Identity / Negation                                                                                                                                                                                                                                                                                                                                 |
| `x * y`<br/><br/><br/>`x / y`<br/><br/><br/>`x % y`<br/><br/>                                                                                                                                                                                                                     | Multiplication / Division / Remainder<br/><br/>The `%` operator is additionally used for<br/>[format strings](gdscript_format_string.md#doc-gdscript-printf).<br/><br/>**Note:** These operators have the same behavior as C++, which may be<br/>unexpected for users coming from Python, JavaScript, etc. See a detailed<br/>note after the table. |
| `x + y`<br/><br/><br/>`x - y`<br/><br/>                                                                                                                                                                                                                                           | Addition (or Concatenation) / Subtraction                                                                                                                                                                                                                                                                                                           |
| `x << y`<br/><br/><br/>`x >> y`<br/><br/>                                                                                                                                                                                                                                         | Bit shifting                                                                                                                                                                                                                                                                                                                                        |
| `x & y`                                                                                                                                                                                                                                                                           | Bitwise AND                                                                                                                                                                                                                                                                                                                                         |
| `x ^ y`                                                                                                                                                                                                                                                                           | Bitwise XOR                                                                                                                                                                                                                                                                                                                                         |
| `x | y`                                                                                                                                                                                                                                                                           | Bitwise OR                                                                                                                                                                                                                                                                                                                                          |
| `x == y`<br/><br/><br/>`x != y`<br/><br/><br/>`x < y`<br/><br/><br/>`x > y`<br/><br/><br/>`x <= y`<br/><br/><br/>`x >= y`<br/><br/>                                                                                                                                               | Comparison<br/><br/>See a detailed note after the table.                                                                                                                                                                                                                                                                                            |
| `x in y`<br/><br/><br/>`x not in y`<br/><br/>                                                                                                                                                                                                                                     | Inclusion checking<br/><br/>`in` is also used with the [for]() keyword as part of the syntax.                                                                                                                                                                                                                                                       |
| `not x`<br/><br/><br/>`!x`<br/><br/>                                                                                                                                                                                                                                              | Boolean NOT and its [unrecommended](gdscript_styleguide.md#boolean-operators) alias                                                                                                                                                                                                                                                                 |
| `x and y`<br/><br/><br/>`x && y`<br/><br/>                                                                                                                                                                                                                                        | Boolean AND and its [unrecommended](gdscript_styleguide.md#boolean-operators) alias                                                                                                                                                                                                                                                                 |
| `x or y`<br/><br/><br/>`x || y`<br/><br/>                                                                                                                                                                                                                                         | Boolean OR and its [unrecommended](gdscript_styleguide.md#boolean-operators) alias                                                                                                                                                                                                                                                                  |
| `true_expr if cond else false_expr`                                                                                                                                                                                                                                               | Ternary if/else                                                                                                                                                                                                                                                                                                                                     |
| `x as Node`                                                                                                                                                                                                                                                                       | [Type casting]()<br/><br/><a id="casting"></a>                                                                                                                                                                                                                                                                                                      |
| `x = y`<br/><br/><br/>`x += y`<br/><br/><br/>`x -= y`<br/><br/><br/>`x *= y`<br/><br/><br/>`x /= y`<br/><br/><br/>`x **= y`<br/><br/><br/>`x %= y`<br/><br/><br/>`x &= y`<br/><br/><br/>`x |= y`<br/><br/><br/>`x ^= y`<br/><br/><br/>`x <<= y`<br/><br/><br/>`x >>= y`<br/><br/> | Assignment (lowest priority)<br/><br/>You cannot use an assignment operator inside an expression.                                                                                                                                                                                                                                                   |

#### NOTE
The behavior of some operators may differ from what you expect:

1. If both operands of the `/` operator are [int](../../../classes/class_int.md#class-int), then integer division is performed instead of fractional. For example `5 / 2 == 2`, not `2.5`.
   If this is not desired, use at least one [float](../../../classes/class_float.md#class-float) literal (`x / 2.0`), cast (`float(x) / y`), or multiply by `1.0` (`x * 1.0 / y`).
2. The `%` operator is only available for ints, for floats use the [fmod()](../../../classes/class_@globalscope.md#class-globalscope-method-fmod) function.
3. For negative values, the `%` operator and `fmod()` use [truncation](https://en.wikipedia.org/wiki/Truncation) instead of rounding towards negative infinity.
   This means that the remainder has a sign. If you need the remainder in a mathematical sense, use the [posmod()](../../../classes/class_@globalscope.md#class-globalscope-method-posmod) and
   [fposmod()](../../../classes/class_@globalscope.md#class-globalscope-method-fposmod) functions instead.
4. The `==` and `!=` operators sometimes allow you to compare values of different types (for example, `1 == 1.0` is true), but in other cases it can cause
   a runtime error. If you're not sure about the types of the operands, you can safely use the [is_same()](../../../classes/class_@globalscope.md#class-globalscope-method-is-same) function
   (but note that it is more strict about types and references). To compare floats, use the [is_equal_approx()](../../../classes/class_@globalscope.md#class-globalscope-method-is-equal-approx)
   and [is_zero_approx()](../../../classes/class_@globalscope.md#class-globalscope-method-is-zero-approx) functions instead.
...
| `&"name"`                   | [StringName](../../../classes/class_stringname.md#class-stringname) |
| `^"Node/Label"`             | [NodePath](../../../classes/class_nodepath.md#class-nodepath)       |
...
GDScript also supports [format strings](gdscript_format_string.md#doc-gdscript-printf).
...
[GDScript class reference](../../../classes/class_@gdscript.md#class-gdscript).
...
For more information about exporting properties, read the [GDScript exports](gdscript_exports.md#doc-gdscript-exports)
article.
...
<a id="doc-gdscript-onready-annotation"></a>
...
[GDScript documentation comments](gdscript_documentation_comments.md#doc-gdscript-documentation-comments) for details.
...
<a id="doc-gdscript-builtin-types"></a>
...
[Variant types](../../../engine_details/architecture/variant_class.md#doc-variant-class) must have a valid value at all times,
...
the tree to get a node, or affecting properties like with [Tweens](../../../classes/class_tween.md#class-tween).
...
#### [Rect2](../../../classes/class_rect2.md#class-rect2)
...
#### [AABB](../../../classes/class_aabb.md#class-aabb)
...
#### [Object](../../../classes/class_object.md#class-object)
...
[Array.assign()](../../../classes/class_array.md#class-array-method-assign) method:
...
<a id="doc-gdscript-packed-arrays"></a>
...
methods such as [Array.map](../../../classes/class_array.md#class-array-method-map) that PackedArrays
lack. Consult the [class reference](../../../classes/class_packedfloat32array.md#class-packedfloat32array) for details
...
- [PackedByteArray](../../../classes/class_packedbytearray.md#class-packedbytearray): An array of bytes (integers from 0 to 255).
- [PackedInt32Array](../../../classes/class_packedint32array.md#class-packedint32array): An array of 32-bit integers.
- [PackedInt64Array](../../../classes/class_packedint64array.md#class-packedint64array): An array of 64-bit integers.
- [PackedFloat32Array](../../../classes/class_packedfloat32array.md#class-packedfloat32array): An array of 32-bit floats.
- [PackedFloat64Array](../../../classes/class_packedfloat64array.md#class-packedfloat64array): An array of 64-bit floats.
- [PackedStringArray](../../../classes/class_packedstringarray.md#class-packedstringarray): An array of strings.
- [PackedVector2Array](../../../classes/class_packedvector2array.md#class-packedvector2array): An array of [Vector2](../../../classes/class_vector2.md#class-vector2) values.
- [PackedVector3Array](../../../classes/class_packedvector3array.md#class-packedvector3array): An array of [Vector3](../../../classes/class_vector3.md#class-vector3) values.
- [PackedVector4Array](../../../classes/class_packedvector4array.md#class-packedvector4array): An array of [Vector4](../../../classes/class_vector4.md#class-vector4) values.
- [PackedColorArray](../../../classes/class_packedcolorarray.md#class-packedcolorarray): An array of [Color](../../../classes/class_color.md#class-color) values.
...
[Object](../../../classes/class_object.md#class-object), not just Dictionaries. Keep in mind it will cause a
script error when attempting to index a non-existing property. To avoid
this, use the [Object.get()](../../../classes/class_object.md#class-object-method-get) and
[Object.set()](../../../classes/class_object.md#class-object-method-set) methods instead.
...
the project settings. See [GDScript warning system](warning_system.md#doc-gdscript-warning-system) for details.
...
<a id="doc-gdscript-basics-static-variables"></a>
...
See [Running code in the editor](../../plugins/running_code_in_the_editor.md#doc-running-code-in-the-editor-important-information)
for details.
...
You should clean up this data manually, or use the [@static_unload](../../../classes/class_@gdscript.md#class-gdscript-annotation-static-unload)
...
[Dictionary](../../../classes/class_dictionary.md#class-dictionary) of that name. This means all constant methods of
...
Functions are first-class values in terms of the [Callable](../../../classes/class_callable.md#class-callable) object.
...
#### NOTE
Callables **must** be called with the [call()](../../../classes/class_callable.md#class-callable-method-call) method.
...
[Callable](../../../classes/class_callable.md#class-callable) object is created and assigned to a variable directly.
...
To call the created lambda you can use the [call()](../../../classes/class_callable.md#class-callable-method-call) method:
...
provided using [\_set()](../../../classes/class_object.md#class-object-private-method-set) and/or
[\_get()](../../../classes/class_object.md#class-object-private-method-get)).
...
<a id="doc-gdscript-basics-class-name"></a>
...
![image](tutorials/scripting/gdscript/img/class_name_editor_register_example.png)
...
<a id="doc-gdscript-basics-abstract-class"></a>
...
[RefCounted](../../../classes/class_refcounted.md#class-refcounted).
...
<a id="doc-gdscript-basics-inner-classes"></a>
...
<a id="doc-gdscript-classes-as-resources"></a>

### Classes as resources

Classes stored as files are treated as [GDScripts](../../../classes/class_gdscript.md#class-gdscript). They
...
#### NOTE
Documentation about exports has been moved to [GDScript exported properties](gdscript_exports.md#doc-gdscript-exports).

<a id="doc-gdscript-basics-setters-getters"></a>
...
See [Running code in the editor](../../plugins/running_code_in_the_editor.md#doc-running-code-in-the-editor) for more information.
...
<a id="doc-gdscript-basics-memory-management"></a>
...
Any instance of the [RefCounted](../../../classes/class_refcounted.md#class-refcounted) class (or any class that inherits
it, such as [Resource](../../../classes/class_resource.md#class-resource)) will be freed automatically when no longer
in use. For an instance of any class that is not a [RefCounted](../../../classes/class_refcounted.md#class-refcounted)
(such as [Node](../../../classes/class_node.md#class-node) or the base [Object](../../../classes/class_object.md#class-object) type), it will
remain in memory until it is deleted with `free()` (or `queue_free()`
for Nodes).

#### NOTE
If a [Node](../../../classes/class_node.md#class-node) is deleted via `free()` or `queue_free()`,
all of its children will also recursively be deleted.

To avoid reference cycles that can't be freed, a [WeakRef](../../../classes/class_weakref.md#class-weakref)
function is provided for creating weak references, which allow access
to the object without preventing a [RefCounted](../../../classes/class_refcounted.md#class-refcounted) from freeing.
Here is an example:
...
signals of nodes like [Button](../../../classes/class_button.md#class-button) or [RigidBody3D](../../../classes/class_rigidbody3d.md#class-rigidbody3d).
...
it with [Signal.emit()](../../../classes/class_signal.md#class-signal-method-emit), and from
a `Game` node higher up our scene tree, we connect it to the `Lifebar` using
the [Signal.connect()](../../../classes/class_signal.md#class-signal-method-connect) method:
...
![image](tutorials/scripting/gdscript/img/gdscript_basics_signals_node_tab_1.png)

You can also create copies of GDScript Callable objects which accept additional
arguments using [Callable.bind()](../../../classes/class_callable.md#class-callable-method-bind). This
