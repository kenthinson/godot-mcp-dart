<a id="doc-gdscript-warning-system"></a>

# GDScript warning system

The GDScript warning system complements [static typing](static_typing.md#doc-gdscript-static-typing)
...
![image](tutorials/scripting/gdscript/img/typed_gdscript_warning_system_settings.webp)
...
![image](tutorials/scripting/gdscript/img/typed_gdscript_warning_example.webp)

To ignore single warnings within a file, use the
[@warning_ignore](../../../classes/class_@gdscript.md#class-gdscript-annotation-warning-ignore) annotation.
...
![image](tutorials/scripting/gdscript/img/typed_gdscript_warning_system_ignore.webp)

To ignore multiple warnings in a region within a file, use the
[@warning_ignore_start](../../../classes/class_@gdscript.md#class-gdscript-annotation-warning-ignore-start)
and [@warning_ignore_restore](../../../classes/class_@gdscript.md#class-gdscript-annotation-warning-ignore-restore)
...
![image](tutorials/scripting/gdscript/img/typed_gdscript_warning_system_errors.webp)
