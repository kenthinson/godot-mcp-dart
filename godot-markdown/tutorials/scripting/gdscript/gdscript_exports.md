<a id="doc-gdscript-exports"></a>

# GDScript exported properties

In Godot, class members can be exported. This means their value gets saved along
with the resource (such as the [scene](../../../classes/class_packedscene.md#class-packedscene)) they're
attached to, and get transferred over when using [RPCs](../../networking/high_level_multiplayer.md#doc-high-level-multiplayer-rpcs).
...
special export syntax is provided. Additionally, [documentation comments](gdscript_documentation_comments.md#doc-gdscript-documentation-comments) can be
used for tooltip descriptions, visible on mouse over.

#### NOTE
Exporting properties can also be done in other languages such as C#.
The syntax varies depending on the language. See [C# exported properties](../c_sharp/c_sharp_exports.md#doc-c-sharp-exports)
...
if the script is in [Tool mode](gdscript_basics.md#doc-gdscript-tool-mode).

## Grouping exports

It is possible to group your exported properties inside the Inspector
with the [@export_group](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-group)
...
Groups cannot be nested, use [@export_subgroup](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-subgroup)
...
categories in the property list with the [@export_category](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-category)
annotation.
...
String as a path to a file. See [@export_file](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-file).

```gdscript
@export_file var f
```

String as a path to a directory. See [@export_dir](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-dir).

```gdscript
@export_dir var f
```

String as a path to a file, custom filter provided as hint. See again [@export_file](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-file).
...
String as a path to a PNG file in the global filesystem. See [@export_global_file](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-global-file).

```gdscript
@export_global_file("*.png") var tool_image
```

String as a path to a directory in the global filesystem. See [@export_global_dir](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-global-dir).
...
field for editing over multiple lines. See [@export_multiline](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-multiline).
...
See [@export_range](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-range) for all of the following.
...
[Floats with easing hint](#doc-gdscript-exports-floats-with-easing-hint) instead.
...
<a id="doc-gdscript-exports-floats-with-easing-hint"></a>

## Floats with easing hint

Display a visual representation of the `ease()` function
when editing. See [@export_exp_easing](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-exp-easing).
...
Color given as red-green-blue value (alpha will always be 1). See [@export_color_no_alpha](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-color-no-alpha).
...
[@export_node_path](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-node-path)
annotation:
...
<a id="doc-gdscript-exports-exporting-bit-flags"></a>

## Exporting bit flags

See [@export_flags](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-flags).
...
See [@export_enum](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-enum).
...
the [@export_enum](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-enum) annotation.
...
See [@export_storage](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-storage).

By default, exporting a property has two effects:

1. makes the property stored in the scene/resource file ([PROPERTY_USAGE_STORAGE](../../../classes/class_@globalscope.md#class-globalscope-constant-property-usage-storage));
2. adds a field to the Inspector ([PROPERTY_USAGE_EDITOR](../../../classes/class_@globalscope.md#class-globalscope-constant-property-usage-editor)).
...
To do this you can use [@export_storage](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-storage).
This can be useful for [@tool](../../../classes/class_@gdscript.md#class-gdscript-annotation-tool) scripts.
Also the property value is copied when [Resource.duplicate()](../../../classes/class_resource.md#class-resource-method-duplicate)
or [Node.duplicate()](../../../classes/class_node.md#class-node-method-duplicate) is called, unlike non-exported variables.
...
See the [class reference](../../../classes/class_@gdscript.md#class-gdscript-annotation-export-custom)
...
[Godot editor icons](https://godot-editor-icons.github.io/) website.
...
[Tool mode](gdscript_basics.md#doc-gdscript-tool-mode), the value in the inspector won't be updated
automatically. To update it, call
[notify_property_list_changed()](../../../classes/class_object.md#class-object-method-notify-property-list-changed)
after setting the exported variable's value.

## Reading an exported variable's value early on

If you read an exported variable's value in [\_init()](../../../classes/class_object.md#class-object-private-method-init),
...
[Node._ready()](../../../classes/class_node.md#class-node-private-method-ready). You can also read the value
...
[\_set()](../../../classes/class_object.md#class-object-private-method-set),
[\_get()](../../../classes/class_object.md#class-object-private-method-get), and
[\_get_property_list()](../../../classes/class_object.md#class-object-private-method-get-property-list) methods as
described in [Accessing data or logic from an object](../../best_practices/godot_interfaces.md#doc-accessing-data-or-logic-from-object).

#### SEE ALSO
For binding properties using the above methods in C++, see
[Binding properties using \_set/_get/_get_property_list](../../../engine_details/architecture/object_class.md#doc-binding-properties-using-set-get-property-list).
