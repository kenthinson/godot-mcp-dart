<a id="doc-gdscript-more-efficiently"></a>
...
that inherit [RefCounted](../../../classes/class_refcounted.md#class-refcounted) (the default if nothing is specified)
will be freed when not used, but manual memory management is allowed too
if inheriting manually from [Object](../../../classes/class_object.md#class-object).
