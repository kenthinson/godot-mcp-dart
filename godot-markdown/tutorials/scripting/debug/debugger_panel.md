...
![image](tutorials/scripting/debug/img/overview_debugger.webp)
...
#### NOTE
Using the debugger and breakpoints on [tool scripts](../../plugins/running_code_in_the_editor.md#doc-running-code-in-the-editor)
...
Expressions are evaluated using [Godot's expression language](../evaluating_expressions.md#doc-evaluating-expressions), which allows you to perform arithmetic and call
...
dedicated [The Profiler](the_profiler.md#doc-the-profiler) page.

<a id="doc-debugger-panel-visual-profiler"></a>
...
![Visual Profiler tab after clicking Start, waiting for a few seconds, then clicking Stop](tutorials/scripting/debug/img/debugger_visual_profiler_results.webp)
...
`disabled` or `canvas_items` [stretch modes](../../rendering/multiple_resolutions.md#doc-multiple-resolutions).
...
![Example results from a 2D scene in the Visual Profiler](tutorials/scripting/debug/img/debugger_visual_profiler_2d_example.webp)
...
![Example results from a 3D scene in the Visual Profiler](tutorials/scripting/debug/img/debugger_visual_profiler_3d_example.webp)
...
#### NOTE
The bandwidth meter does **not** take the [High-level multiplayer](../../networking/high_level_multiplayer.md#doc-high-level-multiplayer)
...
[custom performance monitors](custom_performance_monitors.md#doc-custom-performance-monitors)
...
![image](tutorials/scripting/debug/img/video_ram.png)
