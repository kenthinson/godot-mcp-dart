<a id="doc-cross-language-scripting"></a>
...
(see [Classes as resources](gdscript/gdscript_basics.md#doc-gdscript-classes-as-resources)), the script can be instantiated
with [new()](../../classes/class_csharpscript.md#class-csharpscript-method-new).
...
be instantiated with [GDScript.New()](../../classes/class_gdscript.md#class-gdscript-method-new).
...
Here we are using an [Object](../../classes/class_object.md#class-object), but you can use type conversion like
explained in [Type conversion and casting](c_sharp/c_sharp_features.md#doc-c-sharp-features-type-conversion-and-casting).
...
convoluted. You will have to use [GodotObject.Get()](../../classes/class_object.md#class-object-method-get)
and [GodotObject.Set()](../../classes/class_object.md#class-object-method-set). The first argument is the name of the field you want to access.
...
[Built-in types](gdscript/gdscript_basics.md#doc-gdscript-builtin-types) or classes extending [Object](../../classes/class_object.md#class-object).
...
[GodotObject.Call()](../../classes/class_object.md#class-object-method-call). The first argument is the
...
<a id="connecting-to-signals-cross-language"></a>
