...
|------------------------|-----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Godot 4.7<br/>(master) | Q2/Q3 2026 (estimate) | ![unstable](about/img/unstable.png) *Development.* Receives new features, usability and<br/>performance improvements, as well as bug fixes, while under development. |
| Godot 4.6              | January 2026          | ![supported](about/img/supported.png) Receives fixes for bugs and security issues, as well as<br/>patches that enable platform support.                              |
| Godot 4.5              | September 2025        | ![supported](about/img/supported.png) Receives fixes for bugs and security issues, as well as<br/>patches that enable platform support.                              |
| Godot 4.4              | March 2025            | ![partial](about/img/partial.png) Receives fixes for security and platform support issues only.                                                                      |
| Godot 4.3              | August 2024           | ![eol](about/img/eol.png) No longer supported (last update: 4.3).                                                                                                    |
| Godot 4.2              | November 2023         | ![eol](about/img/eol.png) No longer supported (last update: 4.2.2).                                                                                                  |
| Godot 4.1              | July 2023             | ![eol](about/img/eol.png) No longer supported (last update: 4.1.4).                                                                                                  |
| Godot 4.0              | March 2023            | ![eol](about/img/eol.png) No longer supported (last update: 4.0.4).                                                                                                  |
| Godot 3.7<br/>(3.x)    | No ETA for now        | ![supported](about/img/supported.png) *Beta.* Receives new features, usability and performance<br/>improvements, as well as bug fixes, while under development.      |
| Godot 3.6              | September 2024        | ![supported](about/img/supported.png) Receives fixes for bugs and security issues, as well as<br/>patches that enable platform support.                              |
| Godot 3.5              | August 2022           | ![eol](about/img/eol.png) No longer supported (last update: 3.5.3).                                                                                                  |
| Godot 3.4              | November 2021         | ![eol](about/img/eol.png) No longer supported (last update: 3.4.5).                                                                                                  |
| Godot 3.3              | April 2021            | ![eol](about/img/eol.png) No longer supported (last update: 3.3.4).                                                                                                  |
| Godot 3.2              | January 2020          | ![eol](about/img/eol.png) No longer supported (last update: 3.2.3).                                                                                                  |
| Godot 3.1              | March 2019            | ![eol](about/img/eol.png) No longer supported (last update: 3.1.2).                                                                                                  |
| Godot 3.0              | January 2018          | ![eol](about/img/eol.png) No longer supported (last update: 3.0.6).                                                                                                  |
| Godot 2.1              | July 2016             | ![eol](about/img/eol.png) No longer supported (last update: 2.1.6).                                                                                                  |
| Godot 2.0              | February 2016         | ![eol](about/img/eol.png) No longer supported (last update: 2.0.4.1).                                                                                                |
| Godot 1.1              | May 2015              | ![eol](about/img/eol.png) No longer supported.                                                                                                                       |
| Godot 1.0              | December 2014         | ![eol](about/img/eol.png) No longer supported.                                                                                                                       |

**Legend:**
![supported](about/img/supported.png) Full support –
![partial](about/img/partial.png) Partial support –
![eol](about/img/eol.png) No support (end of life) –
![unstable](about/img/unstable.png) Development version

Pre-release Godot versions aren't intended to be used in production and are
provided for testing purposes only.

#### SEE ALSO
See [Upgrading from Godot 3 to Godot 4](../tutorials/migrating/upgrading_to_godot_4.md#doc-upgrading-to-godot-4) for instructions on migrating a project
from Godot 3.x to 4.x.

<a id="doc-release-policy-which-version-should-i-use"></a>
...
[Upgrading from Godot 3 to Godot 4](../tutorials/migrating/upgrading_to_godot_4.md#doc-upgrading-to-godot-4) open in a separate tab to check which methods
...
<a id="doc-release-policy-should-i-upgrade-my-project"></a>
...
<a id="doc-release-policy-when-is-next-release-out"></a>
...
See [Handling compatibility breakages](../engine_details/development/handling_compatibility_breakages.md#doc-handling-compatibility-breakages) for more information.
