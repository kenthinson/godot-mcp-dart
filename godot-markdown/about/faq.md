...
For more on this, see the sections on [exporting](../tutorials/export/index.md#toc-learn-workflow-export)
and [compiling Godot yourself](../engine_details/development/compiling/index.md#toc-devel-compiling).
...
See the subcategories for each language in the [scripting](../tutorials/scripting/index.md#toc-learn-scripting) section.
...
[open issues](https://github.com/godotengine/godot/issues?q=is%3Aopen+is%3Aissue+label%3Atopic%3Adotnet)
...
<a id="doc-faq-what-is-gdscript"></a>
...
you, check out the [GDScript scripting guide](../tutorials/scripting/gdscript/index.md#doc-gdscript).
...
languages can be found in the [GDScript: An introduction to dynamic languages](../tutorials/scripting/gdscript/gdscript_advanced.md#doc-gdscript-more-efficiently) tutorial.

## What were the motivations behind creating GDScript?

In the early days, the engine used the [Lua](https://www.lua.org) scripting
...
amount of code. After some experiments with [Python](https://www.python.org),
...
<a id="doc-faq-which-programming-language-is-fastest"></a>
...
C++, using [GDExtension](../tutorials/scripting/gdextension/what_is_gdextension.md#doc-what-is-gdextension), will almost always be
...
[cross-language scripting](../tutorials/scripting/cross_language_scripting.md#doc-cross-language-scripting), or by using
...
[Importing 3D scenes](../tutorials/assets_pipeline/importing_3d_scenes/index.md#doc-importing-3d-scenes) documentation.
...
for additional languages, take a look at [EditorPlugins](../tutorials/plugins/editor/making_plugins.md#doc-making-plugins)
and tool scripts.
...
as well as the [Jolt physics engine integration](https://github.com/godot-jolt/godot-jolt)
...
- Rename and move the Godot binary to a location present in your `PATH` environment variable.
  ...
  [run the Godot editor from a terminal](../tutorials/editor/command_line_tutorial.md#doc-command-line-tutorial) by entering `godot`.
  - If you cannot move the Godot editor binary to a protected location, you can
    ...
    to the Godot binary.
- Save [this .desktop file](https://raw.githubusercontent.com/godotengine/godot/master/misc/dist/linux/org.godotengine.Godot.desktop)
...
See [File paths in Godot projects](../tutorials/io/data_paths.md#doc-data-paths) for more information.

If *true* portable operation is desired (e.g. for use on a USB stick),
follow the steps in [Self-contained mode](../tutorials/io/data_paths.md#doc-data-paths-self-contained-mode).
...
[compile custom export templates with unused features disabled](../engine_details/development/compiling/optimizing_for_size.md#doc-optimizing-for-size)
...
2. Use the stretch options in Godot; canvas items stretching while keeping
   aspect ratios works best. Check the [Multiple resolutions](../tutorials/rendering/multiple_resolutions.md#doc-multiple-resolutions) tutorial
...
3. Determine a minimum resolution and then decide if you want your game
   ...
   instead. This is also explained in [Multiple resolutions](../tutorials/rendering/multiple_resolutions.md#doc-multiple-resolutions).
4. For user interfaces, use the [anchoring](../tutorials/ui/size_and_anchors.md#doc-size-and-anchors)
...
When it's ready! See [When is the next release out?](release_policy.md#doc-release-policy-when-is-next-release-out) for more
information.
...
[Which version should I use for a new project?](release_policy.md#doc-release-policy-which-version-should-i-use) for more information.
...
[Should I upgrade my project to use new engine versions?](release_policy.md#doc-release-policy-should-i-upgrade-my-project) for more information.

## Should I use the Forward+, Mobile, or Compatibility renderer?

You can find a detailed comparison of the renderers in [Overview of renderers](../tutorials/rendering/renderers.md#doc-renderers).
...
what other ways to contribute are there in our [documentation for contributors](https://contributing.godotengine.org/en/latest/organization/how_to_contribute.html).
...
<a id="doc-faq-non-game-applications"></a>
...
See [Creating applications](../tutorials/ui/creating_applications.md#doc-creating-applications) for more information.

<a id="doc-faq-use-godot-as-library"></a>
...
[migeran/libgodot_project GitHub repository](https://github.com/migeran/libgodot_project).

## What user interface toolkit does Godot use?

Godot does not use a standard  toolkit
...
This custom UI toolkit can be [embedded into other applications](#doc-faq-use-godot-as-library)
(experimental). However, the preferred way to use it is to
[use Godot to create non-game applications with the editor](#doc-faq-non-game-applications).

<a id="doc-faq-why-scons"></a>

## Why does Godot use the SCons build system?

Godot uses the [SCons](https://www.scons.org/) build system. There are no
...
- Godot's build process is not simple. Several files are generated by
  ...
  customization ([modules](../engine_details/engine_api/custom_modules_in_cpp.md#doc-custom-modules-in-cpp)). This requires
...
Check out [Godot's container types](../engine_details/architecture/core_types.md#doc-core-types) for alternatives.
...
See [How to contribute](https://contributing.godotengine.org/en/latest/organization/how_to_contribute.html).
