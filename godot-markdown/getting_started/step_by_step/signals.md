...
Like methods ([Callable](../../classes/class_callable.md#class-callable)), signals are a first-class type since Godot
...
less error-prone. See the [Signal](../../classes/class_signal.md#class-signal) class reference for a list of
...
([Listening to player input](scripting_player_input.md#doc-scripting-player-input)) move and stop by pressing a button.
...
- **GDScript**: Classes (nodes) use PascalCase, variables and
  ...
  [GDScript style guide](../../tutorials/scripting/gdscript/gdscript_styleguide.md#doc-gdscript-styleguide)).
- **C#**: Classes, export variables and methods use PascalCase,
  private fields use \_camelCase, local variables and parameters use
  camelCase (See [C# style guide](../../tutorials/scripting/c_sharp/c_sharp_style_guide.md#doc-c-sharp-styleguide)). Be careful to type
  the method names precisely when connecting signals.

## Scene setup

To add a button to our game, we will create a new scene which will include
both a [Button](../../classes/class_button.md#class-button) and the `sprite_2d.tscn` scene we created in
the [Creating your first script](scripting_first_script.md#doc-scripting-first-script) lesson.

Create a new scene by going to the menu Scene > New Scene.

![image](getting_started/step_by_step/img/signals_01_new_scene.webp)

In the Scene dock, click the 2D Scene button. This will add
a [Node2D](../../classes/class_node2d.md#class-node2d) as our root.

![image](getting_started/step_by_step/img/signals_02_2d_scene.webp)

In the FileSystem dock, click and drag the `sprite_2d.tscn` file you saved
previously onto the Node2D to instantiate it.

![image](getting_started/step_by_step/img/signals_03_dragging_scene.webp)

We want to add another node as a sibling of the Sprite2D. To do so, right-click
on Node2D and select Add Child Node.

![image](getting_started/step_by_step/img/signals_04_add_child_node.webp)

Search for the [Button](../../classes/class_button.md#class-button) node and add it.

![image](getting_started/step_by_step/img/signals_05_add_button.webp)

The node is small by default. Click and drag on the bottom-right handle of the
Button in the viewport to resize it.

![image](getting_started/step_by_step/img/signals_06_drag_button.png)

If you don't see the handles, ensure the select tool is active in the toolbar.

![image](getting_started/step_by_step/img/signals_07_select_tool.webp)
...
![image](getting_started/step_by_step/img/signals_08_toggle_motion_text.webp)

Your scene tree and viewport should look like this.

![image](getting_started/step_by_step/img/signals_09_scene_setup.webp)
...
You can connect signals in the Signals dock. Select the Button node and, on the
right side of the editor, click on the tab named Signals next to the
Inspector.

![image](getting_started/step_by_step/img/signals_10_node_dock.webp)

The dock displays a list of signals available on the selected node.

![image](getting_started/step_by_step/img/signals_11_pressed_signals.webp)

Double-click the "pressed" signal to open the node connection window.

![image](getting_started/step_by_step/img/signals_12_node_connection.webp)
...
![image](getting_started/step_by_step/img/signals_advanced_connection_window.webp)
...
![image](getting_started/step_by_step/img/signals_13_signals_connection_icon.webp)
...
![image](getting_started/step_by_step/img/signals_14_signals_connection_info.webp)
...
a method to toggle processing on and off: [Node.set_process()](../../classes/class_node.md#class-node-method-set-process). Another method of the Node class,
...
Let's use a different node here. Godot has a [Timer](../../classes/class_timer.md#class-timer) node
...
![image](getting_started/step_by_step/img/signals_15_scene_tree.webp)

With the Timer node selected, go to the Inspector and enable the Autostart
property.

![image](getting_started/step_by_step/img/signals_18_timer_autostart.webp)

Click the script icon next to Sprite2D to jump back to the scripting workspace.

![image](getting_started/step_by_step/img/signals_16_click_script.webp)
...
using the [Node._ready()](../../classes/class_node.md#class-node-private-method-ready) built-in function,
which is called automatically by the engine when a node is fully instantiated.

To get a reference to a node relative to the current one, we use the method
[Node.get_node()](../../classes/class_node.md#class-node-method-get-node). We can store the reference
in a variable.
...
Your signals work the same way as built-in ones: they appear in the Signals tab and
you can connect to them like any other.

![image](getting_started/step_by_step/img/signals_17_custom_signal.webp)
...
For example, an [Area2D](../../classes/class_area2d.md#class-area2d) representing a coin emits a
...
In the next section, [Your first 2D game](../first_2d_game/index.md#doc-your-first-2d-game), you'll create a complete 2D
