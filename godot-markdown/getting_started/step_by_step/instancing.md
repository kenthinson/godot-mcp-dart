<a id="doc-instancing"></a>

# Creating instances

#### NOTE
This tutorial refers to instancing scenes in the editor. To learn how
to instance scenes from code, see [Nodes and scene instances](../../tutorials/scripting/nodes_and_scene_instances.md#doc-nodes-and-scene-instances).
...
objects quickly. See [Optimization using MultiMeshes](../../tutorials/performance/using_multimesh.md#doc-using-multimesh) instead.
...
Here's an example of a ball. It's composed of a [RigidBody2D](../../classes/class_rigidbody2d.md#class-rigidbody2d) node as its root named Ball, which allows the ball to fall
and bounce on walls, a [Sprite2D](../../classes/class_sprite2d.md#class-sprite2d) node, and a
[CollisionShape2D](../../classes/class_collisionshape2d.md#class-collisionshape2d).

![image](getting_started/step_by_step/img/instancing_ball_scene.webp)
...
![image](getting_started/step_by_step/img/instancing_ball_instances_example.webp)
...
![image](getting_started/step_by_step/img/instancing_import_button.webp)

In the pop-up that appears navigate to the folder you extracted.
Double-click the `project.godot` file to open it.

![image](getting_started/step_by_step/img/instancing_import_project_file.webp)

Finally, click the Import button.

![image](getting_started/step_by_step/img/instancing_import_and_edit_button.webp)
...
![image](getting_started/step_by_step/img/instancing_2d_scene_select.webp)![image](getting_started/step_by_step/img/instancing_main_scene.webp)
...
![image](getting_started/step_by_step/img/instancing_scene_link_button.webp)

Double-click the ball scene to instance it.

![image](getting_started/step_by_step/img/instancing_instance_child_window.webp)

The ball appears in the top-left corner of the viewport.

![image](getting_started/step_by_step/img/instancing_ball_instanced.webp)

Click on it and drag it towards the center of the view.

![image](getting_started/step_by_step/img/instancing_ball_moved.webp)
...
![image](getting_started/step_by_step/img/instancing_ball_duplicated.webp)

You can repeat this process until you have several in the scene.

![image](getting_started/step_by_step/img/instancing_main_scene_with_balls.webp)
...
![image](getting_started/step_by_step/img/instancing_ball_scene_open.webp)
...
![image](getting_started/step_by_step/img/instancing_physics_material_expand.webp)

Set its Bounce property to `0.5` by clicking on the number field, typing `0.5`,
and pressing `Enter`.

![image](getting_started/step_by_step/img/instancing_property_bounce_updated.webp)
...
![image](getting_started/step_by_step/img/instancing_scene_tabs.webp)

Select one of the instanced Ball nodes and, in the Inspector, set its
Gravity Scale value to `10`.

![image](getting_started/step_by_step/img/instancing_property_gravity_scale.webp)

A grey "revert" button appears next to the adjusted property.

![image](getting_started/step_by_step/img/instancing_property_revert_icon.webp)
...
![image](getting_started/step_by_step/img/instancing_diagram_shooter.png)
...
![image](getting_started/step_by_step/img/instancing_diagram_open_world.png)
