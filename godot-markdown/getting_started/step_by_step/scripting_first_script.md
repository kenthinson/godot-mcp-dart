...
<a id="doc-scripting-first-script"></a>

# Creating your first script

In this lesson, you will code your first script to make the Godot icon turn in
circles. As we mentioned [in the introduction](../introduction/introduction_to_godot.md#doc-introduction-learning-programming), we assume you have programming
foundations.
...
![image](getting_started/step_by_step/img/scripting_first_script_rotating_godot.gif)

#### SEE ALSO
To learn more about GDScript, its keywords, and its syntax, head to
the [GDScript](../../tutorials/scripting/gdscript/index.md#doc-gdscript) section. To learn more about C#,
head to the [C#/.NET](../../tutorials/scripting/c_sharp/index.md#doc-c-sharp) section.

## Project setup

Please [create a new project](../../tutorials/editor/project_manager.md#doc-creating-and-importing-projects) to
...
![image](getting_started/step_by_step/img/scripting_first_script_icon.svg)

We need to create a Sprite2D node to display it in the game. In the Scene dock,
click the Other Node button.

![image](getting_started/step_by_step/img/scripting_first_script_click_other_node.webp)

Type "Sprite2D" in the search bar to filter nodes and double-click on Sprite2D
to create the node.

![image](getting_started/step_by_step/img/scripting_first_script_add_sprite_node.webp)

Your Scene tab should now only have a Sprite2D node.

![image](getting_started/step_by_step/img/scripting_first_script_scene_tree.webp)
...
![image](getting_started/step_by_step/img/scripting_first_script_setting_texture.webp)
...
![image](getting_started/step_by_step/img/scripting_first_script_centering_sprite.webp)
...
![image](getting_started/step_by_step/img/scripting_first_script_attach_script.webp)
...
![image](getting_started/step_by_step/img/scripting_first_script_attach_node_script.webp)
...
class will implicitly extend [RefCounted](../../classes/class_refcounted.md#class-refcounted), which
...
![image](getting_started/step_by_step/img/scripting_first_script_print_hello_world.webp)
...
![image](getting_started/step_by_step/img/scripting_first_script_godot_turning_in_place.gif)
...
itself is of type [Vector2](../../classes/class_vector2.md#class-vector2), a built-in type in Godot
...
walls or the floor. In [Your first 2D game](../first_2d_game/index.md#doc-your-first-2d-game), you will learn
another approach to moving objects while detecting collisions.

Our node currently moves by itself. In the next part,
[Listening to player input](scripting_player_input.md#doc-scripting-player-input), we'll use player input to control it.
