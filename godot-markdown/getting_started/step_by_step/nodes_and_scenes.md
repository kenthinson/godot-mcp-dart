...
<a id="doc-nodes-and-scenes"></a>

# Nodes and Scenes

In [Overview of Godot's key concepts](../introduction/key_concepts_overview.md#doc-key-concepts-overview), we saw that a Godot game is a tree of
...
![image](getting_started/step_by_step/img/nodes_and_scenes_nodes.webp)
...
playable character the camera follows using a [CharacterBody2D](../../classes/class_characterbody2d.md#class-characterbody2d)
node, a [Sprite2D](../../classes/class_sprite2d.md#class-sprite2d) node,
a [Camera2D](../../classes/class_camera2d.md#class-camera2d) node, and a [CollisionShape2D](../../classes/class_collisionshape2d.md#class-collisionshape2d) node.

![image](getting_started/step_by_step/img/nodes_and_scenes_character_nodes.webp)
...
![image](getting_started/step_by_step/img/nodes_and_scenes_3d_scene_example.webp)
...
[create a new project](../../tutorials/editor/project_manager.md#doc-creating-and-importing-projects) first. After
opening the project, you should see an empty editor.

![image](getting_started/step_by_step/img/nodes_and_scenes_01_empty_editor.webp)

In an empty scene, the Scene dock on the left shows several options to add a
root node quickly. 2D Scene adds a [Node2D](../../classes/class_node2d.md#class-node2d) node,
3D Scene adds a [Node3D](../../classes/class_node3d.md#class-node3d) node,
and User Interface adds a [Control](../../classes/class_control.md#class-control) node.
...
We're going to add a single [Label](../../classes/class_label.md#class-label) node to our scene. Its function is to draw
text on the screen.

Press the Add Child Node button or Other Node to create a
root node.

![image](getting_started/step_by_step/img/nodes_and_scenes_02_scene_dock.webp)

The Create New Node dialog opens, showing the long list of available nodes.

![image](getting_started/step_by_step/img/nodes_and_scenes_03_create_node_window.webp)

Select the Label node. You can type its name to filter down the list.

![image](getting_started/step_by_step/img/nodes_and_scenes_04_create_label_window.webp)

Click on the Label node to select it and click the Create button at
the bottom of the window.

![image](getting_started/step_by_step/img/nodes_and_scenes_05_editor_with_label.webp)
...
![image](getting_started/step_by_step/img/nodes_and_scenes_06_label_text.webp)
...
[Inspector Dock](../../tutorials/editor/inspector_dock.md#doc-editor-inspector-dock).

You can move your Label node in the viewport by selecting the move tool in the
toolbar.

![image](getting_started/step_by_step/img/nodes_and_scenes_07_move_tool.webp)
...
![image](getting_started/step_by_step/img/nodes_and_scenes_08_hello_world_text.webp)
...
![image](getting_started/step_by_step/img/nodes_and_scenes_09_play_scene_button.webp)
...
![image](getting_started/step_by_step/img/nodes_and_scenes_10_save_scene_as.webp)
...
Godot, see [File system](../../tutorials/scripting/filesystem.md#doc-filesystem).

The application should open in a new window and display the text "Hello World".

![image](getting_started/step_by_step/img/nodes_and_scenes_11_final_result.webp)
...
![image](getting_started/step_by_step/img/nodes_and_scenes_12_play_button.webp)
...
![image](getting_started/step_by_step/img/nodes_and_scenes_13_main_scene_popup.webp)

Click the Select button, and in the file dialog that appears, double
click on `label.tscn`.

![image](getting_started/step_by_step/img/nodes_and_scenes_14_select_main_scene.webp)
...
window to do so. For more information, see [Project Settings](../../tutorials/editor/project_settings.md#doc-project-settings).
