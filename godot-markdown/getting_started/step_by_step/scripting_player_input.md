...
<a id="doc-scripting-player-input"></a>

# Listening to player input

Building upon the previous lesson, [Creating your first script](scripting_first_script.md#doc-scripting-first-script), let's look
at another important feature of any game: giving control to the player.
To add this, we need to modify our `sprite_2d.gd` code.

![image](getting_started/step_by_step/img/scripting_first_script_moving_with_input.gif)
...
1. The built-in input callbacks, mainly `_unhandled_input()`. Like
   ...
   more about input callbacks, see [Using InputEvent](../../tutorials/inputs/inputevent.md#doc-inputevent).
...
#### NOTE
You can see and edit input actions in your project by going to
...
In the next lesson, [Using signals](signals.md#doc-signals), we'll build upon the relationship between
