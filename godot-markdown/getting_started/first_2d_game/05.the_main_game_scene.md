<a id="doc-your-first-2d-game-the-main-game-scene"></a>

# The main game scene

Now it's time to bring everything we did together into a playable game scene.

Create a new scene and add a [Node](../../classes/class_node.md#class-node) named `Main`.
...
![image](getting_started/first_2d_game/img/instance_scene.webp)

Now, add the following nodes as children of `Main`, and name them as shown:

- [Timer](../../classes/class_timer.md#class-timer) (named `MobTimer`) - to control how often mobs
  spawn
- [Timer](../../classes/class_timer.md#class-timer) (named `ScoreTimer`) - to increment the score
  every second
- [Timer](../../classes/class_timer.md#class-timer) (named `StartTimer`) - to give a delay before
  starting
- [Marker2D](../../classes/class_marker2d.md#class-marker2d) (named `StartPosition`) - to indicate
...
add a child [Path2D](../../classes/class_path2d.md#class-path2d) node named `MobPath`. When you select
`Path2D`, you will see some new buttons at the top of the editor:

![image](getting_started/first_2d_game/img/path2d_buttons.webp)
...
![image](getting_started/first_2d_game/img/grid_snap_button.webp)

#### IMPORTANT
Draw the path in *clockwise* order, or your mobs will spawn
pointing *outwards* instead of *inwards*!

![image](getting_started/first_2d_game/img/draw_path2d.gif)

After placing point `4` in the image, click the "Close Curve" button and your
curve will be complete.

Now that the path is defined, add a [PathFollow2D](../../classes/class_pathfollow2d.md#class-pathfollow2d)
...
![image](getting_started/first_2d_game/img/main_scene_nodes.webp)
