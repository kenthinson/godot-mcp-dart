<a id="doc-your-first-2d-game-finishing-up"></a>
...
One way to do this is to use a [ColorRect](../../classes/class_colorrect.md#class-colorrect) node. Make it
...
[TextureRect](../../classes/class_texturerect.md#class-texturerect) node instead.
...
Add two [AudioStreamPlayer](../../classes/class_audiostreamplayer.md#class-audiostreamplayer) nodes as children of
...
![image](getting_started/first_2d_game/img/unique_resource_music.webp)
...
![image](getting_started/first_2d_game/img/input-mapping-start_game.webp)
...
property in the Inspector. Create a new [Shortcut](../../classes/class_shortcut.md#class-shortcut) resource
by clicking within the box, open the **Events** array and add a new array element
to it by clicking on **Array[InputEvent] (size 0)**.

![image](getting_started/first_2d_game/img/start_button_shortcut.webp)

Create a new [InputEventAction](../../classes/class_inputeventaction.md#class-inputeventaction) and select the `start_game` action.

![image](getting_started/first_2d_game/img/start_button_shortcut2.webp)
...
![image](getting_started/first_2d_game/img/dodge_preview.gif)
...
And when you're ready, you can move on to [Your first 3D game](../first_3d_game/index.md#doc-your-first-3d-game) to learn
...
playable on. See [Exporting projects](../../tutorials/export/exporting_projects.md#doc-exporting-projects) for instructions.
