<a id="doc-your-first-2d-game-player-scene"></a>
...
"Other Node" button and add an [Area2D](../../classes/class_area2d.md#class-area2d) node to the scene.

#### NOTE
Godot also provides the [CharacterBody2D](../../classes/class_characterbody2d.md#class-characterbody2d) node,
...
![image](getting_started/first_2d_game/img/add_node.webp)

When you add the `Area2D` node, Godot will display the following **warning icon**
next to it in the scene tree:

![image](getting_started/first_2d_game/img/no_shape_warning.webp)
...
![image](getting_started/first_2d_game/img/lock_children.webp)
...
`Cmd + A` on macOS) a child node [AnimatedSprite2D](../../classes/class_animatedsprite2d.md#class-animatedsprite2d). The `AnimatedSprite2D` will handle the
appearance and animations for our player. Notice that there is a warning symbol
next to the node. An `AnimatedSprite2D` requires a [SpriteFrames](../../classes/class_spriteframes.md#class-spriteframes) resource, which is a list of the animations it can
...
![image](getting_started/first_2d_game/img/new_spriteframes.webp)

Click on the `SpriteFrames` you just created to open the "SpriteFrames" panel:

![image](getting_started/first_2d_game/img/spriteframes_panel.webp)
...
![image](getting_started/first_2d_game/img/spriteframes_panel2.webp)
...
![image](getting_started/first_2d_game/img/player_scale.webp)

Finally, add a [CollisionShape2D](../../classes/class_collisionshape2d.md#class-collisionshape2d) as a child of
...
![image](getting_started/first_2d_game/img/player_coll_shape.webp)

When you're finished, your `Player` scene should look like this:

![image](getting_started/first_2d_game/img/player_scene_nodes.webp)
