<a id="doc-your-first-2d-game-coding-the-player"></a>
...
![image](getting_started/first_2d_game/img/add_script_button.webp)
...
![image](getting_started/first_2d_game/img/attach_node_window.webp)

#### NOTE
If this is your first time encountering GDScript, please read
[Scripting languages](../step_by_step/scripting_languages.md#doc-scripting) before continuing.
...
![image](getting_started/first_2d_game/img/build_dotnet.webp)

![image](getting_started/first_2d_game/img/export_variable.webp)
...
![image](getting_started/first_2d_game/img/input-mapping-add-action.webp)

We need to assign a key to this action. Click the "+" icon on the right, to
open the event manager window.

![image](getting_started/first_2d_game/img/input-mapping-add-key.webp)
...
![image](getting_started/first_2d_game/img/input-mapping-event-configuration.webp)
...
![image](getting_started/first_2d_game/img/input-mapping-completed.webp)
...
Click "Run Current Scene" (`F6`, `Cmd + R` on macOS) and confirm you can move
...
![image](getting_started/first_2d_game/img/player_signals.webp)
...
![image](getting_started/first_2d_game/img/player_signal_connection.webp)
