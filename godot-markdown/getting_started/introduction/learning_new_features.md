...
<a id="doc-learning-new-features"></a>
...
![image](getting_started/introduction/img/manual_search.png)
...
![image](getting_started/introduction/img/manual_class_reference_search.webp)

To browse it online, head to the manual's [Class Reference](../../classes/index.md#doc-class-reference)
section.
...
1. Where the class exists in the inheritance hierarchy. You can click the top
   ...
   inherits.
   ![image](getting_started/introduction/img/manual_class_reference_inheritance.webp)
...
information, please open an Issue in the official [godot-docs](https://github.com/godotengine/godot-docs/issues) GitHub repository
to report it.

You can hold `Ctrl` (macOS `Cmd`) and then mouseover text like the name of a class, property,
method, signal, or constant to underline it, then `Ctrl + Click` (macOS `Cmd + Click`) it to jump to it.
...
4. **Share a screenshot** of your *Scene* dock along with your written code. Most of
   ...
   ![image](getting_started/introduction/img/key_concepts_scene_tree.webp)
   ...
   should have a built-in tool to take screenshots with the `PrtSc` (Print
   Screen) key (macOS: use `Cmd + Shift + 3` for a full screen shot,
...
5. Sharing a video of your running game can also be really **useful to
   troubleshoot your game**. You can use programs like [OBS Studio](https://obsproject.com/) and [Screen to GIF](https://www.screentogif.com/) to capture your screen.
...
[Tutorials and resources](../../community/tutorials.md#doc-community-tutorials), which lists content made by the Godot community.
