<a id="doc-first-3d-game-player-scene-and-input"></a>
...
![image](getting_started/first_3d_game/img/02.player_input/new_scene.webp)

Click the **Other Node** button and select the `CharacterBody3D` node type
to create a [CharacterBody3D](../../classes/class_characterbody3d.md#class-characterbody3d) as the root node.

![image](getting_started/first_3d_game/img/02.player_input/add_character_body3D.webp)

Rename the [CharacterBody3D](../../classes/class_characterbody3d.md#class-characterbody3d) to `Player`.
...
[Physics introduction](../../tutorials/physics/physics_introduction.md#doc-physics-introduction).
...
Add a [Node3D](../../classes/class_node3d.md#class-node3d) node as a child of `Player`.
Select the `Player` node in the **Scene** tree and click the "**+**" button to add a child node.
Rename it to `Pivot`.

![image](getting_started/first_3d_game/img/02.player_input/adding_node3D.webp)

Then, in the FileSystem dock, expand the `art/` folder
by double-clicking it and drag and
drop `player.glb` onto `Pivot`.

![image](getting_started/first_3d_game/img/02.player_input/instantiating_the_model.webp)

This should instantiate the model as a child of `Pivot`.
You can rename it to `Character`.

![image](getting_started/first_3d_game/img/02.player_input/scene_structure.webp)
...
[CollisionShape3D](../../classes/class_collisionshape3d.md#class-collisionshape3d). In the **Inspector**, on the **Shape** property,
add a new [SphereShape3D](../../classes/class_sphereshape3d.md#class-sphereshape3d).

![image](getting_started/first_3d_game/img/02.player_input/add_capsuleshape3d.webp)

The sphere's wireframe appears below the character.

![image](getting_started/first_3d_game/img/02.player_input/sphere_shape.png)
...
![image](getting_started/first_3d_game/img/02.player_input/moving_the_sphere_up.png)
...
![image](getting_started/first_3d_game/img/02.player_input/toggling_visibility.webp)
...
<a id="doc-first-3d-game-input-actions"></a>
...
![image](getting_started/first_3d_game/img/02.player_input/project_settings.webp)
...
![image](getting_started/first_3d_game/img/02.player_input/input_map_tab.webp)
...
![image](getting_started/first_3d_game/img/02.player_input/adding_action.webp)

Create the following five actions:

![image](getting_started/first_3d_game/img/02.player_input/actions_list_empty.webp)
...
![image](getting_started/first_3d_game/img/02.player_input/left_inputmap.webp)

Bind also the `A` key, onto the action `move_left`.

![image](getting_started/first_3d_game/img/02.player_input/keyboard_keys.webp)
...
![image](getting_started/first_3d_game/img/02.player_input/joystick_axis_input.webp)
...
![image](getting_started/first_3d_game/img/02.player_input/move_inputs_mapped.webp)

The final action to set up is the `jump` action. Bind the Space key and the gamepad's
A button located under **Joypad Buttons**.

![image](getting_started/first_3d_game/img/02.player_input/joy_button_option.webp)

Your jump input action should look like this.

![image](getting_started/first_3d_game/img/02.player_input/jump_input_action.webp)
