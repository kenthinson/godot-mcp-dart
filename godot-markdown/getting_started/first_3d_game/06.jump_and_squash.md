<a id="doc-first-3d-game-jumping-and-squashing-monsters"></a>
...
the world of [physics layers](../../tutorials/physics/physics_introduction.md#doc-physics-introduction-collision-layers-and-masks).
...
![image0](getting_started/first_3d_game/img/06.jump_and_squash/02.project_settings.webp)
...
![image1](getting_started/first_3d_game/img/06.jump_and_squash/03.physics_layers.webp)
...
![image2](getting_started/first_3d_game/img/06.jump_and_squash/04.default_physics_properties.webp)
...
![image3](getting_started/first_3d_game/img/06.jump_and_squash/05.toggle_layer_and_mask.webp)
...
![image4](getting_started/first_3d_game/img/06.jump_and_squash/06.named_checkboxes.webp)
...
![image5](getting_started/first_3d_game/img/06.jump_and_squash/07.player_physics_mask.webp)
...
![image6](getting_started/first_3d_game/img/06.jump_and_squash/08.mob_physics_mask.webp)
...
collisions with the floor. To do so, we can use Godot's [group](../../tutorials/scripting/groups.md#doc-groups) tagging feature.
...
![image7](getting_started/first_3d_game/img/06.jump_and_squash/09.groups_tab.webp)

Enter "mob" in the *Name* field and click the *Ok* button.

![image8](getting_started/first_3d_game/img/06.jump_and_squash/10.group_create_new.webp)

The "mob" group is now shown under the *Scene Groups* section.

![image9](getting_started/first_3d_game/img/06.jump_and_squash/11.group_scene_groups.webp)

An icon appears in the *Scene* dock to indicate the node is part of at least one
group.

![image10](getting_started/first_3d_game/img/06.jump_and_squash/12.group_scene_icon.webp)
...
the [CharacterBody3D](../../classes/class_characterbody3d.md#class-characterbody3d) class and are related to
`move_and_slide()`.

`get_slide_collision()` returns a
[KinematicCollision3D](../../classes/class_kinematiccollision3d.md#class-kinematiccollision3d) object that holds
...
#### NOTE
The method `is_in_group()` is available on every [Node](../../classes/class_node.md#class-node).
...
#### NOTE
When using C#, Godot will create the appropriate events automatically for all Signals ending with EventHandler, see [C# Signals](../../tutorials/scripting/c_sharp/c_sharp_signals.md#doc-c-sharp-signals).
