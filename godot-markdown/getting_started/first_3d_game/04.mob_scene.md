<a id="doc-first-3d-game-designing-the-mob-scene"></a>
...
Create a scene with, once again, a [CharacterBody3D](../../classes/class_characterbody3d.md#class-characterbody3d) node as its root. Name it
`Mob`. Add a child node [Node3D](../../classes/class_node3d.md#class-node3d), name it `Pivot`. And drag and drop
the file `mob.glb` from the *FileSystem* dock onto the `Pivot` to add the
monster's 3D model to the scene.

![image](getting_started/first_3d_game/img/04.mob_scene/drag_drop_mob.webp)

You can rename the newly created `mob` node
into `Character`.

![image0](getting_started/first_3d_game/img/04.mob_scene/01.initial_three_nodes.webp)

We need a collision shape for our body to work. Right-click on the `Mob` node,
the scene's root, and click *Add Child Node*.

![image1](getting_started/first_3d_game/img/04.mob_scene/02.add_child_node.webp)

Add a [CollisionShape3D](../../classes/class_collisionshape3d.md#class-collisionshape3d).

![image2](getting_started/first_3d_game/img/04.mob_scene/03.scene_with_collision_shape.webp)

In the *Inspector*, assign a *BoxShape3D* to the *Shape* property.

![image](getting_started/first_3d_game/img/01.game_setup/08.create_box_shape3D.webp)
...
![image4](getting_started/first_3d_game/img/04.mob_scene/05.box_final_size.png)
...
[VisibleOnScreenNotifier3D](../../classes/class_visibleonscreennotifier3d.md#class-visibleonscreennotifier3d), and we're going to use it to destroy our mobs.
...
about that here: [Memory management](../../tutorials/scripting/gdscript/gdscript_basics.md#doc-gdscript-basics-memory-management).

Select the `Mob` node and add a child node [VisibleOnScreenNotifier3D](../../classes/class_visibleonscreennotifier3d.md#class-visibleonscreennotifier3d). Another
box, pink this time, appears. When this box completely leaves the screen, the
node will emit a signal.

![image5](getting_started/first_3d_game/img/04.mob_scene/06.visibility_notifier.webp)

Resize it using the orange dots until it covers the entire 3D model.

![image6](getting_started/first_3d_game/img/04.mob_scene/07.visibility_notifier_bbox_resized.png)
...
![image7](getting_started/first_3d_game/img/04.mob_scene/08.mob_attach_script.webp)
...
connect our [VisibleOnScreenNotifier3D](../../classes/class_visibleonscreennotifier3d.md#class-visibleonscreennotifier3d) node's `screen_exited` signal to the `Mob`.

Head back to the 3D viewport by clicking on the *3D* label at the top of the
editor. You can also press `Ctrl + F2` (`Opt + 2` on macOS).

![image8](getting_started/first_3d_game/img/04.mob_scene/09.switch_to_3d_workspace.webp)

Select the [VisibleOnScreenNotifier3D](../../classes/class_visibleonscreennotifier3d.md#class-visibleonscreennotifier3d) node and on the right side of the interface,
navigate to the *Signals* dock. Double-click the `screen_exited()` signal.

![image9](getting_started/first_3d_game/img/04.mob_scene/10.node_dock.webp)

Connect the signal to the `Mob`

![image10](getting_started/first_3d_game/img/04.mob_scene/11.connect_signal.webp)
