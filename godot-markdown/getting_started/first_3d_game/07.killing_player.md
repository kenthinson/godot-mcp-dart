<a id="doc-first-3d-game-killing-the-player"></a>
...
kinds of collisions. Instead, though, we will use an [Area3D](../../classes/class_area3d.md#class-area3d) node, which
works well for hitboxes.

## Hitbox with the Area node

Head back to the `player.tscn` scene and add a new child node [Area3D](../../classes/class_area3d.md#class-area3d). Name it
`MobDetector`
Add a [CollisionShape3D](../../classes/class_collisionshape3d.md#class-collisionshape3d) node as a child of it.

![image0](getting_started/first_3d_game/img/07.killing_player/01.adding_area_node.webp)

In the *Inspector*, assign a cylinder shape to it.

![image1](getting_started/first_3d_game/img/07.killing_player/02.cylinder_shape.webp)
...
![image2](getting_started/first_3d_game/img/07.killing_player/03.cylinder_in_editor.png)
...
![image3](getting_started/first_3d_game/img/07.killing_player/04.mob_detector_properties.webp)
...
![image4](getting_started/first_3d_game/img/07.killing_player/05.body_entered_signal.webp)

The *MobDetector* will emit `body_entered` when a [CharacterBody3D](../../classes/class_characterbody3d.md#class-characterbody3d) or a
[RigidBody3D](../../classes/class_rigidbody3d.md#class-rigidbody3d) node enters it. As it only masks the "enemies" physics
...
![image5](getting_started/first_3d_game/img/07.killing_player/06.player_hit_signal.webp)
