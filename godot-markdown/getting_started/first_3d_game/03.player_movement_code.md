<a id="doc-first-3d-game-player-movement"></a>
...
![image0](getting_started/first_3d_game/img/03.player_movement_code/01.attach_script_to_player.webp)
...
These are common properties for a moving body. The `target_velocity` is a [3D vector](../../classes/class_vector3.md#class-vector3)
...
`_physics_process()`, see [Idle and Physics Processing](../../tutorials/scripting/idle_and_physics_processing.md#doc-idle-and-physics-processing).
...
We compute the direction the `$Pivot` is looking by creating a [Basis](../../classes/class_basis.md#class-basis)
...
smooth it out for you. It uses the *velocity* value native to the [CharacterBody3D](../../classes/class_characterbody3d.md#class-characterbody3d)
...
![image1](getting_started/first_3d_game/img/03.player_movement_code/02.clicking_main_tab.webp)
...
![image2](getting_started/first_3d_game/img/03.player_movement_code/03.instance_child_scene.webp)
...
*Add Child Node*. Create a new [Marker3D](../../classes/class_marker3d.md#class-marker3d), and name it `CameraPivot`.
Select `CameraPivot` and add a child node [Camera3D](../../classes/class_camera3d.md#class-camera3d) to it.
Your scene tree should look similar to this.

![image3](getting_started/first_3d_game/img/03.player_movement_code/04.scene_tree_with_camera.webp)
...
![image4](getting_started/first_3d_game/img/03.player_movement_code/05.camera_preview_checkbox.webp)
...
![image11](getting_started/first_3d_game/img/03.player_movement_code/12.viewport_change.webp)

![image5](getting_started/first_3d_game/img/03.player_movement_code/06.two_viewports.webp)

On the bottom view, select your [Camera3D](../../classes/class_camera3d.md#class-camera3d) and turn on camera
Preview by clicking the checkbox.

![image6](getting_started/first_3d_game/img/03.player_movement_code/07.camera_preview_checkbox.webp)

In the top view, make sure your *Camera3D* is selected and move the camera about
`19` units on the Z axis (drag the blue arrow).

![image7](getting_started/first_3d_game/img/03.player_movement_code/08.camera_moved.png)
...
![image8](getting_started/first_3d_game/img/03.player_movement_code/09.camera_rotated.png)

You can run the scene by pressing `F6` (`Cmd + R` on macOS) and
press the arrow keys to move the character.

![image9](getting_started/first_3d_game/img/03.player_movement_code/10.camera_perspective.png)
...
![image10](getting_started/first_3d_game/img/03.player_movement_code/13.camera3d_values.webp)
