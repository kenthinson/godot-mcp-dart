<a id="doc-first-3d-game-score-and-replay"></a>
...
In the main scene, add a new child node [Control](../../classes/class_control.md#class-control) to `Main` and name it
`UserInterface`. Ensure you are on the 2D screen, where you can edit your User Interface (UI).

Add a [Label](../../classes/class_label.md#class-label) node and name it `ScoreLabel`

![image1](getting_started/first_3d_game/img/08.score_and_replay/01_label_node.webp)

In the *Inspector*, set the *Label*'s *Text* to a placeholder like "Score: 0".

![image2](getting_started/first_3d_game/img/08.score_and_replay/02_score_placeholder.webp)
...
![image3](getting_started/first_3d_game/img/08.score_and_replay/03_score_font_color.webp)

Finally, click and drag on the text in the viewport to move it away from the
top-left corner.

![image4](getting_started/first_3d_game/img/08.score_and_replay/04_score_label_moved.webp)
...
![image5](getting_started/first_3d_game/img/08.score_and_replay/05_creating_theme.webp)
...
![image6](getting_started/first_3d_game/img/08.score_and_replay/06_theme_preview.webp)
...
creating and editing themes, see [Introduction to GUI skinning](../../tutorials/ui/gui_skinning.md#doc-gui-skinning).
...
![image7](getting_started/first_3d_game/img/08.score_and_replay/07_font_size.webp)
...
![image8](getting_started/first_3d_game/img/08.score_and_replay/08_open_main_script.webp)
...
#### SEE ALSO
You can learn more about string formatting here: [GDScript format strings](../../tutorials/scripting/gdscript/gdscript_format_string.md#doc-gdscript-printf).
In C#, consider using [string interpolation with "$"](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/tokens/interpolated).

You can now play the game and squash a few enemies to see the score
increase.

![image9](getting_started/first_3d_game/img/08.score_and_replay/09_score_in_game.png)
...
child node [ColorRect](../../classes/class_colorrect.md#class-colorrect), and name it `Retry`. This node fills a
...
![image10](getting_started/first_3d_game/img/08.score_and_replay/10_anchor_preset.webp)

Open it and apply the *Full Rect* command.

![image11](getting_started/first_3d_game/img/08.score_and_replay/11_full_rect_option.webp)

Nothing happens. Well, almost nothing; only the four green pins move to the
corners of the selection box.

![image12](getting_started/first_3d_game/img/08.score_and_replay/12_anchors_updated.webp)
...
![image13](getting_started/first_3d_game/img/08.score_and_replay/13_retry_color_picker.webp)

Next, add a [Label](../../classes/class_label.md#class-label) as a child of `Retry` and give it the *Text*
"Press Enter to retry."
To move it and anchor it in the center of the screen, apply *Anchor Preset -> Center*
to it.

![image14](getting_started/first_3d_game/img/08.score_and_replay/14_center_option.webp)
...
The function `get_tree()` gives us access to the global [SceneTree](../../classes/class_scenetree.md#class-scenetree) object, which allows us to reload and restart the current
scene.

## Adding music

To add music that plays continuously in the background, we're going to use
another feature in Godot: [autoloads](../../tutorials/scripting/singletons_autoload.md#doc-singletons-autoload).

To play audio, all you need to do is add an [AudioStreamPlayer](../../classes/class_audiostreamplayer.md#class-audiostreamplayer) node to your
...
![image15](getting_started/first_3d_game/img/08.score_and_replay/15_new_scene.webp)

Click the *Other Node* button to create an [AudioStreamPlayer](../../classes/class_audiostreamplayer.md#class-audiostreamplayer) and rename it to
`MusicPlayer`.

![image16](getting_started/first_3d_game/img/08.score_and_replay/16_music_player_node.webp)
...
![image17](getting_started/first_3d_game/img/08.score_and_replay/17_music_node_properties.webp)
...
![image18](getting_started/first_3d_game/img/08.score_and_replay/18_register_autoload.webp)
...
![image19](getting_started/first_3d_game/img/08.score_and_replay/19_scene_dock_tabs.webp)
...
![image20](getting_started/first_3d_game/img/08.score_and_replay/20_remote_scene_tree.webp)
