<a id="doc-first-3d-game-character-animation"></a>
...
Open the player scene, select the `Player` node, and add an [AnimationPlayer](../../classes/class_animationplayer.md#class-animationplayer) node.

The *Animation* dock appears in the bottom panel.

![image1](getting_started/first_3d_game/img/09.adding_animations/animation_player_dock.webp)
...
![image2](getting_started/first_3d_game/img/09.adding_animations/02.new_animation.webp)

Name the animation "float".

![image3](getting_started/first_3d_game/img/09.adding_animations/03.float_name.webp)

Once you've created the animation, the timeline appears with numbers representing
time in seconds.

![image4](getting_started/first_3d_game/img/09.adding_animations/03.timeline.webp)

We want the animation to start playback automatically at the start of the game.
Also, it should loop.

To do so, you can click the autoplay button (![Autoplay](getting_started/first_3d_game/img/09.adding_animations/autoplay_button.webp)) in the animation toolbar
and the looping arrows, respectively.

![image5](getting_started/first_3d_game/img/09.adding_animations/04.autoplay_and_loop.webp)
...
![image6](getting_started/first_3d_game/img/09.adding_animations/05.pin_icon.webp)
...
![image7](getting_started/first_3d_game/img/09.adding_animations/06.animation_duration.webp)

You can click and drag the slider in the bottom-right to zoom in and out of the
timeline.

![image8](getting_started/first_3d_game/img/09.adding_animations/08.zoom_slider.webp)
...
![image9](getting_started/first_3d_game/img/09.adding_animations/09.creating_first_keyframe.webp)

![image](getting_started/first_3d_game/img/09.adding_animations/curves.webp)
...
![image10](getting_started/first_3d_game/img/09.adding_animations/10.initial_keys.webp)
...
![image11](getting_started/first_3d_game/img/09.adding_animations/11.moving_keys.webp)

Move the time cursor to `0.5` seconds by clicking and dragging on the gray
timeline, or by entering it into the input field.

![timeline_05_click](getting_started/first_3d_game/img/09.adding_animations/timeline_05_click.webp)
...
![image12](getting_started/first_3d_game/img/09.adding_animations/12.second_keys_values.webp)

Create a keyframe for both properties

![second_keys_both](getting_started/first_3d_game/img/09.adding_animations/second_keys_both.webp)

Now, move the position keyframe to `0.7`
seconds by dragging it on the timeline.

![image13](getting_started/first_3d_game/img/09.adding_animations/13.second_keys.webp)
...
![animation_final_keyframes](getting_started/first_3d_game/img/09.adding_animations/animation_final_keyframes.webp)
...
![image14](getting_started/first_3d_game/img/09.adding_animations/14.play_button.webp)
...
![image15](getting_started/first_3d_game/img/09.adding_animations/15.box_select.webp)

You can edit the properties of both keys simultaneously in the *Inspector*,
where you can see an *Easing* property.

![image16](getting_started/first_3d_game/img/09.adding_animations/16.easing_property.webp)
...
![image17](getting_started/first_3d_game/img/09.adding_animations/17.ease_out.webp)
...
![image18](getting_started/first_3d_game/img/09.adding_animations/18.ease_out_second_rotation_key.webp)

Do the opposite for the second position keyframe, dragging it to the right.

![image19](getting_started/first_3d_game/img/09.adding_animations/19.ease_in_second_translation_key.webp)

Your animation should look something like this.

![image20](getting_started/first_3d_game/img/09.adding_animations/20.float_animation.gif)
...
![image21](getting_started/first_3d_game/img/09.adding_animations/21.script_icon.webp)
...
Then open `mob.tscn`, create an [AnimationPlayer](../../classes/class_animationplayer.md#class-animationplayer) child
...
Next, make sure that the autoplay button (![Autoplay](getting_started/first_3d_game/img/09.adding_animations/autoplay_button.webp)) and the looping
