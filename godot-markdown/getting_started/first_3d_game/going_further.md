<a id="doc-first-3d-game-going-further"></a>
...
[https://github.com/godotengine/godot-demo-projects/releases](https://github.com/godotengine/godot-demo-projects/releases).
...
1. Read the [Scripting section](../../tutorials/scripting/index.md#toc-scripting-core-features) to learn essential programming features you'll use
   in every project.
2. The [3D](../../tutorials/3d/index.md#toc-learn-features-3d) and [Physics](../../tutorials/physics/index.md#toc-learn-features-physics) sections will teach you more about 3D game creation in the
   engine.
3. [Inputs](../../tutorials/inputs/index.md#toc-learn-features-inputs) is another important one for any game project.
