...
<a id="class-audioeffecthighpassfilter"></a>
...
Cuts frequencies lower than the [AudioEffectFilter.cutoff_hz](class_audioeffectfilter.md#class-audioeffectfilter-property-cutoff-hz) and allows higher frequencies to pass.
