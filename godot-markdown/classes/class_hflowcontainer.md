...
A variant of [FlowContainer](class_flowcontainer.md#class-flowcontainer) that can only arrange its child controls horizontally, wrapping them around at the borders. This is similar to how text in a book wraps around when no more words can fit on a line.
