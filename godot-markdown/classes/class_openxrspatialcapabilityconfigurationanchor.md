...
<a id="class-openxrspatialcapabilityconfigurationanchor"></a>
...
| [PackedInt64Array](class_packedint64array.md#class-packedint64array)   | [get_enabled_components](#class-openxrspatialcapabilityconfigurationanchor-method-get-enabled-components)()    |
|------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
...
<a id="class-openxrspatialcapabilityconfigurationanchor-method-get-enabled-components"></a>
