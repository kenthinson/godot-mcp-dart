...
<a id="class-audioeffecthighshelffilter"></a>
...
Reduces all frequencies above the [AudioEffectFilter.cutoff_hz](class_audioeffectfilter.md#class-audioeffectfilter-property-cutoff-hz).
